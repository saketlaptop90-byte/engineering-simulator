...
export function createLithiumElectronCloud() {
  const group = new THREE.Group();
  
  // Lithium-6 Isotope (Remastered, replacing old redundant 'electron cloud' model)
  ...
  return {
    group: group,
    description: "Lithium-6 Isotope (Remastered). Unlike standard Lithium-7 (which has 4 neutrons), this rare isotope has exactly 3 protons and 3 neutrons. Chemically, it acts exactly the same as normal Lithium (it still has the same 3 electrons). But in the realm of Nuclear Physics, Lithium-6 is incredibly precious! When Lithium-6 is struck by a neutron in a nuclear reactor, it splits perfectly into Helium and Tritium (a super-heavy, radioactive version of Hydrogen). Tritium is the fuel required for thermonuclear fusion! Lithium-6 is literally the key to unlocking the power of the stars on Earth.",
    parts: [
