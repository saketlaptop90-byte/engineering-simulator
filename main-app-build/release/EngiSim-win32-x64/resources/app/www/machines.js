export const MACHINES = [
  ...
  { id: 'hydrogen_fuel_cell', name: 'Hydrogen Fuel Cell', icon: '🔋', category: 'real_life_models', importPath: './machines/hydrogen_fuel_cell.js', importName: 'createHydrogenFuelCell' },
  { id: 'van_de_graaff_generator', name: 'Van de Graaff Generator', icon: '⚡', category: 'real_life_models', importPath: './machines/van_de_graaff_generator.js', importName: 'createVanDeGraaffGenerator' },
  { id: 'galvanic_cell', name: 'Galvanic Cell', icon: '🔋', category: 'real_life_models', importPath: './machines/galvanic_cell.js', importName: 'createGalvanicCell' },
  { id: 'electrolysis_chamber', name: 'Electrolysis Chamber', icon: '💧', category: 'real_life_models', importPath: './machines/electrolysis_chamber.js', importName: 'createElectrolysisChamber' },
...
\n,\n
  ...
  { id: 'helium_thomson_model', name: 'Thomson Model', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_thomson_model.js', importName: 'createHeliumThomsonModel' },
  { id: 'helium_rutherford_model', name: 'Rutherford Model', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_rutherford_model.js', importName: 'createHeliumRutherfordModel' },
  { id: 'helium_schrodinger_model', name: 'Schrödinger Model', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_schrodinger_model.js', importName: 'createHeliumSchrodingerModel' },
  { id: 'helium_electron_density', name: 'Electron Density', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_electron_density.js', importName: 'createHeliumElectronDensity' },
  { id: 'helium_probability_distribution', name: 'Probability Distribution', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_probability_distribution.js', importName: 'createHeliumProbabilityDistribution' },
  { id: 'helium_electron_proton_interaction', name: 'Electron-Proton Force', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_electron_proton_interaction.js', importName: 'createHeliumElectronProtonInteraction' },
  { id: 'helium_electron_shells', name: 'Electron Shells', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_electron_shells.js', importName: 'createHeliumElectronShells' },
  { id: 'helium_subshells', name: 'Subshells', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_subshells.js', importName: 'createHeliumSubshells' },
  { id: 'helium_nodal_surfaces', name: 'Nodal Surfaces', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_nodal_surfaces.js', importName: 'createHeliumNodalSurfaces' },
  { id: 'helium_electron_configuration', name: 'Electron Config', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_electron_configuration.js', importName: 'createHeliumElectronConfiguration' },
  { id: 'helium_orbital_filling_sequence', name: 'Orbital Filling', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_orbital_filling_sequence.js', importName: 'createHeliumOrbitalFillingSequence' },
  { id: 'helium_aufbau_principle', name: 'Aufbau Principle', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_aufbau_principle.js', importName: 'createHeliumAufbauPrinciple' },
\n,\n
  // --- Chemistry Batch 11: Helium (Part 4) ---
  { id: 'helium_valence_electrons', name: 'Valence Electrons', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_valence_electrons.js', importName: 'createHeliumValenceElectrons' },
  { id: 'helium_core_electrons', name: 'Core Electrons', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_core_electrons.js', importName: 'createHeliumCoreElectrons' },
  { id: 'helium_effective_nuclear_charge', name: 'Effective Nuclear Charge', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_effective_nuclear_charge.js', importName: 'createHeliumEffectiveNuclearCharge' },
  { id: 'helium_shielding_effect', name: 'Shielding Effect', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_shielding_effect.js', importName: 'createHeliumShieldingEffect' },
  { id: 'helium_atomic_radius', name: 'Atomic Radius', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_atomic_radius.js', importName: 'createHeliumAtomicRadius' },
  { id: 'helium_ionic_radius', name: 'Ionic Radius', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_ionic_radius.js', importName: 'createHeliumIonicRadius' },
  { id: 'helium_covalent_radius', name: 'Covalent Radius', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_covalent_radius.js', importName: 'createHeliumCovalentRadius' },
  { id: 'helium_metallic_bonding', name: 'Metallic Bonding', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_metallic_bonding.js', importName: 'createHeliumMetallicBonding' },
  { id: 'helium_ionic_bonding', name: 'Ionic Bonding', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_ionic_bonding.js', importName: 'createHeliumIonicBonding' },
  { id: 'helium_van_der_waals_interactions', name: 'London Dispersion', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_van_der_waals_interactions.js', importName: 'createHeliumVanDerWaalsInteractions' },
  { id: 'helium_ground_state', name: 'Ground State', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_ground_state.js', importName: 'createHeliumGroundState' },
  { id: 'helium_excited_states', name: 'Excited States', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_excited_states.js', importName: 'createHeliumExcitedStates' },
\n,\n
  // --- Chemistry Batch 12: Helium (Part 5 - Final) ---
  { id: 'helium_photon_absorption', name: 'Photon Absorption', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_photon_absorption.js', importName: 'createHeliumPhotonAbsorption' },
  { id: 'helium_photon_emission', name: 'Photon Emission', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_photon_emission.js', importName: 'createHeliumPhotonEmission' },
  { id: 'helium_nuclear_structure', name: 'Alpha Particle', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_nuclear_structure.js', importName: 'createHeliumNuclearStructure' },
  { id: 'helium_radioactive_decay', name: 'Radioactive Decay', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_radioactive_decay.js', importName: 'createHeliumRadioactiveDecay' },
  { id: 'helium_crystal_structure', name: 'Solid Helium', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_crystal_structure.js', importName: 'createHeliumCrystalStructure' },
  { id: 'helium_coordinate_bonding_rejection', name: 'Bonding Rejection', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_coordinate_bonding_rejection.js', importName: 'createHeliumCoordinateBondingRejection' },
  { id: 'helium_dipole_interactions', name: 'Helium Dimer', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_dipole_interactions.js', importName: 'createHeliumDipoleInteractions' },
  { id: 'helium_oxidation_reduction_inertness', name: 'Total Inertness', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_oxidation_reduction_inertness.js', importName: 'createHeliumOxidationReductionInertness' },
  { id: 'helium_catalytic_carrier', name: 'Carrier Gas', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_catalytic_carrier.js', importName: 'createHeliumCatalyticCarrier' },
  { id: 'helium_reaction_mechanisms_collision', name: 'Elastic Collision', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_reaction_mechanisms_collision.js', importName: 'createHeliumReactionMechanismsCollision' },
  { id: 'helium_environmental_escape', name: 'Atmospheric Escape', icon: '🎈', category: 'helium', importPath: './machines/chemistry/helium_environmental_escape.js', importName: 'createHeliumEnvironmentalEscape' },
\n,\n
  // --- Chemistry Batch 13: Lithium (Part 1) ---
  { id: 'lithium_atomic_structure', name: 'Atomic Structure', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_atomic_structure.js', importName: 'createLithiumAtomicStructure' },
  { id: 'lithium_bohr_model', name: 'Bohr Model', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_bohr_model.js', importName: 'createLithiumBohrModel' },
  { id: 'lithium_rutherford_model', name: 'Rutherford Model', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_rutherford_model.js', importName: 'createLithiumRutherfordModel' },
  { id: 'lithium_thomson_model', name: 'Thomson Model', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_thomson_model.js', importName: 'createLithiumThomsonModel' },
  { id: 'lithium_quantum_mechanical_model', name: 'Quantum Model', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_quantum_mechanical_model.js', importName: 'createLithiumQuantumMechanicalModel' },
  { id: 'lithium_schrodinger_model', name: 'Schrödinger Model', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_schrodinger_model.js', importName: 'createLithiumSchrodingerModel' },
  { id: 'lithium_electron_cloud', name: 'Electron Cloud', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_electron_cloud.js', importName: 'createLithiumElectronCloud' },
  { id: 'lithium_electron_density', name: 'Electron Density', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_electron_density.js', importName: 'createLithiumElectronDensity' },
  { id: 'lithium_probability_density', name: 'Probability Density', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_probability_density.js', importName: 'createLithiumProbabilityDensity' },
  { id: 'lithium_electron_proton_interaction', name: 'Proton Attraction', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_electron_proton_interaction.js', importName: 'createLithiumElectronProtonInteraction' },
  { id: 'lithium_electron_electron_repulsion', name: 'Electron Repulsion', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_electron_electron_repulsion.js', importName: 'createLithiumElectronElectronRepulsion' },
  { id: 'lithium_shielding_effect', name: 'Shielding Effect', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_shielding_effect.js', importName: 'createLithiumShieldingEffect' },
  { id: 'lithium_effective_nuclear_charge', name: 'Effective Nuclear Charge', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_effective_nuclear_charge.js', importName: 'createLithiumEffectiveNuclearCharge' },
\n,\n
  // --- Chemistry Batch 14: Lithium (Part 2) ---
  { id: 'lithium_electron_shells', name: 'Electron Shells', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_electron_shells.js', importName: 'createLithiumElectronShells' },
  { id: 'lithium_energy_levels', name: 'Energy Levels', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_energy_levels.js', importName: 'createLithiumEnergyLevels' },
  { id: 'lithium_subshells', name: 'Subshells', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_subshells.js', importName: 'createLithiumSubshells' },
  { id: 'lithium_s_orbitals', name: 's Orbitals', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_s_orbitals.js', importName: 'createLithiumSOrbitals' },
  { id: 'lithium_p_orbitals', name: 'p Orbitals', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_p_orbitals.js', importName: 'createLithiumPOrbitals' },
  { id: 'lithium_orbital_overlap', name: 'Orbital Overlap', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_orbital_overlap.js', importName: 'createLithiumOrbitalOverlap' },
  { id: 'lithium_orbital_hybridization', name: 'Hybridization', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_orbital_hybridization.js', importName: 'createLithiumOrbitalHybridization' },
  { id: 'lithium_electron_spin', name: 'Electron Spin', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_electron_spin.js', importName: 'createLithiumElectronSpin' },
  { id: 'lithium_pauli_exclusion_principle', name: 'Pauli Exclusion', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_pauli_exclusion_principle.js', importName: 'createLithiumPauliExclusionPrinciple' },
  { id: 'lithium_hunds_rule', name: 'Hund\'s Rule', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_hunds_rule.js', importName: 'createLithiumHundsRule' },
  { id: 'lithium_aufbau_principle', name: 'Aufbau Principle', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_aufbau_principle.js', importName: 'createLithiumAufbauPrinciple' },
  { id: 'lithium_orbital_filling_sequence', name: 'Orbital Filling', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_orbital_filling_sequence.js', importName: 'createLithiumOrbitalFillingSequence' },
\n,\n
  // --- Chemistry Batch 15: Lithium (Part 3) ---
  { id: 'lithium_valence_electrons', name: 'Valence Electrons', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_valence_electrons.js', importName: 'createLithiumValenceElectrons' },
  { id: 'lithium_core_electrons', name: 'Core Electrons', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_core_electrons.js', importName: 'createLithiumCoreElectrons' },
  { id: 'lithium_atomic_radius', name: 'Atomic Radius', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_atomic_radius.js', importName: 'createLithiumAtomicRadius' },
  { id: 'lithium_ionic_radius', name: 'Ionic Radius', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_ionic_radius.js', importName: 'createLithiumIonicRadius' },
  { id: 'lithium_covalent_radius', name: 'Covalent Radius', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_covalent_radius.js', importName: 'createLithiumCovalentRadius' },
  { id: 'lithium_metallic_bonding', name: 'Metallic Bonding', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_metallic_bonding.js', importName: 'createLithiumMetallicBonding' },
  { id: 'lithium_ionic_bonding', name: 'Ionic Bonding', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_ionic_bonding.js', importName: 'createLithiumIonicBonding' },
  { id: 'lithium_covalent_bonding', name: 'Covalent Bonding', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_covalent_bonding.js', importName: 'createLithiumCovalentBonding' },
  { id: 'lithium_coordinate_bonding', name: 'Coordinate Bonding', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_coordinate_bonding.js', importName: 'createLithiumCoordinateBonding' },
  { id: 'lithium_hydrogen_bonding', name: 'Hydrogen Bonding', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_hydrogen_bonding.js', importName: 'createLithiumHydrogenBonding' },
  { id: 'lithium_van_der_waals_interactions', name: 'Van der Waals', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_van_der_waals_interactions.js', importName: 'createLithiumVanDerWaals' },
  { id: 'lithium_dipole_interactions', name: 'Dipole Interactions', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_dipole_interactions.js', importName: 'createLithiumDipoleInteractions' },
  { id: 'lithium_ion_formation', name: 'Ion Formation', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_ion_formation.js', importName: 'createLithiumIonFormation' },
\n,\n
  // --- Chemistry Batch 16: Lithium (Part 4) ---
  { id: 'lithium_electron_transitions', name: 'Electron Transitions', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_electron_transitions.js', importName: 'createLithiumElectronTransitions' },
  { id: 'lithium_excited_states', name: 'Excited States', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_excited_states.js', importName: 'createLithiumExcitedStates' },
  { id: 'lithium_ground_state', name: 'Ground State', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_ground_state.js', importName: 'createLithiumGroundState' },
  { id: 'lithium_photon_absorption', name: 'Photon Absorption', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_photon_absorption.js', importName: 'createLithiumPhotonAbsorption' },
  { id: 'lithium_photon_emission', name: 'Photon Emission', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_photon_emission.js', importName: 'createLithiumPhotonEmission' },
  { id: 'lithium_flame_test', name: 'Flame Test', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_flame_test.js', importName: 'createLithiumFlameTest' },
  { id: 'lithium_isotopes', name: 'Isotopes', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_isotopes.js', importName: 'createLithiumIsotopes' },
  { id: 'lithium_nuclear_structure', name: 'Nuclear Structure', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_nuclear_structure.js', importName: 'createLithiumNuclearStructure' },
  { id: 'lithium_alpha_particle_bombardment', name: 'Alpha Bombardment', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_alpha_particle_bombardment.js', importName: 'createLithiumAlphaBombardment' },
  { id: 'lithium_half_life', name: 'Half Life', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_half_life.js', importName: 'createLithiumHalfLife' },
\n,\n
  // --- Chemistry Batch 17: Lithium (Part 5) ---
  { id: 'lithium_oxidation_state', name: 'Oxidation State', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_oxidation_state.js', importName: 'createLithiumOxidationState' },
  { id: 'lithium_electronegativity', name: 'Electronegativity', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_electronegativity.js', importName: 'createLithiumElectronegativity' },
  { id: 'lithium_ionization_energy', name: 'Ionization Energy', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_ionization_energy.js', importName: 'createLithiumIonizationEnergy' },
  { id: 'lithium_electron_affinity', name: 'Electron Affinity', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_electron_affinity.js', importName: 'createLithiumElectronAffinity' },
  { id: 'lithium_alkali_metal_group', name: 'Alkali Group', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_alkali_metal_group.js', importName: 'createLithiumAlkaliMetalGroup' },
  { id: 'lithium_reactivity_with_water', name: 'Water Reactivity', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_reactivity_with_water.js', importName: 'createLithiumWaterReactivity' },
  { id: 'lithium_battery_anode', name: 'Battery Anode', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_battery_anode.js', importName: 'createLithiumBatteryAnode' },
  { id: 'lithium_ion_battery_intercalation', name: 'Intercalation', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_ion_battery_intercalation.js', importName: 'createLithiumIntercalation' },
  { id: 'lithium_crystal_structure', name: 'Crystal Structure', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_crystal_structure.js', importName: 'createLithiumCrystalStructure' },
  { id: 'lithium_density', name: 'Density', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_density.js', importName: 'createLithiumDensity' },
  { id: 'lithium_flammability', name: 'Flammability', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_flammability.js', importName: 'createLithiumFlammability' },
  { id: 'lithium_medical_use', name: 'Medical Use', icon: '🔋', category: 'lithium', importPath: './machines/chemistry/lithium_medical_use.js', importName: 'createLithiumMedicalUse' },
\n,\n
  // --- Chemistry Batch 18: Beryllium (Part 1) ---
  { id: 'beryllium_atomic_structure', name: 'Atomic Structure', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_atomic_structure.js', importName: 'createBerylliumAtomicStructure' },
  { id: 'beryllium_bohr_model', name: 'Bohr Model', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_bohr_model.js', importName: 'createBerylliumBohrModel' },
  { id: 'beryllium_rutherford_model', name: 'Rutherford Model', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_rutherford_model.js', importName: 'createBerylliumRutherfordModel' },
  { id: 'beryllium_thomson_model', name: 'Thomson Model', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_thomson_model.js', importName: 'createBerylliumThomsonModel' },
  { id: 'beryllium_quantum_mechanical_model', name: 'Quantum Model', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_quantum_mechanical_model.js', importName: 'createBerylliumQuantumMechanicalModel' },
  { id: 'beryllium_schrodinger_model', name: 'Schrödinger Model', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_schrodinger_model.js', importName: 'createBerylliumSchrodingerModel' },
  { id: 'beryllium_electron_cloud', name: 'Electron Cloud', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_electron_cloud.js', importName: 'createBerylliumElectronCloud' },
  { id: 'beryllium_electron_density', name: 'Electron Density', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_electron_density.js', importName: 'createBerylliumElectronDensity' },
  { id: 'beryllium_probability_density', name: 'Probability Density', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_probability_density.js', importName: 'createBerylliumProbabilityDensity' },
  { id: 'beryllium_electron_proton_interaction', name: 'Proton Interaction', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_electron_proton_interaction.js', importName: 'createBerylliumElectronProtonInteraction' },
  { id: 'beryllium_electron_electron_repulsion', name: 'Electron Repulsion', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_electron_electron_repulsion.js', importName: 'createBerylliumElectronElectronRepulsion' },
  { id: 'beryllium_shielding_effect', name: 'Shielding Effect', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_shielding_effect.js', importName: 'createBerylliumShieldingEffect' },
\n,\n
  // --- Chemistry Batch 19: Beryllium (Part 2) ---
  { id: 'beryllium_effective_nuclear_charge', name: 'Zeff (Effective Pull)', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_effective_nuclear_charge.js', importName: 'createBerylliumEffectiveNuclearCharge' },
  { id: 'beryllium_nuclear_attraction', name: 'Nuclear Attraction', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_nuclear_attraction.js', importName: 'createBerylliumNuclearAttraction' },
  { id: 'beryllium_electron_shells', name: 'Electron Shells', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_electron_shells.js', importName: 'createBerylliumElectronShells' },
  { id: 'beryllium_energy_levels', name: 'Energy Levels', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_energy_levels.js', importName: 'createBerylliumEnergyLevels' },
  { id: 'beryllium_subshells', name: 'Subshells', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_subshells.js', importName: 'createBerylliumSubshells' },
  { id: 'beryllium_s_orbitals', name: 'S Orbitals', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_s_orbitals.js', importName: 'createBerylliumSOrbitals' },
  { id: 'beryllium_p_orbitals', name: 'P Orbitals', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_p_orbitals.js', importName: 'createBerylliumPOrbitals' },
  { id: 'beryllium_d_orbitals', name: 'D Orbitals', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_d_orbitals.js', importName: 'createBerylliumDOrbitals' },
  { id: 'beryllium_f_orbitals', name: 'F Orbitals', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_f_orbitals.js', importName: 'createBerylliumFOrbitals' },
  { id: 'beryllium_orbital_overlap', name: 'Orbital Overlap', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_orbital_overlap.js', importName: 'createBerylliumOrbitalOverlap' },
  { id: 'beryllium_orbital_hybridization', name: 'Hybridization (sp)', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_orbital_hybridization.js', importName: 'createBerylliumHybridization' },
  { id: 'beryllium_electron_spin', name: 'Electron Spin', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_electron_spin.js', importName: 'createBerylliumElectronSpin' },
  { id: 'beryllium_pauli_exclusion_principle', name: 'Pauli Exclusion', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_pauli_exclusion_principle.js', importName: 'createBerylliumPauliExclusion' },
\n,\n
  // --- Chemistry Batch 20: Beryllium (Part 3) ---
  { id: 'beryllium_hunds_rule', name: 'Hund\'s Rule', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_hunds_rule.js', importName: 'createBerylliumHundsRule' },
  { id: 'beryllium_aufbau_principle', name: 'Aufbau Principle', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_aufbau_principle.js', importName: 'createBerylliumAufbauPrinciple' },
  { id: 'beryllium_orbital_filling_sequence', name: 'Orbital Filling (Madelung)', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_orbital_filling_sequence.js', importName: 'createBerylliumOrbitalFillingSequence' },
  { id: 'beryllium_valence_electrons', name: 'Valence Electrons', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_valence_electrons.js', importName: 'createBerylliumValenceElectrons' },
  { id: 'beryllium_core_electrons', name: 'Core Electrons', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_core_electrons.js', importName: 'createBerylliumCoreElectrons' },
  { id: 'beryllium_atomic_radius', name: 'Atomic Radius', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_atomic_radius.js', importName: 'createBerylliumAtomicRadius' },
  { id: 'beryllium_ionic_radius', name: 'Ionic Radius (Be2+)', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_ionic_radius.js', importName: 'createBerylliumIonicRadius' },
  { id: 'beryllium_covalent_radius', name: 'Covalent Radius', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_covalent_radius.js', importName: 'createBerylliumCovalentRadius' },
  { id: 'beryllium_metallic_bonding', name: 'Metallic Bonding', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_metallic_bonding.js', importName: 'createBerylliumMetallicBonding' },
  { id: 'beryllium_ionic_bonding', name: 'Ionic Bonding', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_ionic_bonding.js', importName: 'createBerylliumIonicBonding' },
  { id: 'beryllium_covalent_bonding', name: 'Covalent Bonding', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_covalent_bonding.js', importName: 'createBerylliumCovalentBonding' },
  { id: 'beryllium_coordinate_bonding', name: 'Coordinate Bonding', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_coordinate_bonding.js', importName: 'createBerylliumCoordinateBonding' },
  { id: 'beryllium_hydrogen_bonding', name: 'Hydrogen Bonding', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_hydrogen_bonding.js', importName: 'createBerylliumHydrogenBonding' },
\n,\n
  // --- Chemistry Batch 21: Beryllium (Part 4) ---
  { id: 'beryllium_solid_state', name: 'Solid State (HCP)', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_solid_state.js', importName: 'createBerylliumSolidState' },
  { id: 'beryllium_liquid_state', name: 'Liquid State', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_liquid_state.js', importName: 'createBerylliumLiquidState' },
  { id: 'beryllium_gaseous_state', name: 'Gaseous State', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_gaseous_state.js', importName: 'createBerylliumGaseousState' },
  { id: 'beryllium_plasma_state', name: 'Plasma State', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_plasma_state.js', importName: 'createBerylliumPlasmaState' },
  { id: 'beryllium_isotope_be7', name: 'Isotope Be-7', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_isotope_be7.js', importName: 'createBeryllium7' },
  { id: 'beryllium_isotope_be9', name: 'Isotope Be-9 (Stable)', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_isotope_be9.js', importName: 'createBeryllium9' },
  { id: 'beryllium_isotope_be10', name: 'Isotope Be-10', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_isotope_be10.js', importName: 'createBeryllium10' },
  { id: 'beryllium_radioactive_decay', name: 'Radioactive Decay', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_radioactive_decay.js', importName: 'createBerylliumDecay' },
  { id: 'beryllium_nuclear_fusion', name: 'Nuclear Fusion', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_nuclear_fusion.js', importName: 'createBerylliumFusion' },
  { id: 'beryllium_emission_spectrum', name: 'Emission Spectrum', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_emission_spectrum.js', importName: 'createBerylliumEmissionSpectrum' },
  { id: 'beryllium_absorption_spectrum', name: 'Absorption Spectrum', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_absorption_spectrum.js', importName: 'createBerylliumAbsorptionSpectrum' },
  { id: 'beryllium_photoelectric_effect', name: 'Photoelectric Effect', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_photoelectric_effect.js', importName: 'createBerylliumPhotoelectricEffect' },
\n,\n
  // --- Chemistry Batch 22: Beryllium (Part 5 - Final) ---
  { id: 'beryllium_absolute_zero', name: 'Absolute Zero (0K)', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_absolute_zero.js', importName: 'createBerylliumAbsoluteZero' },
  { id: 'beryllium_black_hole_spaghettification', name: 'Black Hole Tidal Force', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_black_hole_spaghettification.js', importName: 'createBerylliumSpaghettification' },
  { id: 'beryllium_quantum_entanglement', name: 'Quantum Entanglement', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_quantum_entanglement.js', importName: 'createBerylliumEntanglement' },
  { id: 'beryllium_quarks_protons', name: 'Proton Quarks', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_quarks_protons.js', importName: 'createBerylliumQuarksProton' },
  { id: 'beryllium_quarks_neutrons', name: 'Neutron Quarks', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_quarks_neutrons.js', importName: 'createBerylliumQuarksNeutron' },
  { id: 'beryllium_gluons', name: 'Gluons (Strong Force)', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_gluons.js', importName: 'createBerylliumGluons' },
  { id: 'beryllium_antimatter', name: 'Anti-Beryllium', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_antimatter.js', importName: 'createBerylliumAntimatter' },
  { id: 'beryllium_higgs_field', name: 'The Higgs Field', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_higgs_field.js', importName: 'createBerylliumHiggsField' },
  { id: 'beryllium_neutron_star_crust', name: 'Neutron Star Crust', icon: '🔋', category: 'beryllium', importPath: './machines/chemistry/beryllium_neutron_star_crust.js', importName: 'createBerylliumNeutronStar' },
  { id: 'beryllium_james_webb_mirror', name: 'James Webb Mirror', icon: '🔭', category: 'beryllium', importPath: './machines/chemistry/beryllium_james_webb_mirror.js', importName: 'createBerylliumJamesWebb' },\n
  // --- Chemistry Batch 23: Boron (Part 1 - Atomic Structure) ---
  { id: 'boron_atom_basic', name: 'Boron Atom (Base)', icon: '🧪', category: 'boron', importPath: './machines/chemistry/boron_atom_basic.js', importName: 'createBoronAtomBasic' },
  { id: 'boron_protons', name: 'The 5 Protons', icon: '🧪', category: 'boron', importPath: './machines/chemistry/boron_protons.js', importName: 'createBoronProtons' },
  { id: 'boron_neutrons', name: 'The 6 Neutrons', icon: '🧪', category: 'boron', importPath: './machines/chemistry/boron_neutrons.js', importName: 'createBoronNeutrons' },
  { id: 'boron_electrons', name: 'The 5 Electrons', icon: '🧪', category: 'boron', importPath: './machines/chemistry/boron_electrons.js', importName: 'createBoronElectrons' },
  { id: 'boron_nucleus', name: 'The Nucleus', icon: '🧪', category: 'boron', importPath: './machines/chemistry/boron_nucleus.js', importName: 'createBoronNucleus' },
  { id: 'boron_electron_cloud', name: 'Quantum Cloud', icon: '🧪', category: 'boron', importPath: './machines/chemistry/boron_electron_cloud.js', importName: 'createBoronElectronCloud' },
  { id: 'boron_bohr_model', name: 'Bohr Model (1913)', icon: '🧪', category: 'boron', importPath: './machines/chemistry/boron_bohr_model.js', importName: 'createBoronBohr' },
  { id: 'boron_rutherford_model', name: 'Rutherford (1911)', icon: '🧪', category: 'boron', importPath: './machines/chemistry/boron_rutherford_model.js', importName: 'createBoronRutherford' },
  { id: 'boron_thomson_model', name: 'Plum Pudding (1904)', icon: '🧪', category: 'boron', importPath: './machines/chemistry/boron_thomson_model.js', importName: 'createBoronThomson' },
  { id: 'boron_schrodinger_model', name: 'Schrödinger (1926)', icon: '🧪', category: 'boron', importPath: './machines/chemistry/boron_schrodinger_model.js', importName: 'createBoronSchrodinger' },
  { id: 'boron_probability_density', name: 'Probability Density', icon: '🧪', category: 'boron', importPath: './machines/chemistry/boron_probability_density.js', importName: 'createBoronProbabilityDensity' },
  { id: 'boron_electron_repulsion', name: 'Electron Repulsion', icon: '🧪', category: 'boron', importPath: './machines/chemistry/boron_electron_repulsion.js', importName: 'createBoronElectronRepulsion' },\n
  // --- Chemistry Batch 24: Boron (Part 2 - Periodic Trends & Rules) ---
  { id: 'boron_effective_nuclear_charge', name: 'Effective Nuclear Charge', icon: '🔋', category: 'boron', importPath: './machines/chemistry/boron_effective_nuclear_charge.js', importName: 'createBoronEffectiveNuclearCharge' },
  { id: 'boron_electron_shielding', name: 'Electron Shielding', icon: '🔋', category: 'boron', importPath: './machines/chemistry/boron_electron_shielding.js', importName: 'createBoronShielding' },
  { id: 'boron_ionization_energy', name: 'Ionization Energy', icon: '🔋', category: 'boron', importPath: './machines/chemistry/boron_ionization_energy.js', importName: 'createBoronIonizationEnergy' },
  { id: 'boron_atomic_radius', name: 'Atomic Radius', icon: '🔋', category: 'boron', importPath: './machines/chemistry/boron_atomic_radius.js', importName: 'createBoronAtomicRadius' },
  { id: 'boron_ionic_radius', name: 'Ionic Radius (B3+)', icon: '🔋', category: 'boron', importPath: './machines/chemistry/boron_ionic_radius.js', importName: 'createBoronIonicRadius' },
  { id: 'boron_covalent_radius', name: 'Covalent Radius', icon: '🔋', category: 'boron', importPath: './machines/chemistry/boron_covalent_radius.js', importName: 'createBoronCovalentRadius' },
  { id: 'boron_electron_affinity', name: 'Electron Affinity', icon: '🔋', category: 'boron', importPath: './machines/chemistry/boron_electron_affinity.js', importName: 'createBoronElectronAffinity' },
  { id: 'boron_electronegativity', name: 'Electronegativity', icon: '🔋', category: 'boron', importPath: './machines/chemistry/boron_electronegativity.js', importName: 'createBoronElectronegativity' },
  { id: 'boron_metalloid_properties', name: 'Metalloid (Semiconductor)', icon: '🔋', category: 'boron', importPath: './machines/chemistry/boron_metalloid_properties.js', importName: 'createBoronMetalloid' },
  { id: 'boron_electron_configuration', name: 'Configuration (1s2 2s2 2p1)', icon: '🔋', category: 'boron', importPath: './machines/chemistry/boron_electron_configuration.js', importName: 'createBoronConfiguration' },
  { id: 'boron_aufbau_principle', name: 'Aufbau Principle', icon: '🔋', category: 'boron', importPath: './machines/chemistry/boron_aufbau_principle.js', importName: 'createBoronAufbau' },
  { id: 'boron_hunds_rule', name: 'Hund\'s Rule', icon: '🔋', category: 'boron', importPath: './machines/chemistry/boron_hunds_rule.js', importName: 'createBoronHundsRule' },
  { id: 'boron_pauli_exclusion', name: 'Pauli Exclusion Principle', icon: '🔋', category: 'boron', importPath: './machines/chemistry/boron_pauli_exclusion.js', importName: 'createBoronPauliExclusion' },\n
  // --- Chemistry Batch 25: Boron (Part 3 - Advanced Bonding & Allotropes) ---
  { id: 'boron_icosahedron', name: 'The B12 Icosahedron', icon: '💎', category: 'boron', importPath: './machines/chemistry/boron_icosahedron.js', importName: 'createBoronIcosahedron' },
  { id: 'boron_covalent_network', name: 'Macroscopic Network Solid', icon: '💎', category: 'boron', importPath: './machines/chemistry/boron_covalent_network.js', importName: 'createBoronCovalentNetwork' },
  { id: 'boron_three_center_two_electron_bond', name: 'Banana Bond (B2H6)', icon: '🍌', category: 'boron', importPath: './machines/chemistry/boron_three_center_two_electron_bond.js', importName: 'createBoronBananaBond' },
  { id: 'boron_trifluoride_molecule', name: 'Trigonal Planar (BF3)', icon: '📐', category: 'boron', importPath: './machines/chemistry/boron_trifluoride_molecule.js', importName: 'createBoronTrifluoride' },
  { id: 'boron_nitride_nanotube', name: 'Boron Nitride Nanotube', icon: '🧪', category: 'boron', importPath: './machines/chemistry/boron_nitride_nanotube.js', importName: 'createBoronNitrideNanotube' },\n
  ...
  { id: 'boron_borax', name: 'Borax Anion', icon: '🧼', category: 'boron', importPath: './machines/chemistry/boron_borax.js', importName: 'createBoronBorax' },
  { id: 'boron_flame_test', name: 'Flame Test (518nm)', icon: '🔥', category: 'boron', importPath: './machines/chemistry/boron_flame_test.js', importName: 'createBoronFlameTest' },\n
  ...
  { id: 'boron_isotope_11', name: 'Isotope: Boron-11', icon: '🧲', category: 'boron', importPath: './machines/chemistry/boron_isotope_11.js', importName: 'createBoron11' },\n
  // --- Chemistry Batch 28: Boron (Part 6 - Analogues & Magnets) ---
  { id: 'boron_borazine', name: 'Borazine (B3N3H6)', icon: '⬡', category: 'boron', importPath: './machines/chemistry/boron_borazine.js', importName: 'createBoronBorazine' },
  { id: 'boron_neodymium_magnet', name: 'Neodymium Magnet', icon: '🧲', category: 'boron', importPath: './machines/chemistry/boron_neodymium_magnet.js', importName: 'createBoronNeodymiumMagnet' },
  { id: 'boron_boron_nitride_nanotube', name: 'BN Nanotube', icon: '🧪', category: 'boron', importPath: './machines/chemistry/boron_boron_nitride_nanotube.js', importName: 'createBNNanotube' },\n
  // --- Chemistry Batch 29: Boron (Part 7 - Glasses & Ceramics) ---
  { id: 'boron_sodium_borohydride', name: 'Sodium Borohydride', icon: '🔋', category: 'boron', importPath: './machines/chemistry/boron_sodium_borohydride.js', importName: 'createBoronNaBH4' },
  { id: 'boron_boron_phosphide', name: 'Boron Phosphide (BP)', icon: '💎', category: 'boron', importPath: './machines/chemistry/boron_boron_phosphide.js', importName: 'createBoronPhosphide' },
  { id: 'boron_borosilicate_glass', name: 'Borosilicate Glass (Pyrex)', icon: '🥃', category: 'boron', importPath: './machines/chemistry/boron_borosilicate_glass.js', importName: 'createBorosilicateGlass' },\n
  // --- Chemistry Batch 30: Boron (Part 8 - Organic Reactions & Industrial Materials) ---
  { id: 'boron_dative_bond', name: 'The Dative Bond (BF3+NH3)', icon: '🤝', category: 'boron', importPath: './machines/chemistry/boron_dative_bond.js', importName: 'createBoronDativeBond' },
  { id: 'boron_suzuki_coupling', name: 'Suzuki Cross-Coupling', icon: '🏆', category: 'boron', importPath: './machines/chemistry/boron_suzuki_coupling.js', importName: 'createBoronSuzukiCoupling' },
  { id: 'boron_magnesium_diboride', name: 'MgB2 Superconductor', icon: '⚡', category: 'boron', importPath: './machines/chemistry/boron_magnesium_diboride.js', importName: 'createMgB2' },
  { id: 'boron_bpsg_glass', name: 'BPSG Microchip Glass', icon: '💻', category: 'boron', importPath: './machines/chemistry/boron_bpsg_glass.js', importName: 'createBPSG' },
  ...
  { id: 'boron_sodium_perborate', name: 'Sodium Perborate Bleach', icon: '👕', category: 'boron', importPath: './machines/chemistry/boron_sodium_perborate.js', importName: 'createSodiumPerborate' },
  ...
  { id: 'boron_boroxine', name: 'Boroxine (B3O3H3)', icon: '🔥', category: 'boron', importPath: './machines/chemistry/boron_boroxine.js', importName: 'createBoroxine' },
  ...
  { id: 'boron_hydroboration_oxidation', name: 'Hydroboration Rxn', icon: '🧪', category: 'boron', importPath: './machines/chemistry/boron_hydroboration_oxidation.js', importName: 'createHydroboration' },\n
  // --- Chemistry Batch 32: Boron (Part 10 - Tech & Medicine) ---
  { id: 'boron_neodymium_magnet_domains', name: 'Magnet Domains', icon: '🧲', category: 'boron', importPath: './machines/chemistry/boron_neodymium_magnet_domains.js', importName: 'createMagneticDomains' },
  { id: 'boron_bpsg_glass_etching', name: 'BPSG Wet Etching', icon: '🛁', category: 'boron', importPath: './machines/chemistry/boron_bpsg_glass_etching.js', importName: 'createBPSGEtching' },
  { id: 'boron_neutron_capture_therapy', name: 'Cancer Therapy (BNCT)', icon: '🏥', category: 'boron', importPath: './machines/chemistry/boron_neutron_capture_therapy.js', importName: 'createBNCT' },
  ...
  { id: 'boron_doping_silicon', name: 'P-Type Semiconductors', icon: '📟', category: 'boron', importPath: './machines/chemistry/boron_doping_silicon.js', importName: 'createPTypeDoping' },\n
  // --- Chemistry Batch 33: Boron Finale & Lithium Remasters ---
  { id: 'boron_flame_test', name: 'Boron Flame Test', icon: '🔥', category: 'boron', importPath: './machines/chemistry/boron_flame_test.js', importName: 'createBoronFlameTest' },
  ...
  { id: 'boron_borophene', name: 'Borophene (2D Sheet)', icon: '💠', category: 'boron', importPath: './machines/chemistry/boron_borophene.js', importName: 'createBorophene' }
