const fs = require('fs');
const appJsPath = 'C:/Users/Saket/OneDrive/Desktop/engineering-simulator/app.js';
...
if (!content.includes('createCarbonNanotubeAssembler')) {
    content = newImports + '\n' + content;
}
...
if (!content.includes('id: \\'carbon_nanotube_assembler\\'')) {
