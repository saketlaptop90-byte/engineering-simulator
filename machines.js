import { chem_c_mwcnt } from './machines/chemistry/carbon_nanotube_mwcnt.js';

import { chem_c_lonsdaleite } from './machines/chemistry/carbon_lonsdaleite.js';

import { chem_c_fullerene_c70 } from './machines/chemistry/carbon_fullerene_c70.js';

import { chem_c_carbyne } from './machines/chemistry/carbon_carbyne.js';

import { chem_c_graphene_oxide } from './machines/chemistry/carbon_graphene_oxide.js';

export const MACHINES = [

  // --- Boron Models 6-10 ---

  { id: 'boron_electron_proton_interaction', name: 'Boron Electron-Proton Interaction', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_electron_proton_interaction.js', importName: 'createBoronElectronProtonInteraction' },

  { id: 'boron_electron_electron_repulsion', name: 'Boron Electron-Electron Repulsion', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_electron_electron_repulsion.js', importName: 'createBoronElectronElectronRepulsion' },

  { id: 'boron_energy_levels', name: 'Boron Energy Levels', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_energy_levels.js', importName: 'createBoronEnergyLevels' },

  { id: 'boron_atomic_radius', name: 'Boron Atomic Radius', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_atomic_radius.js', importName: 'createBoronAtomicRadius' },

  { id: 'boron_ionic_radius', name: 'Boron Ionic Radius', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_ionic_radius.js', importName: 'createBoronIonicRadius' },



  // --- Boron Batch 2 ---

  { id: 'boron_electron_cloud', name: 'Boron Electron Cloud', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_electron_cloud.js', importName: 'createBoronElectronCloud' },

  { id: 'boron_electron_density', name: 'Boron Electron Density', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_electron_density.js', importName: 'createBoronElectronDensity' },

  { id: 'boron_probability_density', name: 'Boron Probability Density', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_probability_density.js', importName: 'createBoronProbabilityDensity' },



  // --- Boron Batch 1 ---

  { id: 'boron_atomic_structure', name: 'Boron Atomic Structure', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_atomic_structure.js', importName: 'createBoronAtomicStructure' },

  { id: 'boron_bohr_model', name: 'Boron Bohr Model', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_bohr_model.js', importName: 'createBoronBohrModel' },

  { id: 'boron_rutherford_model', name: 'Boron Rutherford Model', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_rutherford_model.js', importName: 'createBoronRutherfordModel' },

  { id: 'boron_thomson_model', name: 'Boron Thomson Model', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_thomson_model.js', importName: 'createBoronThomsonModel' },

  { id: 'boron_quantum_mechanical_model', name: 'Boron Quantum Mechanical Model', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_quantum_mechanical_model.js', importName: 'createBoronQuantumMechanicalModel' },



  // --- Beryllium Batch 12 ---

  { id: 'beryllium_crystal_structure', name: 'Beryllium Crystal Structure', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_crystal_structure.js', importName: 'createBerylliumCrystalStructure' },

  { id: 'beryllium_allotropes', name: 'Beryllium Allotropes', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_allotropes.js', importName: 'createBerylliumAllotropes' },

  { id: 'beryllium_heat_capacity', name: 'Beryllium Heat Capacity', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_heat_capacity.js', importName: 'createBerylliumHeatCapacity' },

  { id: 'beryllium_thermal_conductivity', name: 'Beryllium Thermal Conductivity', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_thermal_conductivity.js', importName: 'createBerylliumThermalConductivity' },

  { id: 'beryllium_youngs_modulus', name: 'Beryllium Youngs Modulus', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_youngs_modulus.js', importName: 'createBerylliumYoungsModulus' },



  // --- Beryllium Batch 11 ---

  { id: 'beryllium_gamma_decay', name: 'Beryllium Gamma Decay', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_gamma_decay.js', importName: 'createBerylliumGammaDecay' },

  { id: 'beryllium_nuclear_fission', name: 'Beryllium Nuclear Fission', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_nuclear_fission.js', importName: 'createBerylliumNuclearFission' },

  { id: 'beryllium_nuclear_fusion', name: 'Beryllium Nuclear Fusion', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_nuclear_fusion.js', importName: 'createBerylliumNuclearFusion' },

  { id: 'beryllium_binding_energy', name: 'Beryllium Binding Energy', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_binding_energy.js', importName: 'createBerylliumBindingEnergy' },

  { id: 'beryllium_mass_defect', name: 'Beryllium Mass Defect', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_mass_defect.js', importName: 'createBerylliumMassDefect' },



  // --- Beryllium Batch 10 ---

  { id: 'beryllium_isotopes', name: 'Beryllium Isotopes', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_isotopes.js', importName: 'createBerylliumIsotopes' },

  { id: 'beryllium_radioactivity', name: 'Beryllium Radioactivity', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_radioactivity.js', importName: 'createBerylliumRadioactivity' },

  { id: 'beryllium_half_life', name: 'Beryllium Half-Life', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_half_life.js', importName: 'createBerylliumHalfLife' },

  { id: 'beryllium_alpha_decay', name: 'Beryllium Alpha Decay', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_alpha_decay.js', importName: 'createBerylliumAlphaDecay' },

  { id: 'beryllium_beta_decay', name: 'Beryllium Beta Decay', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_beta_decay.js', importName: 'createBerylliumBetaDecay' },



  // --- Beryllium Batch 9 ---

  { id: 'beryllium_electron_transitions', name: 'Beryllium Electron Transitions', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_electron_transitions.js', importName: 'createBerylliumElectronTransitions' },

  { id: 'beryllium_excited_states', name: 'Beryllium Excited States', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_excited_states.js', importName: 'createBerylliumExcitedStates' },

  { id: 'beryllium_photon_emission', name: 'Beryllium Photon Emission', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_photon_emission.js', importName: 'createBerylliumPhotonEmission' },

  { id: 'beryllium_photon_absorption', name: 'Beryllium Photon Absorption', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_photon_absorption.js', importName: 'createBerylliumPhotonAbsorption' },

  { id: 'beryllium_spectral_lines', name: 'Beryllium Spectral Lines', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_spectral_lines.js', importName: 'createBerylliumSpectralLines' },



  // --- Beryllium Batch 8 ---

  { id: 'beryllium_hydrogen_bonding', name: 'Beryllium Hydrogen Bonding', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_hydrogen_bonding.js', importName: 'createBerylliumHydrogenBonding' },

  { id: 'beryllium_van_der_waals', name: 'Beryllium Van Der Waals', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_van_der_waals.js', importName: 'createBerylliumVanDerWaals' },

  { id: 'beryllium_dipole_interactions', name: 'Beryllium Dipole Interactions', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_dipole_interactions.js', importName: 'createBerylliumDipoleInteractions' },

  { id: 'beryllium_ion_formation', name: 'Beryllium Ion Formation', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_ion_formation.js', importName: 'createBerylliumIonFormation' },

  { id: 'beryllium_oxidation_reduction', name: 'Beryllium Oxidation Reduction', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_oxidation_reduction.js', importName: 'createBerylliumOxidationReduction' },



  // --- Beryllium Batch 7 ---

  { id: 'beryllium_covalent_radius', name: 'Beryllium Covalent Radius', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_covalent_radius.js', importName: 'createBerylliumCovalentRadius' },

  { id: 'beryllium_metallic_bonding', name: 'Beryllium Metallic Bonding', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_metallic_bonding.js', importName: 'createBerylliumMetallicBonding' },

  { id: 'beryllium_ionic_bonding', name: 'Beryllium Ionic Bonding', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_ionic_bonding.js', importName: 'createBerylliumIonicBonding' },

  { id: 'beryllium_covalent_bonding', name: 'Beryllium Covalent Bonding', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_covalent_bonding.js', importName: 'createBerylliumCovalentBonding' },

  { id: 'beryllium_coordinate_bonding', name: 'Beryllium Coordinate Bonding', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_coordinate_bonding.js', importName: 'createBerylliumCoordinateBonding' },



  // --- Beryllium Batch 6 ---

  { id: 'beryllium_orbital_filling_sequence', name: 'Beryllium Orbital Filling', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_orbital_filling_sequence.js', importName: 'createBerylliumOrbitalFillingSequence' },

  { id: 'beryllium_valence_electrons', name: 'Beryllium Valence Electrons', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_valence_electrons.js', importName: 'createBerylliumValenceElectrons' },

  { id: 'beryllium_core_electrons', name: 'Beryllium Core Electrons', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_core_electrons.js', importName: 'createBerylliumCoreElectrons' },

  { id: 'beryllium_atomic_radius', name: 'Beryllium Atomic Radius', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_atomic_radius.js', importName: 'createBerylliumAtomicRadius' },

  { id: 'beryllium_ionic_radius', name: 'Beryllium Ionic Radius', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_ionic_radius.js', importName: 'createBerylliumIonicRadius' },



  // --- Beryllium Batch 5 ---

  { id: 'beryllium_orbital_overlap', name: 'Beryllium Orbital Overlap', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_orbital_overlap.js', importName: 'createBerylliumOrbitalOverlap' },

  { id: 'beryllium_orbital_hybridization', name: 'Beryllium Orbital Hybridization', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_orbital_hybridization.js', importName: 'createBerylliumOrbitalHybridization' },

  { id: 'beryllium_electron_spin', name: 'Beryllium Electron Spin', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_electron_spin.js', importName: 'createBerylliumElectronSpin' },

  { id: 'beryllium_pauli_exclusion_principle', name: 'Beryllium Pauli Exclusion Principle', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_pauli_exclusion_principle.js', importName: 'createBerylliumPauliExclusionPrinciple' },

  { id: 'beryllium_hunds_rule', name: 'Beryllium Hund\'s Rule', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_hunds_rule.js', importName: 'createBerylliumHundsRule' },



  // --- Beryllium Batch 4 ---

  { id: 'beryllium_energy_levels', name: 'Beryllium Energy Levels', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_energy_levels.js', importName: 'createBerylliumEnergyLevels' },

  { id: 'beryllium_subshells', name: 'Beryllium Subshells', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_subshells.js', importName: 'createBerylliumSubshells' },

  { id: 'beryllium_s_orbitals', name: 'Beryllium s Orbitals', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_s_orbitals.js', importName: 'createBerylliumSOrbitals' },

  { id: 'beryllium_p_orbitals', name: 'Beryllium p Orbitals', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_p_orbitals.js', importName: 'createBerylliumPOrbitals' },

  { id: 'beryllium_d_orbitals', name: 'Beryllium d Orbitals', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_d_orbitals.js', importName: 'createBerylliumDOrbitals' },



  // --- Beryllium Batch 3 ---

  { id: 'beryllium_electron_electron_repulsion', name: 'Beryllium Electron Repulsion', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_electron_electron_repulsion.js', importName: 'createBerylliumElectronElectronRepulsion' },

  { id: 'beryllium_shielding_effect', name: 'Beryllium Shielding Effect', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_shielding_effect.js', importName: 'createBerylliumShieldingEffect' },

  { id: 'beryllium_effective_nuclear_charge', name: 'Beryllium Effective Nuclear Charge', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_effective_nuclear_charge.js', importName: 'createBerylliumEffectiveNuclearCharge' },

  { id: 'beryllium_nuclear_attraction', name: 'Beryllium Nuclear Attraction', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_nuclear_attraction.js', importName: 'createBerylliumNuclearAttraction' },

  { id: 'beryllium_electron_shells', name: 'Beryllium Electron Shells', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_electron_shells.js', importName: 'createBerylliumElectronShells' },



  // --- Beryllium Batch 2 ---

  { id: 'beryllium_schrodinger_model', name: 'Beryllium Schrödinger Model', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_schrodinger_model.js', importName: 'createBerylliumSchrodingerModel' },

  { id: 'beryllium_electron_cloud', name: 'Beryllium Electron Cloud', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_electron_cloud.js', importName: 'createBerylliumElectronCloud' },

  { id: 'beryllium_electron_density', name: 'Beryllium Electron Density', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_electron_density.js', importName: 'createBerylliumElectronDensity' },

  { id: 'beryllium_probability_density', name: 'Beryllium Probability Density', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_probability_density.js', importName: 'createBerylliumProbabilityDensity' },

  { id: 'beryllium_electron_proton_interaction', name: 'Beryllium Electron-Proton', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_electron_proton_interaction.js', importName: 'createBerylliumElectronProtonInteraction' },



  // --- Beryllium Batch 1 ---

  { id: 'beryllium_atomic_structure', name: 'Beryllium Atomic Structure', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_atomic_structure.js', importName: 'createBerylliumAtomicStructure' },

  { id: 'beryllium_bohr_model', name: 'Beryllium Bohr Model', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_bohr_model.js', importName: 'createBerylliumBohrModel' },

  { id: 'beryllium_rutherford_model', name: 'Beryllium Rutherford Model', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_rutherford_model.js', importName: 'createBerylliumRutherfordModel' },

  { id: 'beryllium_thomson_model', name: 'Beryllium Thomson Model', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_thomson_model.js', importName: 'createBerylliumThomsonModel' },

  { id: 'beryllium_quantum_mechanical_model', name: 'Beryllium Quantum Model', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_quantum_mechanical_model.js', importName: 'createBerylliumQuantumMechanicalModel' },



  // --- Batch 60: Real Life Models ---

  { id: 'hydrogen_fuel_cell', name: 'Hydrogen Fuel Cell', icon: '⚛️', category: 'real_life_models', importPath: './machines/hydrogen_fuel_cell.js', importName: 'createHydrogenFuelCell' },

  { id: 'van_de_graaff_generator', name: 'Van de Graaff Generator', icon: '⚛️', category: 'real_life_models', importPath: './machines/van_de_graaff_generator.js', importName: 'createVanDeGraaffGenerator' },

  { id: 'galvanic_cell', name: 'Galvanic Cell', icon: '⚛️', category: 'real_life_models', importPath: './machines/galvanic_cell.js', importName: 'createGalvanicCell' },

  { id: 'electrolysis_chamber', name: 'Electrolysis Chamber', icon: '⚛️', category: 'real_life_models', importPath: './machines/electrolysis_chamber.js', importName: 'createElectrolysisChamber' },

  { id: 'cyclotron', name: 'Cyclotron Accelerator', icon: '⚛️', category: 'real_life_models', importPath: './machines/cyclotron.js', importName: 'createCyclotron' },



  // --- Chemistry Batch 56: Carbon Part 2 ---

  { id: 'carbon_buckyball', name: 'Buckyball', icon: '⚛️', category: 'carbon', importPath: './machines/chemistry/carbon_buckyball.js', importName: 'createCarbonBuckyball' },

  { id: 'carbon_graphite', name: 'Graphite', icon: '⚛️', category: 'carbon', importPath: './machines/chemistry/carbon_graphite.js', importName: 'createCarbonGraphite' },

  { id: 'carbon_lonsdaleite', name: 'Lonsdaleite', icon: '⚛️', category: 'carbon', importPath: './machines/chemistry/carbon_lonsdaleite.js', importName: 'createCarbonLonsdaleite' },

  { id: 'carbon_fullerene_c70', name: 'Fullerene C70', icon: '⚛️', category: 'carbon', importPath: './machines/chemistry/carbon_fullerene_c70.js', importName: 'createCarbonFullereneC70' },

  { id: 'carbon_amorphous', name: 'Amorphous Carbon', icon: '⚛️', category: 'carbon', importPath: './machines/chemistry/carbon_amorphous.js', importName: 'createCarbonAmorphous' },

  { id: 'carbon_fiber', name: 'Carbon Fiber', icon: '⚛️', category: 'carbon', importPath: './machines/chemistry/carbon_fiber.js', importName: 'createCarbonFiber' },

  { id: 'carbon_carbyne', name: 'Carbyne', icon: '⚛️', category: 'carbon', importPath: './machines/chemistry/carbon_carbyne.js', importName: 'createCarbonCarbyne' },



  // --- Chemistry Batch 57: Carbon Part 3 ---

  { id: 'carbon_aerogel', name: 'Aerogel', icon: '⚛️', category: 'carbon', importPath: './machines/chemistry/carbon_aerogel.js', importName: 'createCarbonAerogel' },

  { id: 'carbon_fullerite', name: 'Fullerite', icon: '⚛️', category: 'carbon', importPath: './machines/chemistry/carbon_fullerite.js', importName: 'createCarbonFullerite' },

  { id: 'carbon_schwarzite', name: 'Schwarzite', icon: '⚛️', category: 'carbon', importPath: './machines/chemistry/carbon_schwarzite.js', importName: 'createCarbonSchwarzite' },

  { id: 'carbon_chaoite', name: 'Chaoite', icon: '⚛️', category: 'carbon', importPath: './machines/chemistry/carbon_chaoite.js', importName: 'createCarbonChaoite' },

  { id: 'carbon_glassy', name: 'Glassy Carbon', icon: '⚛️', category: 'carbon', importPath: './machines/chemistry/carbon_glassy.js', importName: 'createCarbonGlassy' },



  // --- Chemistry Batch 58: Nitrogen ---

  { id: 'nitrogen_gas', name: 'Nitrogen Gas', icon: '⚛️', category: 'nitrogen', importPath: './machines/chemistry/nitrogen_gas.js', importName: 'createNitrogenGas' },

  { id: 'nitrogen_liquid', name: 'Liquid Nitrogen', icon: '⚛️', category: 'nitrogen', importPath: './machines/chemistry/nitrogen_liquid.js', importName: 'createNitrogenLiquid' },

  { id: 'nitrogen_ammonia', name: 'Ammonia', icon: '⚛️', category: 'nitrogen', importPath: './machines/chemistry/nitrogen_ammonia.js', importName: 'createNitrogenAmmonia' },

  { id: 'nitrogen_nitric_acid', name: 'Nitric Acid', icon: '⚛️', category: 'nitrogen', importPath: './machines/chemistry/nitrogen_nitric_acid.js', importName: 'createNitrogenNitricAcid' },

  { id: 'nitrogen_nitrous_oxide', name: 'Nitrous Oxide', icon: '⚛️', category: 'nitrogen', importPath: './machines/chemistry/nitrogen_nitrous_oxide.js', importName: 'createNitrogenNitrousOxide' },



  // --- Batch 59 ---

  { id: 'superconducting_resonator', name: 'Superconducting Resonator', icon: '⚛️', category: 'quantum', importPath: './machines/superconducting_resonator.js', importName: 'createSuperconductingResonator', isPremium: true },
  ...
  { id: 'astro_sunshield', name: 'Space Sunshield', icon: '⚛️', category: 'astrophysics', importPath: './machines/astro_space_sunshield.js', importName: 'createSpaceSunshield' },

  { id: 'astro_coronagraph', name: 'Coronagraph Mask', icon: '⚛️', category: 'astrophysics', importPath: './machines/astro_space_coronagraph.js', importName: 'createCoronagraphMask' },

  { id: 'astro_xray', name: 'X-ray Mirror', icon: '⚛️', category: 'astrophysics', importPath: './machines/astro_space_xray_mirror.js', importName: 'createXRayMirror' },

  { id: 'astro_tracker', name: 'Star Tracker', icon: '⚛️', category: 'astrophysics', importPath: './machines/astro_space_star_tracker.js', importName: 'createStarTracker' },

  { id: 'astro_horn', name: 'Radio Feed Horn', icon: '⚛️', category: 'astrophysics', importPath: './machines/astro_space_radio_feed_horn.js', importName: 'createRadioFeedHorn' },



  { id: 'astro_deformable', name: 'Deformable Mirror', icon: '⚛️', category: 'astrophysics', importPath: './machines/astro_deformable_mirror.js', importName: 'createDeformableMirror' },

  { id: 'astro_interf_arm', name: 'LIGO Arm', icon: '⚛️', category: 'astrophysics', importPath: './machines/astro_interferometer_arm.js', importName: 'createInterferometerArm' },

  { id: 'astro_pmt', name: 'Neutrino PMT', icon: '⚛️', category: 'astrophysics', importPath: './machines/astro_neutrino_pmt.js', importName: 'createNeutrinoPMT' },

  { id: 'astro_ccd', name: 'CCD Sensor Array', icon: '⚛️', category: 'astrophysics', importPath: './machines/astro_ccd_sensor_array.js', importName: 'createCCDSensorArray' },

  { id: 'astro_grating', name: 'Spectrograph Grating', icon: '⚛️', category: 'astrophysics', importPath: './machines/astro_spectrograph_grating.js', importName: 'createSpectrographGrating' },
  ...
  { id: 'aero_bow', name: 'Bow Thruster', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_bow_thruster.js', importName: 'createShipBowThruster' },

  { id: 'aero_flap', name: 'Flap Track', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_flap_track.js', importName: 'createAirplaneFlapTrack' },

  { id: 'aero_tail', name: 'Tail Rotor', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_tail_rotor.js', importName: 'createHelicopterTailRotor' },

  { id: 'aero_pelton', name: 'Pelton Wheel', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_pelton_wheel.js', importName: 'createPeltonWheel' },

  { id: 'aero_pitot', name: 'Pitot Tube', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_pitot_tube.js', importName: 'createAircraftPitotTube' },
  ...
  { id: 'aero_ballast', name: 'Submarine Ballast', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_submarine_ballast.js', importName: 'createBallastTank' },

  { id: 'aero_hydrofoil', name: 'Hydrofoil Strut', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_hydrofoil_strut.js', importName: 'createHydrofoilStrut' },

  { id: 'aero_liftfan', name: 'Hovercraft Lift Fan', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_hovercraft_lift_fan.js', importName: 'createLiftFan' },

  { id: 'aero_stator_vane', name: 'Jet Stator Vane', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_jet_stator_vane.js', importName: 'createStatorVane' },
  ...
  { id: 'aero_swashplate', name: 'Heli Swashplate', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_helicopter_swashplate.js', importName: 'createHelicopterSwashplate' },

  { id: 'aero_prop', name: 'Variable-Pitch Prop', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_variable_pitch_propeller.js', importName: 'createVariablePitchPropeller' },

  { id: 'aero_gear', name: 'Landing Gear', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_retracting_landing_gear.js', importName: 'createRetractingLandingGear' },

  { id: 'aero_reverser', name: 'Thrust Reverser', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_thrust_reverser.js', importName: 'createThrustReverser' },

  { id: 'aero_gyro', name: 'Artificial Horizon', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_gyroscopic_horizon.js', importName: 'createGyroscopicHorizon' },
  ...
  { id: 'bridge_anchor', name: 'Suspension Anchor', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_suspension_anchor.js', importName: 'createSuspensionAnchor' },

  { id: 'bridge_pylon', name: 'Cable-Stayed Pylon', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_cable_stayed_pylon.js', importName: 'createCableStayedPylon' },

  { id: 'bridge_bascule', name: 'Bascule Drawbridge', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_bascule_bridge.js', importName: 'createBasculeBridge' },

  { id: 'bridge_swing', name: 'Swing Bridge', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_swing_bridge.js', importName: 'createSwingBridge' },

  { id: 'bridge_truss', name: 'Truss Bridge Joint', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_truss_bridge_joint.js', importName: 'createTrussBridgeJoint' },



  { id: 'audio_dynamic', name: 'Dynamic Mic', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/audio_dynamic_mic.js', importName: 'createDynamicMic' },

  { id: 'audio_condenser', name: 'Condenser Mic', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/audio_condenser_mic.js', importName: 'createCondenserMic' },

  { id: 'audio_ribbon', name: 'Ribbon Tweeter', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/audio_ribbon_tweeter.js', importName: 'createRibbonTweeter' },

  { id: 'audio_gramophone', name: 'Gramophone Tonearm', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/audio_gramophone.js', importName: 'createGramophone' },
  ...
  { id: 'weap_match', name: 'Matchlock Mechanism', icon: '⚛️', category: 'historical_engineering', importPath: './machines/weaponry_matchlock.js', importName: 'createMatchlock' },

  { id: 'weap_crossbow', name: 'Crossbow Trigger', icon: '⚛️', category: 'historical_engineering', importPath: './machines/weaponry_crossbow_trigger.js', importName: 'createCrossbowTrigger' },

  { id: 'weap_flint', name: 'Flintlock Firing', icon: '⚛️', category: 'historical_engineering', importPath: './machines/weaponry_flintlock.js', importName: 'createFlintlock' },

  { id: 'weap_wheel', name: 'Wheel-lock Mechanism', icon: '⚛️', category: 'historical_engineering', importPath: './machines/weaponry_wheel_lock.js', importName: 'createWheelLock' },

  { id: 'weap_cannon', name: 'Cannon Recoil System', icon: '⚛️', category: 'historical_engineering', importPath: './machines/weaponry_cannon_recoil.js', importName: 'createCannonRecoil' },
  ...
  { id: 'time_water', name: 'Water Clock', icon: '⚛️', category: 'historical_engineering', importPath: './machines/timekeeping_water_clock.js', importName: 'createWaterClock' },

  { id: 'time_pendulum', name: 'Pendulum Escapement', icon: '⚛️', category: 'historical_engineering', importPath: './machines/timekeeping_pendulum_escapement.js', importName: 'createPendulumEscapement' },

  { id: 'time_marine', name: 'Marine Chronometer', icon: '⚛️', category: 'historical_engineering', importPath: './machines/timekeeping_marine_chronometer.js', importName: 'createMarineChronometer' },

  { id: 'time_astro', name: 'Astrolabe', icon: '⚛️', category: 'historical_engineering', importPath: './machines/timekeeping_astrolabe.js', importName: 'createAstrolabe' },

  { id: 'time_incense', name: 'Incense Clock', icon: '⚛️', category: 'historical_engineering', importPath: './machines/timekeeping_incense_clock.js', importName: 'createIncenseClock' },
  ...
  { id: 'siege_treb', name: 'Trebuchet', icon: '⚛️', category: 'historical_engineering', importPath: './machines/siege_trebuchet.js', importName: 'createTrebuchet' },

  { id: 'siege_ballista', name: 'Roman Ballista', icon: '⚛️', category: 'historical_engineering', importPath: './machines/siege_ballista.js', importName: 'createBallista' },

  { id: 'siege_ram', name: 'Battering Ram', icon: '⚛️', category: 'historical_engineering', importPath: './machines/siege_battering_ram.js', importName: 'createBatteringRam' },

  { id: 'siege_tower', name: 'Siege Tower', icon: '⚛️', category: 'historical_engineering', importPath: './machines/siege_tower.js', importName: 'createSiegeTower' },

  { id: 'siege_fire', name: 'Greek Fire Siphon', icon: '⚛️', category: 'historical_engineering', importPath: './machines/siege_greek_fire.js', importName: 'createGreekFireSiphon' },
  ...
  { id: 'robo_biped', name: 'Bipedal Mechanism', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/robotics_bipedal_mechanism.js', importName: 'createBipedalMechanism' },

  { id: 'robo_arm', name: 'Welding Arm', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/robotics_industrial_welding_arm.js', importName: 'createIndustrialWeldingArm' },

  { id: 'robo_face', name: 'Animatronic Face', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/robotics_animatronic_facial_rig.js', importName: 'createAnimatronicFacialRig' },

  { id: 'robo_wheel', name: 'Omni-Directional Wheel', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/robotics_omni_directional_wheel_drive.js', importName: 'createOmniDirectionalWheelDrive' },

  { id: 'robo_leg', name: 'Quadruped Robot Leg', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/robotics_quadruped_robot_leg.js', importName: 'createQuadrupedRobotLeg' },
  ...
  { id: 'vin_turing', name: 'Turing Bombe Machine', icon: '⚛️', category: 'vintage_tech', importPath: './machines/vintage_turing_bombe.js', importName: 'createTuringBombe' },

  { id: 'vin_anti', name: 'Antikythera Mechanism', icon: '⚛️', category: 'vintage_tech', importPath: './machines/vintage_antikythera_mechanism.js', importName: 'createAntikytheraMechanism' },

  { id: 'vin_core', name: 'Core Memory Matrix', icon: '⚛️', category: 'vintage_tech', importPath: './machines/vintage_core_memory_matrix.js', importName: 'createCoreMemoryMatrix' },

  { id: 'vin_tube', name: 'Vacuum Tube Logic Gate', icon: '⚛️', category: 'vintage_tech', importPath: './machines/vintage_vacuum_tube_logic.js', importName: 'createVacuumTubeLogicGate' },

  { id: 'vin_punch', name: 'Punch Card Reader', icon: '⚛️', category: 'vintage_tech', importPath: './machines/vintage_punch_card_reader.js', importName: 'createPunchCardReader' },
  ...
  { id: 'space_cupola', name: 'Cupola Obs Module', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/space_station_cupola.js', importName: 'createCupolaModule' },

  { id: 'space_solar', name: 'Solar Array Truss', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/space_station_solar_array.js', importName: 'createSolarArrayTruss' },

  { id: 'space_dock', name: 'Docking Port Adapter', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/space_station_docking_port.js', importName: 'createDockingPortAdapter' },

  { id: 'space_centrifuge', name: 'Centrifuge Habitat', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/space_station_centrifuge.js', importName: 'createCentrifugeHabitat' },

  { id: 'space_airlock', name: 'Airlock Chamber', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/space_station_airlock.js', importName: 'createAirlockChamber' },
  ...
  { id: 'sea_bathy', name: 'Bathysphere', icon: '⚛️', category: 'marine_engineering', importPath: './machines/deep_sea_bathysphere.js', importName: 'createBathysphere' },

  { id: 'sea_arm', name: 'ROV Manipulator Arm', icon: '⚛️', category: 'marine_engineering', importPath: './machines/deep_sea_rov_arm.js', importName: 'createROVArm' },

  { id: 'sea_sonar', name: 'Sonar Array', icon: '⚛️', category: 'marine_engineering', importPath: './machines/deep_sea_sonar_array.js', importName: 'createSonarArray' },

  { id: 'sea_sub', name: 'Deep Sea Submersible', icon: '⚛️', category: 'marine_engineering', importPath: './machines/deep_sea_submersible.js', importName: 'createSubmersible' },

  { id: 'sea_thruster', name: 'Underwater Thruster', icon: '⚛️', category: 'marine_engineering', importPath: './machines/deep_sea_thruster.js', importName: 'createUnderwaterThruster' },



  { id: 'da_vinci_screw', name: 'Aerial Screw', icon: '⚛️', category: 'historical_engineering', importPath: './machines/da_vinci_aerial_screw.js', importName: 'createAerialScrew' },

  { id: 'da_vinci_tank', name: 'Armored Tank Gearbox', icon: '⚛️', category: 'historical_engineering', importPath: './machines/da_vinci_armored_tank_gearbox.js', importName: 'createArmoredTankGearbox' },

  { id: 'da_vinci_cannon', name: 'Multi-Barrel Cannon', icon: '⚛️', category: 'historical_engineering', importPath: './machines/da_vinci_multi_barrel_cannon.js', importName: 'createMultiBarrelCannon' },

  { id: 'da_vinci_wings', name: 'Ornithopter Wings', icon: '⚛️', category: 'historical_engineering', importPath: './machines/da_vinci_ornithopter_wings.js', importName: 'createOrnithopterWings' },

  { id: 'da_vinci_boat', name: 'Paddle Boat Mechanism', icon: '⚛️', category: 'historical_engineering', importPath: './machines/da_vinci_paddle_boat_mechanism.js', importName: 'createPaddleBoatMechanism' },
  ...
  { id: 'mars_crane', name: 'Descent Stage Crane', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/mars_rover_descent_stage_crane.js', importName: 'createDescentStageCrane' },

  { id: 'mars_rtg', name: 'Multi-Mission RTG', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/mars_rover_multi_mission_rtg.js', importName: 'createMultiMissionRTG' },

  { id: 'mars_mast', name: 'Panoramic Camera Mast', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/mars_rover_panoramic_camera_mast.js', importName: 'createPanoramicCameraMast' },

  { id: 'mars_bogie', name: 'Rocker-Bogie Suspension', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/mars_rover_rocker_bogie.js', importName: 'createRockerBogie' },

  { id: 'mars_drill', name: 'Sample Return Drill', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/mars_rover_sample_return_drill.js', importName: 'createSampleReturnDrill' },



  { id: 'geo_pump', name: 'Geothermal Heat Pump', icon: '⚛️', category: 'marine_engineering', importPath: './machines/ocean_geo_geothermal_heat_pump.js', importName: 'createGeothermalHeatPump' },

  { id: 'geo_otec', name: 'OTEC Plant', icon: '⚛️', category: 'marine_engineering', importPath: './machines/ocean_geo_otec_plant.js', importName: 'createOtecPlant' },

  { id: 'geo_salinity', name: 'Salinity Gradient', icon: '⚛️', category: 'marine_engineering', importPath: './machines/ocean_geo_salinity_gradient_generator.js', importName: 'createSalinityGradientGenerator' },

  { id: 'geo_tidal', name: 'Tidal Turbine', icon: '⚛️', category: 'marine_engineering', importPath: './machines/ocean_geo_tidal_turbine.js', importName: 'createTidalTurbine' },

  { id: 'geo_wave', name: 'Wave Energy Converter', icon: '⚛️', category: 'marine_engineering', importPath: './machines/ocean_geo_wave_energy_converter.js', importName: 'createWaveEnergyConverter' },



  { id: 'cam_flash', name: 'Flashbulb Synchronizer', icon: '⚛️', category: 'vintage_tech', importPath: './machines/vintage_camera_flashbulb.js', importName: 'createFlashbulbSynchronizer' },

  { id: 'cam_instant', name: 'Instant Film Mechanism', icon: '⚛️', category: 'vintage_tech', importPath: './machines/vintage_camera_instant.js', importName: 'createInstantFilmMechanism' },

  { id: 'cam_range', name: 'Rangefinder Mechanism', icon: '⚛️', category: 'vintage_tech', importPath: './machines/vintage_camera_rangefinder.js', importName: 'createRangefinderMechanism' },

  { id: 'cam_tlr', name: 'Twin-Lens Reflex', icon: '⚛️', category: 'vintage_tech', importPath: './machines/vintage_camera_tlr.js', importName: 'createTwinLensReflex' },

  { id: 'cam_view', name: 'Large Format Camera', icon: '⚛️', category: 'vintage_tech', importPath: './machines/vintage_camera_view.js', importName: 'createLargeFormatViewCamera' },



  { id: 'audio_mic', name: 'Dynamic Microphone', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/audio_tech_dynamic_microphone.js', importName: 'createDynamicMicrophone' },

  { id: 'audio_speaker_v2', name: 'Electrostatic Speaker', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/audio_tech_electrostatic_speaker.js', importName: 'createElectrostaticSpeaker' },

  { id: 'audio_coil', name: 'Moving Coil Cartridge', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/audio_tech_moving_coil_cartridge.js', importName: 'createMovingCoilCartridge' },

  { id: 'audio_tape', name: 'Reel-to-Reel Tape Deck', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/audio_tech_reel_to_reel_tape_deck.js', importName: 'createReelToReelTapeDeck' },

  { id: 'audio_amp', name: 'Vacuum Tube Amplifier', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/audio_tech_vacuum_tube_amplifier.js', importName: 'createVacuumTubeAmplifier' },



  // --- Batch 45 ---

  { id: 'theme_bumper', name: 'Bumper Car', icon: '⚛️', category: 'amusement_rides', importPath: './machines/theme_park_bumper_car.js', importName: 'createBumperCar' },

  { id: 'theme_drop', name: 'Drop Tower', icon: '⚛️', category: 'amusement_rides', importPath: './machines/theme_park_drop_tower.js', importName: 'createDropTower' },

  { id: 'theme_pendulum', name: 'Giant Pendulum', icon: '⚛️', category: 'amusement_rides', importPath: './machines/theme_park_giant_pendulum.js', importName: 'createGiantPendulumRide' },

  { id: 'theme_scrambler', name: 'Scrambler Ride', icon: '⚛️', category: 'amusement_rides', importPath: './machines/theme_park_scrambler.js', importName: 'createScramblerRide' },

  { id: 'theme_topspin', name: 'Top Spin Ride', icon: '⚛️', category: 'amusement_rides', importPath: './machines/theme_park_top_spin.js', importName: 'createTopSpinRide' },
  ...
  { id: 'heli_main', name: 'Main Rotor Hub', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/helicopter_main_rotor.js', importName: 'createMainRotor' },

  { id: 'heli_skid', name: 'Landing Skid Dampener', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/helicopter_skid_dampener.js', importName: 'createSkidDampener' },

  { id: 'heli_swash', name: 'Helicopter Swashplate', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/helicopter_swashplate.js', importName: 'createSwashplate' },

  { id: 'heli_tail', name: 'Tail Rotor Assembly', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/helicopter_tail_rotor.js', importName: 'createTailRotor' },

  { id: 'heli_engine', name: 'Turboshaft Engine', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/helicopter_turboshaft_engine.js', importName: 'createTurboshaftEngine' },
  ...
  { id: 'auto_brake', name: 'Disc Brake System', icon: '⚛️', category: 'automotive_engineering', importPath: './machines/automotive_disc_brake.js', importName: 'createDiscBrake' },

  { id: 'auto_trans', name: 'Manual Transmission', icon: '⚛️', category: 'automotive_engineering', importPath: './machines/automotive_manual_transmission.js', importName: 'createManualTransmission' },

  { id: 'auto_diff', name: 'Open Differential Gear', icon: '⚛️', category: 'automotive_engineering', importPath: './machines/automotive_open_differential.js', importName: 'createOpenDifferential' },

  { id: 'auto_rack', name: 'Rack and Pinion', icon: '⚛️', category: 'automotive_engineering', importPath: './machines/automotive_rack_and_pinion.js', importName: 'createRackAndPinion' },

  { id: 'auto_suspension', name: 'Suspension Strut', icon: '⚛️', category: 'automotive_engineering', importPath: './machines/automotive_suspension_strut.js', importName: 'createSuspensionStrut' },
  ...
  { id: 'hist_ballista', name: 'Roman Ballista', icon: '⚛️', category: 'historical_engineering', importPath: './machines/historical_ballista.js', importName: 'createBallista' },

  { id: 'hist_ram', name: 'Battering Ram', icon: '⚛️', category: 'historical_engineering', importPath: './machines/historical_battering_ram.js', importName: 'createBatteringRam' },

  { id: 'hist_catapult', name: 'Catapult', icon: '⚛️', category: 'historical_engineering', importPath: './machines/historical_catapult.js', importName: 'createCatapult' },

  { id: 'hist_tower', name: 'Siege Tower', icon: '⚛️', category: 'historical_engineering', importPath: './machines/historical_siege_tower.js', importName: 'createSiegeTower' },

  { id: 'hist_trebuchet', name: 'Trebuchet', icon: '⚛️', category: 'historical_engineering', importPath: './machines/historical_trebuchet.js', importName: 'createTrebuchet' },
  ...
  { id: 'net_cell', name: '5G Cell Tower', icon: '⚛️', category: 'network_engineering', importPath: './machines/network_5g_cell_tower.js', importName: 'createCellTower' },

  { id: 'net_fiber', name: 'Subsea Fiber Cable', icon: '⚛️', category: 'network_engineering', importPath: './machines/network_subsea_fiber_cable.js', importName: 'createSubseaFiberCable' },

  { id: 'net_sat', name: 'Satellite Dish Array', icon: '⚛️', category: 'network_engineering', importPath: './machines/network_satellite_dish_array.js', importName: 'createSatelliteDishArray' },

  { id: 'net_server', name: 'Datacenter Server Rack', icon: '⚛️', category: 'network_engineering', importPath: './machines/network_datacenter_server_rack.js', importName: 'createDatacenterServerRack' },

  { id: 'net_switch', name: 'High-Speed Network Switch', icon: '⚛️', category: 'network_engineering', importPath: './machines/network_high_speed_switch.js', importName: 'createHighSpeedNetworkSwitch' },



  { id: 'audio_speaker_v3', name: 'Dynamic Loudspeaker', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/audio_loudspeaker.js', importName: 'createLoudspeaker' },

  { id: 'audio_vinyl', name: 'Vinyl Turntable', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/audio_turntable.js', importName: 'createTurntable' },

  { id: 'audio_mixer', name: 'Audio Mixing Console', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/audio_mixer.js', importName: 'createMixer' },



  // --- Batch 40 ---

  { id: 'pwr_nuke', name: 'Nuclear Power Plant', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/power_generation_nuclear_plant.js', importName: 'createNuclearPlant' },

  { id: 'pwr_coal', name: 'Coal Power Plant', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/power_generation_coal_plant.js', importName: 'createCoalPlant' },

  { id: 'pwr_hydro', name: 'Hydroelectric Dam', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/power_generation_hydroelectric_dam.js', importName: 'createHydroelectricDam' },

  { id: 'pwr_wind', name: 'Wind Turbine', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/power_generation_wind_turbine.js', importName: 'createWindTurbine' },

  { id: 'pwr_geo', name: 'Geothermal Plant', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/power_generation_geothermal_plant.js', importName: 'createGeothermalPlant' },
  ...
  { id: 'heavy_exc', name: 'Excavator', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/heavy_machinery_excavator.js', importName: 'createExcavator' },

  { id: 'heavy_bull', name: 'Bulldozer', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/heavy_machinery_bulldozer.js', importName: 'createBulldozer' },

  { id: 'heavy_crane', name: 'Tower Crane', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/heavy_machinery_tower_crane.js', importName: 'createTowerCrane' },

  { id: 'heavy_tbm', name: 'Tunnel Boring Machine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/heavy_machinery_tbm.js', importName: 'createTBM' },

  { id: 'heavy_dump', name: 'Dump Truck', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/heavy_machinery_dump_truck.js', importName: 'createDumpTruck' },
  ...
  { id: 'astro_oscil', name: 'Stellar Oscillator', icon: '⚛️', category: 'astrophysics', importPath: './machines/astroseismology_stellar_oscillator.js', importName: 'createStellarOscillator' },

  { id: 'astro_pulse', name: 'Pulsation Modes', icon: '⚛️', category: 'astrophysics', importPath: './machines/astroseismology_pulsation_modes.js', importName: 'createPulsationModes' },

  { id: 'astro_core', name: 'Core Resonance', icon: '⚛️', category: 'astrophysics', importPath: './machines/astroseismology_core_resonance.js', importName: 'createCoreResonance' },

  { id: 'astro_acoustic', name: 'Acoustic Waves', icon: '⚛️', category: 'astrophysics', importPath: './machines/astroseismology_acoustic_waves.js', importName: 'createAcousticWaves' },

  { id: 'astro_doppler', name: 'Doppler Imager', icon: '⚛️', category: 'astrophysics', importPath: './machines/astroseismology_doppler_imager.js', importName: 'createDopplerImager' },
  ...
  { id: 'cosmo_isotope', name: 'Isotope Analyzer', icon: '⚛️', category: 'astrophysics', importPath: './machines/cosmochemistry_isotope_analyzer.js', importName: 'createIsotopeAnalyzer' },

  { id: 'cosmo_nebula', name: 'Nebula Simulator', icon: '⚛️', category: 'astrophysics', importPath: './machines/cosmochemistry_nebula_simulator.js', importName: 'createNebulaSimulator' },

  { id: 'cosmo_sublimator', name: 'Cometary Sublimator', icon: '⚛️', category: 'astrophysics', importPath: './machines/cosmochemistry_cometary_sublimator.js', importName: 'createCometarySublimator' },

  { id: 'cosmo_ion', name: 'Presolar Ion Probe', icon: '⚛️', category: 'astrophysics', importPath: './machines/cosmochemistry_ion_probe.js', importName: 'createIonProbe' },

  { id: 'cosmo_furnace', name: 'Chondrule Furnace', icon: '⚛️', category: 'astrophysics', importPath: './machines/cosmochemistry_chondrule_furnace.js', importName: 'createChondruleFurnace' },
  ...
  { id: 'ca_cache', name: 'Cache Hierarchy', icon: '⚛️', category: 'computer_engineering', importPath: './machines/computer_architecture_cache_hierarchy.js', importName: 'createCacheHierarchy' },

  { id: 'ca_vonneumann', name: 'Von Neumann Architecture', icon: '⚛️', category: 'computer_engineering', importPath: './machines/computer_architecture_von_neumann.js', importName: 'createVonNeumann' },

  { id: 'ca_alu', name: 'ALU', icon: '⚛️', category: 'computer_engineering', importPath: './machines/computer_architecture_alu.js', importName: 'createAlu' },

  { id: 'ca_turing', name: 'Turing Machine', icon: '⚛️', category: 'computer_engineering', importPath: './machines/computer_architecture_turing_machine.js', importName: 'createTuringMachine' },

  { id: 'net_router', name: 'Router', icon: '⚛️', category: 'network_engineering', importPath: './machines/networking_router.js', importName: 'createRouterModel' },

  { id: 'net_switch_v2', name: 'Network Switch', icon: '⚛️', category: 'network_engineering', importPath: './machines/networking_switch.js', importName: 'createSwitchModel' },

  { id: 'net_datacenter', name: 'Data Center Rack', icon: '⚛️', category: 'network_engineering', importPath: './machines/networking_datacenter_rack.js', importName: 'createDataCenterRack' },
  ...
  { id: 'aero_wind', name: 'Wind Tunnel', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerodynamics_wind_tunnel.js', importName: 'createWindTunnel' },

  { id: 'aero_lift', name: 'Airfoil Lift', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerodynamics_airfoil_lift.js', importName: 'createAirfoilLift' },

  { id: 'aero_thrust', name: 'Propeller Thrust', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerodynamics_propeller_thrust.js', importName: 'createPropellerThrust' },

  { id: 'aero_magnus', name: 'Magnus Effect', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerodynamics_magnus_effect.js', importName: 'createMagnusEffect' },

  { id: 'aero_shock', name: 'Shock Wave', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerodynamics_shock_wave.js', importName: 'createShockWave' },
  ...
  { id: 'orbit_two', name: 'Two-Body Orbit', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/orbital_mechanics_two_body.js', importName: 'createTwoBodyOrbit' },

  { id: 'orbit_hohmann', name: 'Hohmann Transfer', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/orbital_mechanics_hohmann_transfer.js', importName: 'createHohmannTransfer' },

  { id: 'orbit_three', name: 'Three-Body Problem', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/orbital_mechanics_three_body.js', importName: 'createThreeBodyProblem' },

  { id: 'orbit_constellation', name: 'Satellite Constellation', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/orbital_mechanics_satellite_constellation.js', importName: 'createSatelliteConstellation' },

  { id: 'orbit_kepler', name: 'Kepler Laws', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/orbital_mechanics_kepler_laws.js', importName: 'createKeplersLaws' },
...
// --- Batch 24: Nuclear, Biomedical, Fluids, Organic, Inorganic ---
  ...
  { id: 'jet_engine', name: 'Turbofan Jet Engine', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/jet_engine.js', importName: 'createJetEngine' },

  { id: 'airfoil', name: 'Airfoil Section', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/airfoil.js', importName: 'createAirfoil' },

  { id: 'supersonic', name: 'De Laval Supersonic Nozzle', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/supersonic_nozzle.js', importName: 'createSupersonicNozzle' },
  ...
  { id: 'hohmann', name: 'Hohmann Transfer Orbit', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/hohmann_transfer.js', importName: 'createHohmannTransferOrbit' },

  { id: 'lagrange', name: 'Lagrange Points System', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/lagrange_points.js', importName: 'createLagrangePointsSystem' },

  { id: 'gravity_assist', name: 'Gravity Assist Maneuver', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/gravity_assist.js', importName: 'createGravityAssistManeuver' },

  { id: 'geosync', name: 'Geosynchronous Satellite', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/geosynchronous_satellite.js', importName: 'createGeosynchronousSatellite' },

  { id: 'orbital_res', name: 'Orbital Resonance System', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/orbital_resonance.js', importName: 'createOrbitalResonanceSystem' },
  ...
  { id: 'memory_hierarchy', name: 'Cache & Memory Hierarchy', icon: '⚛️', category: 'computer_engineering', importPath: './machines/memory_hierarchy.js', importName: 'createMemoryHierarchy' },

  { id: 'gpu_architecture', name: 'GPU Streaming Multiprocessor', icon: '⚛️', category: 'computer_engineering', importPath: './machines/gpu_architecture.js', importName: 'createGpuArchitecture' },

  { id: 'ooo_execution', name: 'Out-of-Order Execution Core', icon: '⚛️', category: 'computer_engineering', importPath: './machines/ooo_execution.js', importName: 'createOooExecution' },

  { id: 'dc_switch', name: 'Data Center Switch', icon: '⚛️', category: 'network_engineering', importPath: './machines/data_center_switch.js', importName: 'createDataCenterSwitch' },

  { id: 'cell_tower', name: 'Next-Gen Cell Tower', icon: '⚛️', category: 'network_engineering', importPath: './machines/next_gen_cell_tower.js', importName: 'createNextGenCellTower' },
  ...
  { id: 'engine', name: '4-Cylinder Engine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/engine.js', importName: 'createEngine' },

  { id: 'motor', name: 'Electric Motor', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/motor.js', importName: 'createMotor' },

  { id: 'fan', name: 'Ceiling Fan', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/fan.js', importName: 'createFan' },

  { id: 'clock', name: 'Mechanical Clock', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/clock.js', importName: 'createClock' },

  { id: 'gears', name: 'Gear Train', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/gears.js', importName: 'createGears' },
  ...
  { id: 'rocket', name: 'Rocket Engine', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/rocket.js', importName: 'createRocket' },

  { id: 'battery', name: 'Lead-Acid Battery', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/battery.js', importName: 'createBattery' },

  { id: 'charger', name: 'Phone Charger', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/charger.js', importName: 'createCharger' },

  { id: 'v8engine', name: 'V8 Engine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/v8engine.js', importName: 'createV8Engine' },

  { id: 'v12engine', name: 'V12 Engine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/v12engine.js', importName: 'createV12Engine' },

  { id: 'inline6', name: 'Inline-6 Engine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/inline6.js', importName: 'createInline6Engine' },

  { id: 'boxer', name: 'Boxer Engine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/boxer.js', importName: 'createBoxerEngine' },

  { id: 'v6engine', name: 'V6 Engine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/v6engine.js', importName: 'createV6Engine' },

  { id: 'v10engine', name: 'V10 Engine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/v10engine.js', importName: 'createV10Engine' },

  { id: 'w12engine', name: 'W12 Engine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/w12engine.js', importName: 'createW12Engine' },

  { id: 'w16engine', name: 'W16 Engine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/w16engine.js', importName: 'createW16Engine' },

  { id: 'transmission', name: 'Transmission', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/transmission.js', importName: 'createTransmission' },

  { id: 'diesel', name: 'Diesel Engine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/diesel.js', importName: 'createDieselEngine' },

  { id: 'hybrid', name: 'Hybrid Powertrain', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/hybrid.js', importName: 'createHybrid' },

  { id: 'carburetor', name: 'Carburetor', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/carburetor.js', importName: 'createCarburetor' },
  ...
  { id: 'articulated_robot_arm', name: 'Articulated Robot Arm', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/articulated_robot_arm.js', importName: 'createArticulatedRobotArm' },

  { id: 'autonomous_mobile_robot', name: 'Autonomous Mobile Robot', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/autonomous_mobile_robot.js', importName: 'createAutonomousMobileRobot' },

  { id: 'hexapod_walker', name: 'Hexapod Walker', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/hexapod_walker.js', importName: 'createHexapodWalker' },

  { id: 'surgical_robot', name: 'Surgical Robot', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/surgical_robot.js', importName: 'createSurgicalRobot' },

  { id: 'humanoid_bipedal_robot', name: 'Humanoid Bipedal Robot', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/humanoid_bipedal_robot.js', importName: 'createHumanoidBipedalRobot' },
  ...
  { id: 'tuning_fork', name: 'Tuning Fork', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/tuning_fork.js', importName: 'createTuningFork' },

  { id: 'speaker_cone', name: 'Speaker Cone', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/speaker_cone.js', importName: 'createSpeakerCone' },

  { id: 'anechoic_chamber', name: 'Anechoic Chamber', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/anechoic_chamber.js', importName: 'createAnechoicChamber' },

  { id: 'sonar_array', name: 'Submarine Sonar Array', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/sonar_array.js', importName: 'createSonarArray' },
  ...
  { id: 'suspension_bridge', name: 'Suspension Bridge', icon: '⚛️', category: 'civil_engineering', importPath: './machines/suspension_bridge.js', importName: 'createSuspensionBridge' },

  { id: 'hydroelectric_dam', name: 'Hydroelectric Dam', icon: '⚛️', category: 'civil_engineering', importPath: './machines/hydroelectric_dam.js', importName: 'createHydroelectricDam' },

  { id: 'tunnel_boring_machine', name: 'Tunnel Boring Machine', icon: '⚛️', category: 'civil_engineering', importPath: './machines/tunnel_boring_machine.js', importName: 'createTunnelBoringMachine' },

  { id: 'skyscraper_tuned_mass_damper', name: 'Tuned Mass Damper', icon: '⚛️', category: 'civil_engineering', importPath: './machines/tuned_mass_damper.js', importName: 'createTunedMassDamper' },

  { id: 'arch_bridge', name: 'Arch Bridge', icon: '⚛️', category: 'civil_engineering', importPath: './machines/arch_bridge.js', importName: 'createArchBridge' },



  // --- Marine ---

  { id: 'submarine_propulsion', name: 'Nuclear Submarine Propulsion', icon: '⚛️', category: 'marine_engineering', importPath: './machines/submarine_propulsion.js', importName: 'createSubmarinePropulsion' },

  { id: 'dynamic_positioning', name: 'Dynamic Positioning System', icon: '⚛️', category: 'marine_engineering', importPath: './machines/dynamic_positioning.js', importName: 'createDynamicPositioning' },

  { id: 'marine_desalination_plant', name: 'Marine Desalination Plant', icon: '⚛️', category: 'marine_engineering', importPath: './machines/desalination_plant.js', importName: 'createDesalinationPlant' },

  { id: 'ship_stabilizer', name: 'Active Fin Stabilizer', icon: '⚛️', category: 'marine_engineering', importPath: './machines/ship_stabilizer.js', importName: 'createShipStabilizer' },

  { id: 'marine_diesel_engine', name: 'Two-Stroke Marine Diesel Engine', icon: '⚛️', category: 'marine_engineering', importPath: './machines/marine_diesel_engine.js', importName: 'createMarineDieselEngine' },



  // --- Aerospace ---

  { id: 'turbofan_jet_engine', name: 'Turbofan Jet Engine', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/jet_engine.js', importName: 'createJetEngine' },

  { id: 'space_shuttle', name: 'Space Shuttle Orbiter', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/space_shuttle.js', importName: 'createSpaceShuttle' },

  { id: 'satellite', name: 'Communications Satellite', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/satellite.js', importName: 'createSatellite' },
  ...
  { id: 'acid_base_titration', name: 'Acid Base Titration', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/acid_base_titration.js', importName: 'createAcidBaseTitration' },

  { id: 'acoustics_doppler_effect', name: 'Acoustics Doppler Effect', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/acoustics_doppler_effect.js', importName: 'createAcousticsDopplerEffect' },

  { id: 'acoustics_helmholtz_resonator', name: 'Acoustics Helmholtz Resonator', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/acoustics_helmholtz_resonator.js', importName: 'createAcousticsHelmholtzResonator' },

  { id: 'acoustics_interference_pattern', name: 'Acoustics Interference Pattern', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/acoustics_interference_pattern.js', importName: 'createAcousticsInterferencePattern' },

  { id: 'acoustics_resonance_chamber', name: 'Acoustics Resonance Chamber', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/acoustics_resonance_chamber.js', importName: 'createAcousticsResonanceChamber' },

  { id: 'acoustics_wave_propagation', name: 'Acoustics Wave Propagation', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/acoustics_wave_propagation.js', importName: 'createAcousticsWavePropagation' },

  { id: 'acoustic_levitation_chamber', name: 'Acoustic Levitation Chamber', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/acoustic_levitation_chamber.js', importName: 'createAcousticLevitationChamber' },

  { id: 'acoustic_tractor_beam', name: 'Acoustic Tractor Beam', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/acoustic_tractor_beam.js', importName: 'createAcousticTractorBeam' },

  { id: 'aero_cooling_edge', name: 'Aero Cooling Edge', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_cooling_edge.js', importName: 'createActiveCoolingEdge' },

  { id: 'aero_plasma_emitter', name: 'Aero Plasma Emitter', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_plasma_emitter.js', importName: 'createPlasmaEmitter' },

  { id: 'aero_scramjet_intake', name: 'Aero Scramjet Intake', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_scramjet_intake.js', importName: 'createScramjetIntake' },

  { id: 'aero_waverider_hull', name: 'Aero Waverider Hull', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_waverider_hull.js', importName: 'createWaveriderHull' },

  { id: 'aero_wind_tunnel', name: 'Aero Wind Tunnel', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_wind_tunnel.js', importName: 'createWindTunnel' },

  { id: 'aircraft_carrier', name: 'Aircraft Carrier', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/aircraft_carrier.js', importName: 'createAircraftCarrier' },

  { id: 'alu_datapath', name: 'Alu Datapath', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/alu_datapath.js', importName: 'createAluDatapath' },

  { id: 'apollo_lunar_lander', name: 'Apollo Lunar Lander', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/apollo_lunar_lander.js', importName: 'createApolloLunarLander' },

  { id: 'arch_dam', name: 'Arch Dam', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/arch_dam.js', importName: 'createArchDam' },

  { id: 'asteroid_anchor_dock', name: 'Asteroid Anchor Dock', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/asteroid_anchor_dock.js', importName: 'createAsteroidAnchorDock' },

  { id: 'asteroid_mining_rig', name: 'Asteroid Mining Rig', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/asteroid_mining_rig.js', importName: 'createAsteroidMiningRig' },

  { id: 'astro_pulsar_timing_array_dish', name: 'Astro Pulsar Timing Array Dish', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/astro_pulsar_timing_array_dish.js', importName: 'createPulsarTimingArrayDish' },

  { id: 'atmos_cloud_seeding_swarm', name: 'Atmos Cloud Seeding Swarm', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/atmos_cloud_seeding_swarm.js', importName: 'createCloudSeedingSwarm' },

  { id: 'atmos_ionospheric_heater', name: 'Atmos Ionospheric Heater', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/atmos_ionospheric_heater.js', importName: 'createIonosphericHeaterArray' },

  { id: 'atmos_ozone_replenisher', name: 'Atmos Ozone Replenisher', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/atmos_ozone_replenisher.js', importName: 'createOzoneReplenisher' },

  { id: 'atmos_tornado_dissipation_array', name: 'Atmos Tornado Dissipation Array', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/atmos_tornado_dissipation_array.js', importName: 'createTornadoDissipationArray' },

  { id: 'atmos_water_generator', name: 'Atmos Water Generator', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/atmos_water_generator.js', importName: 'createAtmosphericWaterGenerator' },

  { id: 'atomic_clock_array', name: 'Atomic Clock Array', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/atomic_clock_array.js', importName: 'createAtomicClockArray' },

  { id: 'atoms', name: 'Atoms', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/atoms.js', importName: 'createAtoms' },

  { id: 'audio_amplifier', name: 'Audio Amplifier', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/audio_amplifier.js', importName: 'createAmplifier' },

  { id: 'audio_microphone', name: 'Audio Microphone', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/audio_microphone.js', importName: 'createMicrophone' },

  { id: 'automated_weather_station', name: 'Automated Weather Station', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/automated_weather_station.js', importName: 'createAutomatedWeatherStation' },

  { id: 'autonomous_underwater_vehicle', name: 'Autonomous Underwater Vehicle', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/autonomous_underwater_vehicle.js', importName: 'createAutonomousUnderwaterVehicle' },

  { id: 'auv_explorer', name: 'Auv Explorer', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/auv_explorer.js', importName: 'createAuvExplorer' },

  { id: 'bacteriophage_virus', name: 'Bacteriophage Virus', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/bacteriophage_virus.js', importName: 'createBacteriophageVirus' },

  { id: 'base_isolated_building', name: 'Base Isolated Building', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/base_isolated_building.js', importName: 'createBaseIsolatedBuilding' },

  { id: 'base_isolation_system', name: 'Base Isolation System', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/base_isolation_system.js', importName: 'createBaseIsolationSystem' },
  ...
  { id: 'blackHoleAccretionDisk', name: 'BlackHoleAccretionDisk', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/blackHoleAccretionDisk.js', importName: 'createBlackHoleAccretionDisk' },

  { id: 'black_hole_accretion', name: 'Black Hole Accretion', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/black_hole_accretion.js', importName: 'createBlackHoleAccretion' },

  { id: 'bldc_motor', name: 'Bldc Motor', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/bldc_motor.js', importName: 'createBLDCMotor' },

  { id: 'blowout_preventer', name: 'Blowout Preventer', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/blowout_preventer.js', importName: 'createBlowoutPreventer' },

  { id: 'bose_einstein_condensate', name: 'Bose Einstein Condensate', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/bose_einstein_condensate.js', importName: 'createBoseEinsteinCondensate' },

  { id: 'brain', name: 'Brain', icon: '⚛️', category: 'bci_engineering', importPath: './machines/brain.js', importName: 'createBrain' },

  { id: 'cable_stayed_bridge', name: 'Cable Stayed Bridge', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/cable_stayed_bridge.js', importName: 'createCableStayedBridge' },

  { id: 'cathode_ray_tube', name: 'Cathode Ray Tube', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/cathode_ray_tube.js', importName: 'createCathodeRayTube' },

  { id: 'centrifugal_separator', name: 'Centrifugal Separator', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/centrifugal_separator.js', importName: 'createCentrifugalSeparator' },

  { id: 'chloroplast_photosynthesis', name: 'Chloroplast Photosynthesis', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/chloroplast_photosynthesis.js', importName: 'createChloroplastPhotosynthesis' },
  ...
  { id: 'climate_carbon_capture_tower', name: 'Climate Carbon Capture Tower', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/climate_carbon_capture_tower.js', importName: 'createCarbonCaptureTower' },

  { id: 'climate_glacial_preserver', name: 'Climate Glacial Preserver', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/climate_glacial_preserver.js', importName: 'createGlacialPreserver' },

  { id: 'climate_ocean_alkalinity_vessel', name: 'Climate Ocean Alkalinity Vessel', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/climate_ocean_alkalinity_vessel.js', importName: 'createOceanAlkalinityVessel' },

  { id: 'climate_solar_reflector_array', name: 'Climate Solar Reflector Array', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/climate_solar_reflector_array.js', importName: 'createSolarReflectorArray' },

  { id: 'climate_stratospheric_aerosol_jet', name: 'Climate Stratospheric Aerosol Jet', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/climate_stratospheric_aerosol_jet.js', importName: 'createStratosphericAerosolJet' },

  { id: 'climatology_doppler_radar', name: 'Climatology Doppler Radar', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/climatology_doppler_radar.js', importName: 'createDopplerRadar' },

  { id: 'clockwork_mechanism', name: 'Clockwork Mechanism', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/clockwork_mechanism.js', importName: 'createClockworkMechanism' },

  { id: 'combustion_engine', name: 'Combustion Engine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/combustion_engine.js', importName: 'createCombustionEngine' },

  { id: 'computer_architecture_cpu_pipeline', name: 'Computer Architecture Cpu Pipeline', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/computer_architecture_cpu_pipeline.js', importName: 'createCpuPipeline' },

  { id: 'concrete_frame', name: 'Concrete Frame', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/concrete_frame.js', importName: 'createConcreteFrame' },

  { id: 'cpu_pipeline', name: 'Cpu Pipeline', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/cpu_pipeline.js', importName: 'createCpuPipeline' },

  { id: 'crispr_cas9_complex', name: 'Crispr Cas9 Complex', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/crispr_cas9_complex.js', importName: 'createCrisprCas9Complex' },

  { id: 'cryptography_blockchain_ledger', name: 'Cryptography Blockchain Ledger', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/cryptography_blockchain_ledger.js', importName: 'createBlockchainLedger' },

  { id: 'cstr_reactor', name: 'Cstr Reactor', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/cstr_reactor.js', importName: 'createCSTRReactor' },

  { id: 'cyber_air_gapped_vault', name: 'Cyber Air Gapped Vault', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/cyber_air_gapped_vault.js', importName: 'createAirGappedVault' },

  { id: 'cyber_biometric_hardware_token', name: 'Cyber Biometric Hardware Token', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/cyber_biometric_hardware_token.js', importName: 'createBiometricHardwareToken' },

  { id: 'cyber_bionic_retinal_implant', name: 'Cyber Bionic Retinal Implant', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/cyber_bionic_retinal_implant.js', importName: 'createBionicRetinalImplant' },

  { id: 'cyber_cochlear_micro_array', name: 'Cyber Cochlear Micro Array', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/cyber_cochlear_micro_array.js', importName: 'createCochlearMicroArray' },

  { id: 'cyber_exoskeleton_joint', name: 'Cyber Exoskeleton Joint', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/cyber_exoskeleton_joint.js', importName: 'createExoskeletonJoint' },

  { id: 'cyber_intrusion_detection_rack', name: 'Cyber Intrusion Detection Rack', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/cyber_intrusion_detection_rack.js', importName: 'createIntrusionDetectionRack' },

  { id: 'cyber_myoelectric_prosthetic_arm', name: 'Cyber Myoelectric Prosthetic Arm', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/cyber_myoelectric_prosthetic_arm.js', importName: 'createMyoelectricProstheticArm' },
  ...
  { id: 'cyber_puf_chip', name: 'Cyber Puf Chip', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/cyber_puf_chip.js', importName: 'createPUFChip' },

  { id: 'cyber_quantum_key_cryptoprocessor', name: 'Cyber Quantum Key Cryptoprocessor', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/cyber_quantum_key_cryptoprocessor.js', importName: 'createQuantumKeyCryptoprocessor' },

  { id: 'cyclotron_accelerator', name: 'Cyclotron Accelerator', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/cyclotron_accelerator.js', importName: 'createCyclotronAccelerator' },

  { id: 'deep_ocean_buoy', name: 'Deep Ocean Buoy', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/deep_ocean_buoy.js', importName: 'createDeepOceanBuoy' },

  { id: 'deep_sea_rig', name: 'Deep Sea Rig', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/deep_sea_rig.js', importName: 'createDeepSeaRig' },

  { id: 'digestive_system', name: 'Digestive System', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/digestive_system.js', importName: 'createDigestiveSystem' },

  { id: 'dna_molecule', name: 'Dna Molecule', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/dna_molecule.js', importName: 'createDNAMolecule' },

  { id: 'dna_origami_fabricator', name: 'Dna Origami Fabricator', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/dna_origami_fabricator.js', importName: 'createDnaOrigamiFabricator' },

  { id: 'doppler_weather_radar', name: 'Doppler Weather Radar', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/doppler_weather_radar.js', importName: 'createDopplerWeatherRadar' },

  { id: 'dyson_swarm_mirror', name: 'Dyson Swarm Mirror', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/dyson_swarm_mirror.js', importName: 'createDysonSwarmMirror' },

  { id: 'earthquake_base_isolator', name: 'Earthquake Base Isolator', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/earthquake_base_isolator.js', importName: 'createEarthquakeBaseIsolator' },

  { id: 'electric_motor', name: 'Electric Motor', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/electric_motor.js', importName: 'createElectricMotor' },

  { id: 'electromagnetic_relay', name: 'Electromagnetic Relay', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/electromagnetic_relay.js', importName: 'createElectromagneticRelay' },

  { id: 'energy_flow_battery', name: 'Energy Flow Battery', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/energy_flow_battery.js', importName: 'createFlowBattery' },

  { id: 'energy_flywheel', name: 'Energy Flywheel', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/energy_flywheel.js', importName: 'createFlywheelVault' },

  { id: 'energy_sand_battery', name: 'Energy Sand Battery', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/energy_sand_battery.js', importName: 'createSandBattery' },

  { id: 'energy_smes', name: 'Energy Smes', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/energy_smes.js', importName: 'createSMES' },

  { id: 'energy_solid_state_battery', name: 'Energy Solid State Battery', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/energy_solid_state_battery.js', importName: 'createSolidStateBattery' },

  { id: 'enso_system', name: 'Enso System', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/enso_system.js', importName: 'createEnsoSystem' },

  { id: 'entangled_photon_rangefinder', name: 'Entangled Photon Rangefinder', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/entangled_photon_rangefinder.js', importName: 'createEntangledPhotonRangefinder' },

  { id: 'exotic_alcubierre_drive', name: 'Exotic Alcubierre Drive', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/exotic_alcubierre_drive.js', importName: 'createAlcubierreDrive' },

  { id: 'exotic_antimatter_rocket', name: 'Exotic Antimatter Rocket', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/exotic_antimatter_rocket.js', importName: 'createAntimatterRocket' },

  { id: 'exotic_em_drive_resonator', name: 'Exotic Em Drive Resonator', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/exotic_em_drive_resonator.js', importName: 'createEMDriveResonator' },

  { id: 'exotic_nuclear_salt_water_rocket', name: 'Exotic Nuclear Salt Water Rocket', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/exotic_nuclear_salt_water_rocket.js', importName: 'createNuclearSaltWaterRocket' },

  { id: 'exotic_photonic_laser_thruster', name: 'Exotic Photonic Laser Thruster', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/exotic_photonic_laser_thruster.js', importName: 'createPhotonicLaserThruster' },
  ...
  { id: 'fiber_optic_router', name: 'Fiber Optic Router', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/fiber_optic_router.js', importName: 'createFiberOpticRouter' },

  { id: 'flagellum', name: 'Flagellum', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/flagellum.js', importName: 'createFlagellum' },

  { id: 'flower_pollination', name: 'Flower Pollination', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/flower_pollination.js', importName: 'createFlowerPollination' },

  { id: 'fluidized_bed_reactor', name: 'Fluidized Bed Reactor', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/fluidized_bed_reactor.js', importName: 'createFluidizedBedReactor' },

  { id: 'fossil_excavation_site', name: 'Fossil Excavation Site', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/fossil_excavation_site.js', importName: 'createFossilExcavationSite' },

  { id: 'foucault_pendulum', name: 'Foucault Pendulum', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/foucault_pendulum.js', importName: 'createFoucaultPendulum' },

  { id: 'four_bar_linkage', name: 'Four Bar Linkage', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/four_bar_linkage.js', importName: 'createFourBarLinkage' },

  { id: 'fuel_cell', name: 'Fuel Cell', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/fuel_cell.js', importName: 'createFuelCell' },

  { id: 'fusion_rocket_engine', name: 'Fusion Rocket Engine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/fusion_rocket_engine.js', importName: 'createFusionRocketEngine' },

  { id: 'gas_turbine_jet_engine', name: 'Gas Turbine Jet Engine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/gas_turbine_jet_engine.js', importName: 'createGasTurbineJetEngine' },

  { id: 'gel_electrophoresis_chamber', name: 'Gel Electrophoresis Chamber', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/gel_electrophoresis_chamber.js', importName: 'createGelElectrophoresisChamber' },

  { id: 'genetics_base_editor_protein', name: 'Genetics Base Editor Protein', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/genetics_base_editor_protein.js', importName: 'createBaseEditorProtein' },

  { id: 'genetics_cas12a_system', name: 'Genetics Cas12a System', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/genetics_cas12a_system.js', importName: 'createCas12aSystem' },

  { id: 'genetics_crispr', name: 'Genetics Crispr', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/genetics_crispr.js', importName: 'createCrisprCas9' },

  { id: 'genetics_gene_drive_mechanism', name: 'Genetics Gene Drive Mechanism', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/genetics_gene_drive_mechanism.js', importName: 'createGeneDriveMechanism' },

  { id: 'genetics_prime_editing_complex', name: 'Genetics Prime Editing Complex', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/genetics_prime_editing_complex.js', importName: 'createPrimeEditingComplex' },

  { id: 'genetics_synthetic_chromosome_assembler', name: 'Genetics Synthetic Chromosome Assembler', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/genetics_synthetic_chromosome_assembler.js', importName: 'createSyntheticChromosomeAssembler' },

  { id: 'geophysics_magma_engine', name: 'Geophysics Magma Engine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/geophysics_magma_engine.js', importName: 'createMagmaEngine' },

  { id: 'geophysics_magma_tap', name: 'Geophysics Magma Tap', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/geophysics_magma_tap.js', importName: 'createMagmaTap' },

  { id: 'geophysics_mantle_sensor', name: 'Geophysics Mantle Sensor', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/geophysics_mantle_sensor.js', importName: 'createMantleSensorArray' },

  { id: 'geophysics_moho_drill', name: 'Geophysics Moho Drill', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/geophysics_moho_drill.js', importName: 'createMohoDrill' },

  { id: 'geophysics_tectonic_monitor', name: 'Geophysics Tectonic Monitor', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/geophysics_tectonic_monitor.js', importName: 'createTectonicMonitor' },

  { id: 'geothermal_power_plant', name: 'Geothermal Power Plant', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/geothermal_power_plant.js', importName: 'createGeothermalPowerPlant' },

  { id: 'geo_core_extractor', name: 'Geo Core Extractor', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/geo_core_extractor.js', importName: 'createIronNickelCoreExtractor' },

  { id: 'geo_diamond_anvil_cell', name: 'Geo Diamond Anvil Cell', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/geo_diamond_anvil_cell.js', importName: 'createHighPressureDiamondAnvilCell' },

  { id: 'geo_magma_sonar_drone', name: 'Geo Magma Sonar Drone', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/geo_magma_sonar_drone.js', importName: 'createMagmaOceanSonarDrone' },

  { id: 'geo_mantle_drill', name: 'Geo Mantle Drill', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/geo_mantle_drill.js', importName: 'createCoreSamplingMantleDrill' },

  { id: 'geo_seismic_sensor', name: 'Geo Seismic Sensor', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/geo_seismic_sensor.js', importName: 'createSeismicTomographySensor' },

  { id: 'gpcr_signaling', name: 'Gpcr Signaling', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/gpcr_signaling.js', importName: 'createGPCRSignalingPathway' },

  { id: 'gps_satellite', name: 'Gps Satellite', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/gps_satellite.js', importName: 'createGpsSatellite' },

  { id: 'graphene_sheet_synthesizer', name: 'Graphene Sheet Synthesizer', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/graphene_sheet_synthesizer.js', importName: 'createGrapheneSheetSynthesizer' },

  { id: 'graphics_card', name: 'Graphics Card', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/graphics_card.js', importName: 'createGraphicsCard' },

  { id: 'gravitationalWaveInterferometer', name: 'GravitationalWaveInterferometer', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/gravitationalWaveInterferometer.js', importName: 'createGravitationalWaveInterferometer' },

  { id: 'greenhouse_effect', name: 'Greenhouse Effect', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/greenhouse_effect.js', importName: 'createGreenhouseEffect' },

  { id: 'haber_bosch_reactor', name: 'Haber Bosch Reactor', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/haber_bosch_reactor.js', importName: 'createHaberBoschReactor' },

  { id: 'helicopterRotor', name: 'HelicopterRotor', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/helicopterRotor.js', importName: 'createHelicopterRotorSystem' },

  { id: 'helicopter_rotor', name: 'Helicopter Rotor', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/helicopter_rotor.js', importName: 'createHelicopterRotor' },
  ...
  { id: 'hplc_system', name: 'Hplc System', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/hplc_system.js', importName: 'createHPLCSystem' },

  { id: 'hubble_telescope', name: 'Hubble Telescope', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/hubble_telescope.js', importName: 'createHubbleTelescope' },
  ...
  { id: 'human_heart', name: 'Human Heart', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/human_heart.js', importName: 'createHumanHeart' },

  { id: 'human_lungs', name: 'Human Lungs', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/human_lungs.js', importName: 'createHumanLungs' },

  { id: 'hurricane_formation', name: 'Hurricane Formation', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/hurricane_formation.js', importName: 'createHurricaneFormation' },

  { id: 'hurricane_hunter_aircraft', name: 'Hurricane Hunter Aircraft', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/hurricane_hunter_aircraft.js', importName: 'createHurricaneHunterAircraft' },

  { id: 'hydraulic_excavator', name: 'Hydraulic Excavator', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/hydraulic_excavator.js', importName: 'createHydraulicExcavator' },

  { id: 'hydroelectric_turbine', name: 'Hydroelectric Turbine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/hydroelectric_turbine.js', importName: 'createHydroelectricTurbine' },

  { id: 'hydrothermal_vent_observatory', name: 'Hydrothermal Vent Observatory', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/hydrothermal_vent_observatory.js', importName: 'createHydrothermalVentObservatory' },

  { id: 'hydrothermal_vent_system', name: 'Hydrothermal Vent System', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/hydrothermal_vent_system.js', importName: 'createHydrothermalVentSystem' },

  { id: 'ice_albedo_feedback', name: 'Ice Albedo Feedback', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/ice_albedo_feedback.js', importName: 'createIceAlbedoFeedback' },

  { id: 'ice_core_driller', name: 'Ice Core Driller', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/ice_core_driller.js', importName: 'createGlacialIceCoreDriller' },

  { id: 'infrasonic_crowd_control_emitter', name: 'Infrasonic Crowd Control Emitter', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/infrasonic_crowd_control_emitter.js', importName: 'createInfrasonicCrowdControlEmitter' },

  { id: 'inner_ear', name: 'Inner Ear', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/inner_ear.js', importName: 'createInnerEar' },

  { id: 'inorganic_carbon_nanotube', name: 'Inorganic Carbon Nanotube', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/inorganic_carbon_nanotube.js', importName: 'createCarbonNanotube' },

  { id: 'internal_combustion_engine', name: 'Internal Combustion Engine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/internal_combustion_engine.js', importName: 'createInternalCombustionEngine' },

  { id: 'ion_thruster_drive', name: 'Ion Thruster Drive', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/ion_thruster_drive.js', importName: 'createIonThrusterDrive' },

  { id: 'iss_space_station', name: 'Iss Space Station', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/iss_space_station.js', importName: 'createISSSpaceStation' },

  { id: 'iss_station', name: 'Iss Station', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/iss_station.js', importName: 'createIssStation' },

  { id: 'jwst_observatory', name: 'Jwst Observatory', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/jwst_observatory.js', importName: 'createJwstObservatory' },

  { id: 'kidney', name: 'Kidney', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/kidney.js', importName: 'createKidney' },

  { id: 'knee_joint', name: 'Knee Joint', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/knee_joint.js', importName: 'createKneeJoint' },

  { id: 'large_hadron_collider', name: 'Large Hadron Collider', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/large_hadron_collider.js', importName: 'createLHC' },

  { id: 'lhc_detector_slice', name: 'Lhc Detector Slice', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/lhc_detector_slice.js', importName: 'createLHCDetectorSlice' },

  { id: 'lhc_segment', name: 'Lhc Segment', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/lhc_segment.js', importName: 'createLHCSegment' },

  { id: 'lithium_ion_battery', name: 'Lithium Ion Battery', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/lithium_ion_battery.js', importName: 'createLithiumIonBattery' },

  { id: 'li_ion_battery', name: 'Li Ion Battery', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/li_ion_battery.js', importName: 'createLiIonBattery' },

  { id: 'macrophage_phagocytosis', name: 'Macrophage Phagocytosis', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/macrophage_phagocytosis.js', importName: 'createMacrophagePhagocytosis' },

  { id: 'magma_chamber_simulator', name: 'Magma Chamber Simulator', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/magma_chamber_simulator.js', importName: 'createMagmaChamberSimulator' },

  { id: 'magneto_optical_trap', name: 'Magneto Optical Trap', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/magneto_optical_trap.js', importName: 'createMagnetoOpticalTrap' },

  { id: 'magnetron', name: 'Magnetron', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/magnetron.js', importName: 'createMagnetron' },

  { id: 'marine_biology_coral_reef', name: 'Marine Biology Coral Reef', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/marine_biology_coral_reef.js', importName: 'createCoralReef' },

  { id: 'marine_scrubber', name: 'Marine Scrubber', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/marine_scrubber.js', importName: 'createMarineScrubber' },

  { id: 'mars_rover_curiosity', name: 'Mars Rover Curiosity', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mars_rover_curiosity.js', importName: 'createMarsRoverCuriosity' },

  { id: 'mars_rover_perseverance', name: 'Mars Rover Perseverance', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mars_rover_perseverance.js', importName: 'createMarsRoverPerseverance' },

  { id: 'med_cryo_stasis_pod', name: 'Med Cryo Stasis Pod', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/med_cryo_stasis_pod.js', importName: 'createCryoStasisPod' },

  { id: 'med_da_vinci_console', name: 'Med Da Vinci Console', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/med_da_vinci_console.js', importName: 'createDaVinciConsole' },

  { id: 'med_micro_surgery_bot', name: 'Med Micro Surgery Bot', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/med_micro_surgery_bot.js', importName: 'createMicroSurgeryBot' },

  { id: 'med_organ_regen_tank', name: 'Med Organ Regen Tank', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/med_organ_regen_tank.js', importName: 'createOrganRegenTank' },

  { id: 'med_plasma_scalpel', name: 'Med Plasma Scalpel', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/med_plasma_scalpel.js', importName: 'createPlasmaScalpel' },

  { id: 'metamaterials_acoustic_absorber', name: 'Metamaterials Acoustic Absorber', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/metamaterials_acoustic_absorber.js', importName: 'createAcousticAbsorber' },

  { id: 'meta_acoustic_cloak', name: 'Meta Acoustic Cloak', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/meta_acoustic_cloak.js', importName: 'createAcousticCloak' },

  { id: 'meta_negative_index_lens', name: 'Meta Negative Index Lens', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/meta_negative_index_lens.js', importName: 'createNegativeIndexLens' },

  { id: 'meta_programmable_matter', name: 'Meta Programmable Matter', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/meta_programmable_matter.js', importName: 'createProgrammableMatterCube' },

  { id: 'meta_seismic_shield', name: 'Meta Seismic Shield', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/meta_seismic_shield.js', importName: 'createSeismicShield' },

  { id: 'meta_thermal_cloak', name: 'Meta Thermal Cloak', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/meta_thermal_cloak.js', importName: 'createThermalCloak' },
  ...
  { id: 'mining_asteroid_harpoon', name: 'Mining Asteroid Harpoon', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/mining_asteroid_harpoon.js', importName: 'createAsteroidHarpoon' },

  { id: 'mining_core_drilling_laser', name: 'Mining Core Drilling Laser', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mining_core_drilling_laser.js', importName: 'createCoreDrillingLaser' },

  { id: 'mining_optical_spectrometer', name: 'Mining Optical Spectrometer', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mining_optical_spectrometer.js', importName: 'createOpticalSpectrometer' },

  { id: 'mining_plasma_refiner', name: 'Mining Plasma Refiner', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mining_plasma_refiner.js', importName: 'createPlasmaRefiner' },

  { id: 'mining_slag_centrifuge', name: 'Mining Slag Centrifuge', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mining_slag_centrifuge.js', importName: 'createSlagCentrifuge' },

  { id: 'mrna_vaccine', name: 'Mrna Vaccine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mrna_vaccine.js', importName: 'createmRNAVaccineDelivery' },

  { id: 'nanomedicine_dna_origami_nanobot', name: 'Nanomedicine Dna Origami Nanobot', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/nanomedicine_dna_origami_nanobot.js', importName: 'createDnaOrigamiNanobot' },

  { id: 'nano_acoustic_tweezers', name: 'Nano Acoustic Tweezers', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/nano_acoustic_tweezers.js', importName: 'createAcousticTweezers' },

  { id: 'nano_dna_data_storage', name: 'Nano Dna Data Storage', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/nano_dna_data_storage.js', importName: 'createDNADataStorageCrystal' },

  { id: 'networking_fiber_optic_cable', name: 'Networking Fiber Optic Cable', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/networking_fiber_optic_cable.js', importName: 'createFiberOpticCable' },

  { id: 'networking_satellite_dish', name: 'Networking Satellite Dish', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/networking_satellite_dish.js', importName: 'createSatelliteDish' },

  { id: 'neuron_cell', name: 'Neuron Cell', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/neuron_cell.js', importName: 'createNeuronCell' },

  { id: 'neuroscience_action_potential', name: 'Neuroscience Action Potential', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/neuroscience_action_potential.js', importName: 'createActionPotential' },

  { id: 'neuroscience_neuron_synapse', name: 'Neuroscience Neuron Synapse', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/neuroscience_neuron_synapse.js', importName: 'createNeuronSynapse' },

  { id: 'neuro_biomimetic_wing', name: 'Neuro Biomimetic Wing', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/neuro_biomimetic_wing.js', importName: 'createBiomimeticWing' },

  { id: 'neuro_eye_cluster', name: 'Neuro Eye Cluster', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/neuro_eye_cluster.js', importName: 'createEyeCluster' },

  { id: 'neuro_hexapod_walker', name: 'Neuro Hexapod Walker', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/neuro_hexapod_walker.js', importName: 'createHexapodWalker' },

  { id: 'neuro_synapse_controller', name: 'Neuro Synapse Controller', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/neuro_synapse_controller.js', importName: 'createSynapseController' },

  { id: 'neuro_vocal_cord_synth', name: 'Neuro Vocal Cord Synth', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/neuro_vocal_cord_synth.js', importName: 'createVocalCordSynth' },

  { id: 'nitrogen_cycle_soil', name: 'Nitrogen Cycle Soil', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/nitrogen_cycle_soil.js', importName: 'createNitrogenCycleSoil' },

  { id: 'nmr_spectrometer', name: 'Nmr Spectrometer', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/nmr_spectrometer.js', importName: 'createNMRSpectrometer' },

  { id: 'npn_transistor', name: 'Npn Transistor', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/npn_transistor.js', importName: 'createNpnTransistor' },

  { id: 'nuclear_reactor_core', name: 'Nuclear Reactor Core', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/nuclear_reactor_core.js', importName: 'createNuclearReactorCore' },

  { id: 'oceanic_abyssal_habitat', name: 'Oceanic Abyssal Habitat', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/oceanic_abyssal_habitat.js', importName: 'createAbyssalHabitat' },

  { id: 'oceanic_benthic_drone_sub', name: 'Oceanic Benthic Drone Sub', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/oceanic_benthic_drone_sub.js', importName: 'createBenthicDroneSub' },

  { id: 'oceanic_deep_ocean_tidal_turbine', name: 'Oceanic Deep Ocean Tidal Turbine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/oceanic_deep_ocean_tidal_turbine.js', importName: 'createDeepOceanTidalTurbine' },

  { id: 'oceanic_hydrothermal_desalinator', name: 'Oceanic Hydrothermal Desalinator', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/oceanic_hydrothermal_desalinator.js', importName: 'createHydrothermalDesalinator' },

  { id: 'oceanic_thermal_vent_harvester', name: 'Oceanic Thermal Vent Harvester', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/oceanic_thermal_vent_harvester.js', importName: 'createThermalVentHarvester' },

  { id: 'oceanographic_buoy', name: 'Oceanographic Buoy', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/oceanographic_buoy.js', importName: 'createOceanographicBuoy' },

  { id: 'ocean_conveyor_belt', name: 'Ocean Conveyor Belt', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/ocean_conveyor_belt.js', importName: 'createOceanConveyorBelt' },

  { id: 'ocean_thermal_energy_conversion', name: 'Ocean Thermal Energy Conversion', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/ocean_thermal_energy_conversion.js', importName: 'createOceanThermalEnergyConversion' },

  { id: 'offshore_wind_turbine', name: 'Offshore Wind Turbine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/offshore_wind_turbine.js', importName: 'createOffshoreWindTurbine' },

  { id: 'oncology_brachytherapy', name: 'Oncology Brachytherapy', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/oncology_brachytherapy.js', importName: 'createBrachytherapyAfterloader' },

  { id: 'oncology_pet_ct', name: 'Oncology Pet Ct', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/oncology_pet_ct.js', importName: 'createPetCtScanner' },

  { id: 'oneill_cylinder_segment', name: 'Oneill Cylinder Segment', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/oneill_cylinder_segment.js', importName: 'createONeillCylinder' },

  { id: 'optics_electron_microscope', name: 'Optics Electron Microscope', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/optics_electron_microscope.js', importName: 'createElectronMicroscope' },

  { id: 'optics_fiber_optic_network', name: 'Optics Fiber Optic Network', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/optics_fiber_optic_network.js', importName: 'createFiberOpticNetwork' },

  { id: 'orbitalResonanceSystem', name: 'OrbitalResonanceSystem', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/orbitalResonanceSystem.js', importName: 'createOrbitalResonanceSystem' },

  { id: 'orbital_centrifuge', name: 'Orbital Centrifuge', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/orbital_centrifuge.js', importName: 'createOrbitalCentrifuge' },

  { id: 'orbital_solar_power_satellite', name: 'Orbital Solar Power Satellite', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/orbital_solar_power_satellite.js', importName: 'createSolarPowerSatellite' },

  { id: 'pacemaker', name: 'Pacemaker', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/pacemaker.js', importName: 'createPacemaker' },

  { id: 'penicillin_mechanism', name: 'Penicillin Mechanism', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/penicillin_mechanism.js', importName: 'createPenicillinMechanism' },

  { id: 'pharmacology_antibody_antigen', name: 'Pharmacology Antibody Antigen', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/pharmacology_antibody_antigen.js', importName: 'createAntibodyAntigenModel' },

  { id: 'phloem_transport', name: 'Phloem Transport', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/phloem_transport.js', importName: 'createPhloemTransport' },

  { id: 'phononics_acoustic_metamaterial', name: 'Phononics Acoustic Metamaterial', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/phononics_acoustic_metamaterial.js', importName: 'createAcousticMetamaterial' },

  { id: 'photosynthesis_system', name: 'Photosynthesis System', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/photosynthesis_system.js', importName: 'createPhotosynthesisSystem' },

  { id: 'phototropism_auxin', name: 'Phototropism Auxin', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/phototropism_auxin.js', importName: 'createPhototropismAuxin' },
  ...
  { id: 'pile_driving_rig', name: 'Pile Driving Rig', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/pile_driving_rig.js', importName: 'createPileDrivingRig' },

  { id: 'plant_cell_mitosis', name: 'Plant Cell Mitosis', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/plant_cell_mitosis.js', importName: 'createPlantCellMitosis' },

  { id: 'plant_cell_structure', name: 'Plant Cell Structure', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/plant_cell_structure.js', importName: 'createPlantCellStructure' },

  { id: 'plasma_helicon_thruster', name: 'Plasma Helicon Thruster', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/plasma_helicon_thruster.js', importName: 'createHeliconThruster' },

  { id: 'plasma_stellarator_coil', name: 'Plasma Stellarator Coil', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/plasma_stellarator_coil.js', importName: 'createStellaratorCoil' },

  { id: 'plasma_tokamak_divertor', name: 'Plasma Tokamak Divertor', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/plasma_tokamak_divertor.js', importName: 'createTokamakDivertor' },

  { id: 'plasma_wakefield_accelerator', name: 'Plasma Wakefield Accelerator', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/plasma_wakefield_accelerator.js', importName: 'createWakefieldAccelerator' },

  { id: 'plasma_z_pinch', name: 'Plasma Z Pinch', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/plasma_z_pinch.js', importName: 'createZPinch' },

  { id: 'pn_junction_diode', name: 'Pn Junction Diode', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/pn_junction_diode.js', importName: 'createPnJunctionDiode' },

  { id: 'polar_weather_satellite', name: 'Polar Weather Satellite', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/polar_weather_satellite.js', importName: 'createPolarWeatherSatellite' },

  { id: 'polymerization_extruder', name: 'Polymerization Extruder', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/polymerization_extruder.js', importName: 'createPolymerizationExtruder' },

  { id: 'propulsion_systems_ion_thruster', name: 'Propulsion Systems Ion Thruster', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/propulsion_systems_ion_thruster.js', importName: 'createIonThruster' },
  ...
  { id: 'quant_compass_spin_sensor', name: 'Quant Compass Spin Sensor', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/quant_compass_spin_sensor.js', importName: 'createQuantumCompass' },

  { id: 'quant_gravity_gradiometer', name: 'Quant Gravity Gradiometer', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/quant_gravity_gradiometer.js', importName: 'createGravityGradiometer' },

  { id: 'qubit_processor_chip', name: 'Qubit Processor Chip', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/qubit_processor_chip.js', importName: 'createQubitProcessorChip' },

  { id: 'radiosonde_weather_balloon', name: 'Radiosonde Weather Balloon', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/radiosonde_weather_balloon.js', importName: 'createRadiosondeWeatherBalloon' },

  { id: 'radio_telescope', name: 'Radio Telescope', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/radio_telescope.js', importName: 'createRadioTelescope' },

  { id: 'radio_telescope_array', name: 'Radio Telescope Array', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/radio_telescope_array.js', importName: 'createRadioTelescopeArray' },

  { id: 'relay_switch', name: 'Relay Switch', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/relay_switch.js', importName: 'createRelaySwitch' },

  { id: 'remotely_operated_vehicle', name: 'Remotely Operated Vehicle', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/remotely_operated_vehicle.js', importName: 'createRemotelyOperatedVehicle' },

  { id: 'robotics_hydrogel_deformable_bot', name: 'Robotics Hydrogel Deformable Bot', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/robotics_hydrogel_deformable_bot.js', importName: 'createHydrogelDeformableBot' },

  { id: 'robotics_liquid_metal_actuator', name: 'Robotics Liquid Metal Actuator', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/robotics_liquid_metal_actuator.js', importName: 'createLiquidMetalActuator' },

  { id: 'robotics_peristaltic_crawling_tube', name: 'Robotics Peristaltic Crawling Tube', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/robotics_peristaltic_crawling_tube.js', importName: 'createPeristalticCrawlingTube' },

  { id: 'robotics_pneumatic_tentacle', name: 'Robotics Pneumatic Tentacle', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/robotics_pneumatic_tentacle.js', importName: 'createPneumaticTentacle' },

  { id: 'robotics_silicone_muscle_array', name: 'Robotics Silicone Muscle Array', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/robotics_silicone_muscle_array.js', importName: 'createSiliconeMuscleArray' },

  { id: 'root_nodule_system', name: 'Root Nodule System', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/root_nodule_system.js', importName: 'createRootNoduleSystem' },

  { id: 'root_osmosis', name: 'Root Osmosis', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/root_osmosis.js', importName: 'createRootOsmosis' },

  { id: 'rov_manipulator', name: 'Rov Manipulator', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/rov_manipulator.js', importName: 'createRovManipulator' },

  { id: 'rov_trencher', name: 'Rov Trencher', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/rov_trencher.js', importName: 'createRovTrencher' },

  { id: 'satellite_uplink_station', name: 'Satellite Uplink Station', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/satellite_uplink_station.js', importName: 'createSatelliteUplinkStation' },

  { id: 'saturn_v_rocket', name: 'Saturn V Rocket', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/saturn_v_rocket.js', importName: 'createSaturnVRocket' },

  { id: 'scanning_tunneling_microscope', name: 'Scanning Tunneling Microscope', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/scanning_tunneling_microscope.js', importName: 'createScanningTunnelingMicroscope' },

  { id: 'seed_germination', name: 'Seed Germination', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/seed_germination.js', importName: 'createSeedGermination' },

  { id: 'seismic_monitoring_network', name: 'Seismic Monitoring Network', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/seismic_monitoring_network.js', importName: 'createSeismicMonitoringNetwork' },

  { id: 'seismograph_station', name: 'Seismograph Station', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/seismograph_station.js', importName: 'createSeismographStation' },

  { id: 'seismology_seismograph', name: 'Seismology Seismograph', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/seismology_seismograph.js', importName: 'createSeismograph' },

  { id: 'seismology_tsunami_buoy', name: 'Seismology Tsunami Buoy', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/seismology_tsunami_buoy.js', importName: 'createTsunamiBuoy' },

  { id: 'shark_anatomy', name: 'Shark Anatomy', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/shark_anatomy.js', importName: 'createSharkAnatomy' },

  { id: 'shield_volcano_effusive_flow', name: 'Shield Volcano Effusive Flow', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/shield_volcano_effusive_flow.js', importName: 'createShieldVolcanoEffusiveFlow' },

  { id: 'skeleton_arm', name: 'Skeleton Arm', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/skeleton_arm.js', importName: 'createSkeletonArm' },

  { id: 'skyscraper_tuned_mass_damper', name: 'Skyscraper Tuned Mass Damper', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/skyscraper_tuned_mass_damper.js', importName: 'createTunedMassDamper' },

  { id: 'sls_rocket', name: 'Sls Rocket', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/sls_rocket.js', importName: 'createSlsRocket' },
  ...
  { id: 'solarFlareMagneticReconnection', name: 'SolarFlareMagneticReconnection', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/solarFlareMagneticReconnection.js', importName: 'createSolarFlareMagneticReconnection' },

  { id: 'solar_panel', name: 'Solar Panel', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/solar_panel.js', importName: 'createSolarPanel' },

  { id: 'solar_sail_probe', name: 'Solar Sail Probe', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/solar_sail_probe.js', importName: 'createSolarSailProbe' },

  { id: 'sonic_fire_extinguisher', name: 'Sonic Fire Extinguisher', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/sonic_fire_extinguisher.js', importName: 'createSonicFireExtinguisher' },

  { id: 'sonochemistry_acoustic_levitator', name: 'Sonochemistry Acoustic Levitator', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/sonochemistry_acoustic_levitator.js', importName: 'createAcousticLevitator' },

  { id: 'space_elevator_tether', name: 'Space Elevator Tether', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/space_elevator_tether.js', importName: 'createSpaceElevator' },

  { id: 'space_helium3_extraction_plant', name: 'Space Helium3 Extraction Plant', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/space_helium3_extraction_plant.js', importName: 'createHelium3ExtractionPlant' },

  { id: 'space_low_gravity_centrifuge', name: 'Space Low Gravity Centrifuge', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/space_low_gravity_centrifuge.js', importName: 'createLowGravityCentrifuge' },

  { id: 'space_lunar_3d_printer', name: 'Space Lunar 3d Printer', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/space_lunar_3d_printer.js', importName: 'createLunar3DPrinter' },

  { id: 'space_lunar_lava_tube_airlock', name: 'Space Lunar Lava Tube Airlock', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/space_lunar_lava_tube_airlock.js', importName: 'createLunarLavaTubeAirlock' },

  { id: 'space_moon_dust_scrubber', name: 'Space Moon Dust Scrubber', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/space_moon_dust_scrubber.js', importName: 'createMoonDustScrubber' },

  { id: 'squeezed_light_interferometer', name: 'Squeezed Light Interferometer', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/squeezed_light_interferometer.js', importName: 'createSqueezedLightInterferometer' },

  { id: 'ssri_synapse', name: 'Ssri Synapse', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/ssri_synapse.js', importName: 'createSSRIMechanism' },

  { id: 'steam_engine', name: 'Steam Engine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/steam_engine.js', importName: 'createSteamEngine' },

  { id: 'steam_locomotive', name: 'Steam Locomotive', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/steam_locomotive.js', importName: 'createSteamLocomotive' },

  { id: 'steam_turbine', name: 'Steam Turbine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/steam_turbine.js', importName: 'createSteamTurbine' },

  { id: 'step_down_transformer', name: 'Step Down Transformer', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/step_down_transformer.js', importName: 'createStepDownTransformer' },

  { id: 'stern_gerlach', name: 'Stern Gerlach', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/stern_gerlach.js', importName: 'createSternGerlach' },

  { id: 'stern_gerlach_apparatus', name: 'Stern Gerlach Apparatus', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/stern_gerlach_apparatus.js', importName: 'createSternGerlachApparatus' },

  { id: 'stomach', name: 'Stomach', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/stomach.js', importName: 'createStomach' },

  { id: 'stomata_guard_cells', name: 'Stomata Guard Cells', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/stomata_guard_cells.js', importName: 'createStomataGuardCells' },

  { id: 'stratovolcano_eruption_model', name: 'Stratovolcano Eruption Model', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/stratovolcano_eruption_model.js', importName: 'createStratovolcanoEruptionModel' },

  { id: 'subatomic_baryogenesis_reactor', name: 'Subatomic Baryogenesis Reactor', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/subatomic_baryogenesis_reactor.js', importName: 'createBaryogenesisReactor' },

  { id: 'subatomic_higgs_field_modulator', name: 'Subatomic Higgs Field Modulator', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/subatomic_higgs_field_modulator.js', importName: 'createHiggsFieldModulator' },

  { id: 'subatomic_muon_catalyzed_fusion_core', name: 'Subatomic Muon Catalyzed Fusion Core', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/subatomic_muon_catalyzed_fusion_core.js', importName: 'createMuonCatalyzedFusionCore' },

  { id: 'subatomic_neutrino_oscillation', name: 'Subatomic Neutrino Oscillation', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/subatomic_neutrino_oscillation.js', importName: 'createNeutrinoOscillation' },

  { id: 'subatomic_pion_beam_emitter', name: 'Subatomic Pion Beam Emitter', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/subatomic_pion_beam_emitter.js', importName: 'createPionBeamEmitter' },

  { id: 'subatomic_quark_gluon_chamber', name: 'Subatomic Quark Gluon Chamber', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/subatomic_quark_gluon_chamber.js', importName: 'createQuarkGluonChamber' },

  { id: 'submarine_cable_repeater', name: 'Submarine Cable Repeater', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/submarine_cable_repeater.js', importName: 'createSubmarineCableRepeater' },

  { id: 'submersible_rov', name: 'Submersible Rov', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/submersible_rov.js', importName: 'createSubmersibleROV' },

  { id: 'supersonicWing', name: 'SupersonicWing', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/supersonicWing.js', importName: 'createSupersonicDeltaWing' },

  { id: 'taphonomy_amber_entombment', name: 'Taphonomy Amber Entombment', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/taphonomy_amber_entombment.js', importName: 'createAmberEntombment' },

  { id: 'taphonomy_decay_stages', name: 'Taphonomy Decay Stages', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/taphonomy_decay_stages.js', importName: 'createDecayStages' },

  { id: 'taphonomy_fossilization', name: 'Taphonomy Fossilization', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/taphonomy_fossilization.js', importName: 'createFossilization' },

  { id: 'taphonomy_scavenging', name: 'Taphonomy Scavenging', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/taphonomy_scavenging.js', importName: 'createScavenging' },

  { id: 'taphonomy_sediment_compaction', name: 'Taphonomy Sediment Compaction', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/taphonomy_sediment_compaction.js', importName: 'createSedimentCompaction' },

  { id: 'terra_atmospheric_processor', name: 'Terra Atmospheric Processor', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/terra_atmospheric_processor.js', importName: 'createAtmosphereProcessor' },

  { id: 'terra_comet_tractor', name: 'Terra Comet Tractor', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/terra_comet_tractor.js', importName: 'createCometTractor' },

  { id: 'terra_cyanobacteria_seeder', name: 'Terra Cyanobacteria Seeder', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/terra_cyanobacteria_seeder.js', importName: 'createCyanobacteriaSeederDrone' },

  { id: 'terra_martian_soil_detoxifier', name: 'Terra Martian Soil Detoxifier', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/terra_martian_soil_detoxifier.js', importName: 'createMartianSoilDetoxifier' },

  { id: 'terra_subglacial_ocean_probe', name: 'Terra Subglacial Ocean Probe', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/terra_subglacial_ocean_probe.js', importName: 'createSubglacialOceanProbe' },

  { id: 'tidal_energy_generator', name: 'Tidal Energy Generator', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/tidal_energy_generator.js', importName: 'createTidalEnergyGenerator' },

  { id: 'tokamak_reactor', name: 'Tokamak Reactor', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/tokamak_reactor.js', importName: 'createTokamakReactor' },

  { id: 'transmission_electron_microscope', name: 'Transmission Electron Microscope', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/transmission_electron_microscope.js', importName: 'createTransmissionElectronMicroscope' },

  { id: 'trilobite_anatomy', name: 'Trilobite Anatomy', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/trilobite_anatomy.js', importName: 'createTrilobiteAnatomy' },

  { id: 'tsunami_warning_buoy', name: 'Tsunami Warning Buoy', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/tsunami_warning_buoy.js', importName: 'createTsunamiWarningBuoy' },

  { id: 'turbocharger', name: 'Turbocharger', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/turbocharger.js', importName: 'createTurbocharger' },

  { id: 'turbofanEngine', name: 'TurbofanEngine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/turbofanEngine.js', importName: 'createTurbofanJetEngine' },

  { id: 'turbofan_engine', name: 'Turbofan Engine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/turbofan_engine.js', importName: 'createTurbofanEngine' },

  { id: 'ultrasonic_cell_disruptor', name: 'Ultrasonic Cell Disruptor', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/ultrasonic_cell_disruptor.js', importName: 'createUltrasonicCellDisruptor' },

  { id: 'variablePitchPropeller', name: 'VariablePitchPropeller', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/variablePitchPropeller.js', importName: 'createVariablePitchPropeller' },

  { id: 'ventilator', name: 'Ventilator', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/ventilator.js', importName: 'createVentilator' },

  { id: 'venus_flytrap_mechanism', name: 'Venus Flytrap Mechanism', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/venus_flytrap_mechanism.js', importName: 'createVenusFlytrapMechanism' },

  { id: 'viral_vector_delivery', name: 'Viral Vector Delivery', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/viral_vector_delivery.js', importName: 'createViralVectorDelivery' },

  { id: 'virology_ebola', name: 'Virology Ebola', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/virology_ebola.js', importName: 'createEbola' },

  { id: 'virology_hiv', name: 'Virology Hiv', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/virology_hiv.js', importName: 'createHIV' },

  { id: 'virus_bacteriophage', name: 'Virus Bacteriophage', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/virus_bacteriophage.js', importName: 'createBacteriophage' },

  { id: 'voyager_probe', name: 'Voyager Probe', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/voyager_probe.js', importName: 'createVoyagerProbe' },

  { id: 'water_molecule', name: 'Water Molecule', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/water_molecule.js', importName: 'createWaterMolecule' },

  { id: 'water_treatment_plant', name: 'Water Treatment Plant', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/water_treatment_plant.js', importName: 'createWaterTreatmentPlant' },

  { id: 'weapon_directed_energy_turret', name: 'Weapon Directed Energy Turret', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/weapon_directed_energy_turret.js', importName: 'createDirectedEnergyTurret' },

  { id: 'weapon_emp_disruptor_cannon', name: 'Weapon Emp Disruptor Cannon', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/weapon_emp_disruptor_cannon.js', importName: 'createEMPDisruptorCannon' },

  { id: 'weapon_graviton_torpedo_launcher', name: 'Weapon Graviton Torpedo Launcher', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/weapon_graviton_torpedo_launcher.js', importName: 'createGravitonTorpedoLauncher' },

  { id: 'weapon_plasma_railgun', name: 'Weapon Plasma Railgun', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/weapon_plasma_railgun.js', importName: 'createPlasmaRailgun' },

  { id: 'weapon_tachyon_lance', name: 'Weapon Tachyon Lance', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/weapon_tachyon_lance.js', importName: 'createTachyonLance' },

  { id: 'windTunnel', name: 'WindTunnel', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/windTunnel.js', importName: 'createSubsonicWindTunnel' },

  { id: 'xylem_transpiration', name: 'Xylem Transpiration', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/xylem_transpiration.js', importName: 'createXylemTranspiration' },
  ...
  { id: 'ac_generator', name: 'Generator', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/ac_generator.js', importName: 'createAcGenerator' },

  { id: 'aerodynamics_airfoil_lift', name: 'Airfoil Lift', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerodynamics_airfoil_lift.js', importName: 'createAirfoilLift' },

  { id: 'aerodynamics_magnus_effect', name: 'Magnus Effect', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerodynamics_magnus_effect.js', importName: 'createMagnusEffect' },

  { id: 'aerodynamics_propeller_thrust', name: 'Propeller Thrust', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerodynamics_propeller_thrust.js', importName: 'createPropellerThrust' },

  { id: 'aerodynamics_shock_wave', name: 'Shock Wave', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerodynamics_shock_wave.js', importName: 'createShockWave' },

  { id: 'aerodynamics_wind_tunnel', name: 'Wind Tunnel', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerodynamics_wind_tunnel.js', importName: 'createWindTunnel' },

  { id: 'aero_bow_thruster', name: 'Bow Thruster', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_bow_thruster.js', importName: 'createShipBowThruster' },

  { id: 'aero_flap_track', name: 'Flap Track', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_flap_track.js', importName: 'createAirplaneFlapTrack' },

  { id: 'aero_gyroscopic_horizon', name: 'Gyroscopic Horizon', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_gyroscopic_horizon.js', importName: 'createGyroscopicHorizon' },

  { id: 'aero_helicopter_swashplate', name: 'Helicopter Swashplate', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_helicopter_swashplate.js', importName: 'createHelicopterSwashplate' },

  { id: 'aero_hovercraft_lift_fan', name: 'Hovercraft Lift Fan', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_hovercraft_lift_fan.js', importName: 'createLiftFan' },

  { id: 'aero_hydrofoil_strut', name: 'Hydrofoil Strut', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_hydrofoil_strut.js', importName: 'createHydrofoilStrut' },

  { id: 'aero_jet_stator_vane', name: 'Jet Stator Vane', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_jet_stator_vane.js', importName: 'createStatorVane' },

  { id: 'aero_pelton_wheel', name: 'Pelton Wheel', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_pelton_wheel.js', importName: 'createPeltonWheel' },

  { id: 'aero_pitot_tube', name: 'Pitot Tube', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_pitot_tube.js', importName: 'createAircraftPitotTube' },

  { id: 'aero_retracting_landing_gear', name: 'Retracting Landing Gear', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_retracting_landing_gear.js', importName: 'createRetractingLandingGear' },

  { id: 'aero_submarine_ballast', name: 'Submarine Ballast', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_submarine_ballast.js', importName: 'createBallastTank' },

  { id: 'aero_tail_rotor', name: 'Tail Rotor', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_tail_rotor.js', importName: 'createHelicopterTailRotor' },

  { id: 'aero_thrust_reverser', name: 'Thrust Reverser', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_thrust_reverser.js', importName: 'createThrustReverser' },

  { id: 'aero_variable_pitch_propeller', name: 'Variable Pitch Propeller', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aero_variable_pitch_propeller.js', importName: 'createVariablePitchPropeller' },
  ...
  { id: 'airborne-dispersion-chamber', name: 'Airborne-Dispersion-Chamber', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/airborne-dispersion-chamber.js', importName: 'createAirborneDispersionChamber' },

  { id: 'air_data_computer', name: 'Data Computer', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/air_data_computer.js', importName: 'createAirDataComputer' },
  ...
  { id: 'amusement_carousel', name: 'Carousel', icon: '⚛️', category: 'amusement_rides', importPath: './machines/amusement_carousel.js', importName: 'createGrandCarousel' },

  { id: 'amusement_drop_tower', name: 'Drop Tower', icon: '⚛️', category: 'amusement_rides', importPath: './machines/amusement_drop_tower.js', importName: 'createDropTower' },

  { id: 'amusement_ferris_wheel', name: 'Ferris Wheel', icon: '⚛️', category: 'amusement_rides', importPath: './machines/amusement_ferris_wheel.js', importName: 'createFerrisWheel' },

  { id: 'amusement_pendulum', name: 'Pendulum', icon: '⚛️', category: 'amusement_rides', importPath: './machines/amusement_pendulum.js', importName: 'createPendulumSwing' },

  { id: 'amusement_rollercoaster', name: 'Rollercoaster', icon: '⚛️', category: 'amusement_rides', importPath: './machines/amusement_rollercoaster.js', importName: 'createRollercoaster' },
  ...
  { id: 'astroseismology_core_resonance', name: 'Core Resonance', icon: '⚛️', category: 'astrophysics', importPath: './machines/astroseismology_core_resonance.js', importName: 'createCoreResonance' },

  { id: 'astroseismology_doppler_imager', name: 'Doppler Imager', icon: '⚛️', category: 'astrophysics', importPath: './machines/astroseismology_doppler_imager.js', importName: 'createDopplerImager' },

  { id: 'astroseismology_pulsation_modes', name: 'Pulsation Modes', icon: '⚛️', category: 'astrophysics', importPath: './machines/astroseismology_pulsation_modes.js', importName: 'createPulsationModes' },

  { id: 'astroseismology_stellar_oscillator', name: 'Stellar Oscillator', icon: '⚛️', category: 'astrophysics', importPath: './machines/astroseismology_stellar_oscillator.js', importName: 'createStellarOscillator' },

  { id: 'astro_ccd_sensor_array', name: 'Ccd Sensor Array', icon: '⚛️', category: 'astrophysics', importPath: './machines/astro_ccd_sensor_array.js', importName: 'createCCDSensorArray' },

  { id: 'astro_deformable_mirror', name: 'Deformable Mirror', icon: '⚛️', category: 'astrophysics', importPath: './machines/astro_deformable_mirror.js', importName: 'createDeformableMirror' },

  { id: 'astro_interferometer_arm', name: 'Interferometer Arm', icon: '⚛️', category: 'astrophysics', importPath: './machines/astro_interferometer_arm.js', importName: 'createInterferometerArm' },
  ...
  { id: 'astro_space_coronagraph', name: 'Space Coronagraph', icon: '⚛️', category: 'astrophysics', importPath: './machines/astro_space_coronagraph.js', importName: 'createCoronagraphMask' },

  { id: 'astro_space_radio_feed_horn', name: 'Space Radio Feed Horn', icon: '⚛️', category: 'astrophysics', importPath: './machines/astro_space_radio_feed_horn.js', importName: 'createRadioFeedHorn' },

  { id: 'astro_space_star_tracker', name: 'Space Star Tracker', icon: '⚛️', category: 'astrophysics', importPath: './machines/astro_space_star_tracker.js', importName: 'createStarTracker' },

  { id: 'astro_space_sunshield', name: 'Space Sunshield', icon: '⚛️', category: 'astrophysics', importPath: './machines/astro_space_sunshield.js', importName: 'createSpaceSunshield' },

  { id: 'astro_space_xray_mirror', name: 'Space Xray Mirror', icon: '⚛️', category: 'astrophysics', importPath: './machines/astro_space_xray_mirror.js', importName: 'createXRayMirror' },

  { id: 'astro_spectrograph_grating', name: 'Spectrograph Grating', icon: '⚛️', category: 'astrophysics', importPath: './machines/astro_spectrograph_grating.js', importName: 'createSpectrographGrating' },
  ...
  { id: 'audio_condenser_mic', name: 'Condenser Mic', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/audio_condenser_mic.js', importName: 'createCondenserMic' },

  { id: 'audio_dynamic_mic', name: 'Dynamic Mic', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/audio_dynamic_mic.js', importName: 'createDynamicMic' },

  { id: 'audio_loudspeaker', name: 'Loudspeaker', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/audio_loudspeaker.js', importName: 'createLoudspeaker' },

  { id: 'audio_ribbon_tweeter', name: 'Ribbon Tweeter', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/audio_ribbon_tweeter.js', importName: 'createRibbonTweeter' },

  { id: 'audio_tech_dynamic_microphone', name: 'Tech Dynamic Microphone', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/audio_tech_dynamic_microphone.js', importName: 'createDynamicMicrophone' },

  { id: 'audio_tech_electrostatic_speaker', name: 'Tech Electrostatic Speaker', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/audio_tech_electrostatic_speaker.js', importName: 'createElectrostaticSpeaker' },

  { id: 'audio_tech_moving_coil_cartridge', name: 'Tech Moving Coil Cartridge', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/audio_tech_moving_coil_cartridge.js', importName: 'createMovingCoilCartridge' },

  { id: 'audio_tech_reel_to_reel_tape_deck', name: 'Tech Reel To Reel Tape Deck', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/audio_tech_reel_to_reel_tape_deck.js', importName: 'createReelToReelTapeDeck' },

  { id: 'audio_tech_vacuum_tube_amplifier', name: 'Tech Vacuum Tube Amplifier', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/audio_tech_vacuum_tube_amplifier.js', importName: 'createVacuumTubeAmplifier' },

  { id: 'audio_turntable', name: 'Turntable', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/audio_turntable.js', importName: 'createTurntable' },

  { id: 'automated_tissue_processor', name: 'Tissue Processor', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/automated_tissue_processor.js', importName: 'createAutomatedTissueProcessor' },

  { id: 'automotive_disc_brake', name: 'Disc Brake', icon: '⚛️', category: 'automotive_engineering', importPath: './machines/automotive_disc_brake.js', importName: 'createDiscBrake' },

  { id: 'automotive_manual_transmission', name: 'Manual Transmission', icon: '⚛️', category: 'automotive_engineering', importPath: './machines/automotive_manual_transmission.js', importName: 'createManualTransmission' },

  { id: 'automotive_open_differential', name: 'Open Differential', icon: '⚛️', category: 'automotive_engineering', importPath: './machines/automotive_open_differential.js', importName: 'createOpenDifferential' },

  { id: 'automotive_rack_and_pinion', name: 'Rack And Pinion', icon: '⚛️', category: 'automotive_engineering', importPath: './machines/automotive_rack_and_pinion.js', importName: 'createRackAndPinion' },

  { id: 'automotive_suspension_strut', name: 'Suspension Strut', icon: '⚛️', category: 'automotive_engineering', importPath: './machines/automotive_suspension_strut.js', importName: 'createSuspensionStrut' },
  ...
  { id: 'civil_airport_runway_lighting_system', name: 'Airport Runway Lighting System', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_airport_runway_lighting_system.js', importName: 'createAirportRunwayLightingSystem' },

  { id: 'civil_bascule_bridge', name: 'Bascule Bridge', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_bascule_bridge.js', importName: 'createBasculeBridge' },

  { id: 'civil_box_girder_bridge_segment', name: 'Box Girder Bridge Segment', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_box_girder_bridge_segment.js', importName: 'createBoxGirderBridgeSegment' },

  { id: 'civil_breakwater_tetrapods', name: 'Breakwater Tetrapods', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_breakwater_tetrapods.js', importName: 'createBreakwaterTetrapodArray' },

  { id: 'civil_cable_stayed_pylon', name: 'Cable Stayed Pylon', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_cable_stayed_pylon.js', importName: 'createCableStayedPylon' },

  { id: 'civil_canal_lock_gates', name: 'Canal Lock Gates', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_canal_lock_gates.js', importName: 'createCanalLockGates' },

  { id: 'civil_concrete_mixer_truck', name: 'Concrete Mixer Truck', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_concrete_mixer_truck.js', importName: 'createConcreteMixerTruck' },

  { id: 'civil_crane_slew_ring', name: 'Crane Slew Ring', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_crane_slew_ring.js', importName: 'createTowerCraneSlewRing' },

  { id: 'civil_geodesic_dome', name: 'Geodesic Dome', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_geodesic_dome.js', importName: 'createGeodesicDome' },

  { id: 'civil_gravity_dam_spillway', name: 'Gravity Dam Spillway', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_gravity_dam_spillway.js', importName: 'createGravityDamSpillway' },

  { id: 'civil_highway_overpass_interchange', name: 'Highway Overpass Interchange', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_highway_overpass_interchange.js', importName: 'createHighwayOverpassInterchange' },

  { id: 'civil_precast_concrete_pile_driver', name: 'Precast Concrete Pile Driver', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_precast_concrete_pile_driver.js', importName: 'createPrecastConcretePileDriver' },

  { id: 'civil_retaining_wall', name: 'Retaining Wall', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_retaining_wall.js', importName: 'createAnchoredEarthRetainingWall' },

  { id: 'civil_suspension_anchor', name: 'Suspension Anchor', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_suspension_anchor.js', importName: 'createSuspensionAnchor' },

  { id: 'civil_suspension_bridge_cable_anchor', name: 'Suspension Bridge Cable Anchor', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_suspension_bridge_cable_anchor.js', importName: 'createSuspensionBridgeCableAnchor' },

  { id: 'civil_suspension_saddle', name: 'Suspension Saddle', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_suspension_saddle.js', importName: 'createSuspensionSaddle' },

  { id: 'civil_swing_bridge', name: 'Swing Bridge', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_swing_bridge.js', importName: 'createSwingBridge' },

  { id: 'civil_tower_crane', name: 'Tower Crane', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_tower_crane.js', importName: 'createTowerCrane' },

  { id: 'civil_truss_bridge_joint', name: 'Truss Bridge Joint', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_truss_bridge_joint.js', importName: 'createTrussBridgeJoint' },

  { id: 'civil_tuned_mass_damper', name: 'Tuned Mass Damper', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_tuned_mass_damper.js', importName: 'createTunedMassDamper' },

  { id: 'civil_tunneling_ring', name: 'Tunneling Ring', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_tunneling_ring.js', importName: 'createShieldTunnelingRing' },

  { id: 'civil_tunnel_boring_machine', name: 'Tunnel Boring Machine', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_tunnel_boring_machine.js', importName: 'createTunnelBoringMachine' },
  ...
  { id: 'comm_satellite', name: 'Satellite', icon: '⚛️', category: 'telecommunications', importPath: './machines/comm_satellite.js', importName: 'createCommSatellite' },
  ...
  { id: 'computer_architecture_alu', name: 'Architecture Alu', icon: '⚛️', category: 'computer_engineering', importPath: './machines/computer_architecture_alu.js', importName: 'createAlu' },

  { id: 'computer_architecture_cache_hierarchy', name: 'Architecture Cache Hierarchy', icon: '⚛️', category: 'computer_engineering', importPath: './machines/computer_architecture_cache_hierarchy.js', importName: 'createCacheHierarchy' },

  { id: 'computer_architecture_turing_machine', name: 'Architecture Turing Machine', icon: '⚛️', category: 'computer_engineering', importPath: './machines/computer_architecture_turing_machine.js', importName: 'createTuringMachine' },

  { id: 'computer_architecture_von_neumann', name: 'Architecture Von Neumann', icon: '⚛️', category: 'computer_engineering', importPath: './machines/computer_architecture_von_neumann.js', importName: 'createVonNeumann' },

  { id: 'coral_reef', name: 'Reef', icon: '⚛️', category: 'coral', importPath: './machines/coral_reef.js', importName: 'createCoralReef' },

  { id: 'cosmochemistry_chondrule_furnace', name: 'Chondrule Furnace', icon: '⚛️', category: 'astrophysics', importPath: './machines/cosmochemistry_chondrule_furnace.js', importName: 'createChondruleFurnace' },

  { id: 'cosmochemistry_cometary_sublimator', name: 'Cometary Sublimator', icon: '⚛️', category: 'astrophysics', importPath: './machines/cosmochemistry_cometary_sublimator.js', importName: 'createCometarySublimator' },

  { id: 'cosmochemistry_ion_probe', name: 'Ion Probe', icon: '⚛️', category: 'astrophysics', importPath: './machines/cosmochemistry_ion_probe.js', importName: 'createIonProbe' },

  { id: 'cosmochemistry_isotope_analyzer', name: 'Isotope Analyzer', icon: '⚛️', category: 'astrophysics', importPath: './machines/cosmochemistry_isotope_analyzer.js', importName: 'createIsotopeAnalyzer' },

  { id: 'cosmochemistry_nebula_simulator', name: 'Nebula Simulator', icon: '⚛️', category: 'astrophysics', importPath: './machines/cosmochemistry_nebula_simulator.js', importName: 'createNebulaSimulator' },
  ...
  { id: 'cpu_architecture', name: 'Architecture', icon: '⚛️', category: 'computer_engineering', importPath: './machines/cpu_architecture.js', importName: 'createCPU' },
  ...
  { id: 'da_vinci_aerial_screw', name: 'Vinci Aerial Screw', icon: '⚛️', category: 'historical_engineering', importPath: './machines/da_vinci_aerial_screw.js', importName: 'createAerialScrew' },

  { id: 'da_vinci_armored_tank_gearbox', name: 'Vinci Armored Tank Gearbox', icon: '⚛️', category: 'historical_engineering', importPath: './machines/da_vinci_armored_tank_gearbox.js', importName: 'createArmoredTankGearbox' },

  { id: 'da_vinci_multi_barrel_cannon', name: 'Vinci Multi Barrel Cannon', icon: '⚛️', category: 'historical_engineering', importPath: './machines/da_vinci_multi_barrel_cannon.js', importName: 'createMultiBarrelCannon' },

  { id: 'da_vinci_ornithopter_wings', name: 'Vinci Ornithopter Wings', icon: '⚛️', category: 'historical_engineering', importPath: './machines/da_vinci_ornithopter_wings.js', importName: 'createOrnithopterWings' },

  { id: 'da_vinci_paddle_boat_mechanism', name: 'Vinci Paddle Boat Mechanism', icon: '⚛️', category: 'historical_engineering', importPath: './machines/da_vinci_paddle_boat_mechanism.js', importName: 'createPaddleBoatMechanism' },

  { id: 'deep_sea_bathysphere', name: 'Sea Bathysphere', icon: '⚛️', category: 'marine_engineering', importPath: './machines/deep_sea_bathysphere.js', importName: 'createBathysphere' },

  { id: 'deep_sea_hydrothermal_vent', name: 'Sea Hydrothermal Vent', icon: '⚛️', category: 'marine_engineering', importPath: './machines/deep_sea_hydrothermal_vent.js', importName: 'createDeepSeaHydrothermalVent' },

  { id: 'deep_sea_rov_arm', name: 'Sea Rov Arm', icon: '⚛️', category: 'marine_engineering', importPath: './machines/deep_sea_rov_arm.js', importName: 'createROVArm' },
  ...
  { id: 'deep_sea_thruster', name: 'Sea Thruster', icon: '⚛️', category: 'marine_engineering', importPath: './machines/deep_sea_thruster.js', importName: 'createUnderwaterThruster' },
  ...
  { id: 'dna', name: 'Dna', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/dna.js', importName: 'create' },
  ...
  { id: 'double_slit_interferometer', name: 'Slit Interferometer', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/double_slit_interferometer.js', importName: 'createDoubleSlitInterferometer' },
  ...
  { id: 'electrical_ac_generator', name: 'Ac Generator', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/electrical_ac_generator.js', importName: 'createACGenerator' },

  { id: 'electrical_arc_furnace_electrodes', name: 'Arc Furnace Electrodes', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/electrical_arc_furnace_electrodes.js', importName: 'createArcFurnace' },

  { id: 'electrical_faraday_cage', name: 'Faraday Cage', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/electrical_faraday_cage.js', importName: 'createFaradayCage' },

  { id: 'electrical_high_voltage_insulator_string', name: 'High Voltage Insulator String', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/electrical_high_voltage_insulator_string.js', importName: 'createHighVoltageInsulatorString' },

  { id: 'electrical_hv_circuit_breaker', name: 'Hv Circuit Breaker', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/electrical_hv_circuit_breaker.js', importName: 'createCircuitBreaker' },

  { id: 'electrical_hv_transformer', name: 'Hv Transformer', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/electrical_hv_transformer.js', importName: 'createTransformer' },

  { id: 'electrical_induction_motor', name: 'Induction Motor', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/electrical_induction_motor.js', importName: 'createInductionMotor' },

  { id: 'electrical_linear_induction_motor', name: 'Linear Induction Motor', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/electrical_linear_induction_motor.js', importName: 'createLinearInductionMotor' },

  { id: 'electrical_power_grid_capacitor_bank', name: 'Power Grid Capacitor Bank', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/electrical_power_grid_capacitor_bank.js', importName: 'createPowerGridCapacitorBank' },

  { id: 'electrical_relay_switch_logic', name: 'Relay Switch Logic', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/electrical_relay_switch_logic.js', importName: 'createRelaySwitchLogic' },

  { id: 'electrical_stator_commutator', name: 'Stator Commutator', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/electrical_stator_commutator.js', importName: 'createStatorCommutator' },

  { id: 'electrical_submarine_power_cable', name: 'Submarine Power Cable', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/electrical_submarine_power_cable.js', importName: 'createSubmarinePowerCable' },

  { id: 'electrical_substation_switchgear', name: 'Substation Switchgear', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/electrical_substation_switchgear.js', importName: 'createSubstationSwitchgear' },

  { id: 'electrical_synchronous_condenser', name: 'Synchronous Condenser', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/electrical_synchronous_condenser.js', importName: 'createSynchronousCondenser' },

  { id: 'electrical_wind_turbine_nacelle', name: 'Wind Turbine Nacelle', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/electrical_wind_turbine_nacelle.js', importName: 'createWindTurbineGenerator' },
  ...
  { id: 'flight_management_system', name: 'Management System', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/flight_management_system.js', importName: 'createFlightManagementSystem' },
  ...
  { id: 'generator', name: 'Generator', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/generator.js', importName: 'createGenerator' },
  ...
  { id: 'geosynchronous_satellite', name: 'Satellite', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/geosynchronous_satellite.js', importName: 'createGeosynchronousSatellite' },
  ...
  { id: 'get_batch', name: 'Batch', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/get_batch.js', importName: 'default' },

  { id: 'giant_squid_anatomy', name: 'Squid Anatomy', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/giant_squid_anatomy.js', importName: 'createGiantSquidAnatomy' },
  ...
  { id: 'glaciology_subglacial_probe', name: 'Glaciology Subglacial Probe', icon: '⚛️', category: 'marine_engineering', importPath: './machines/glaciology_subglacial_probe.js', importName: 'createSubglacialProbe' },
  ...
  { id: 'heavy_machinery_bulldozer', name: 'Machinery Bulldozer', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/heavy_machinery_bulldozer.js', importName: 'createBulldozer' },

  { id: 'heavy_machinery_dump_truck', name: 'Machinery Dump Truck', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/heavy_machinery_dump_truck.js', importName: 'createDumpTruck' },

  { id: 'heavy_machinery_excavator', name: 'Machinery Excavator', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/heavy_machinery_excavator.js', importName: 'createExcavator' },

  { id: 'heavy_machinery_tbm', name: 'Machinery Tbm', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/heavy_machinery_tbm.js', importName: 'createTBM' },

  { id: 'heavy_machinery_tower_crane', name: 'Machinery Tower Crane', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/heavy_machinery_tower_crane.js', importName: 'createTowerCrane' },

  { id: 'helicopter_main_rotor', name: 'Main Rotor', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/helicopter_main_rotor.js', importName: 'createMainRotor' },

  { id: 'helicopter_skid_dampener', name: 'Skid Dampener', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/helicopter_skid_dampener.js', importName: 'createSkidDampener' },

  { id: 'helicopter_swashplate', name: 'Swashplate', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/helicopter_swashplate.js', importName: 'createSwashplate' },

  { id: 'helicopter_tail_rotor', name: 'Tail Rotor', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/helicopter_tail_rotor.js', importName: 'createTailRotor' },

  { id: 'helicopter_turboshaft_engine', name: 'Turboshaft Engine', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/helicopter_turboshaft_engine.js', importName: 'createTurboshaftEngine' },
  ...
  { id: 'historical_ballista', name: 'Ballista', icon: '⚛️', category: 'historical_engineering', importPath: './machines/historical_ballista.js', importName: 'createBallista' },

  { id: 'historical_battering_ram', name: 'Battering Ram', icon: '⚛️', category: 'historical_engineering', importPath: './machines/historical_battering_ram.js', importName: 'createBatteringRam' },

  { id: 'historical_catapult', name: 'Catapult', icon: '⚛️', category: 'historical_engineering', importPath: './machines/historical_catapult.js', importName: 'createCatapult' },

  { id: 'historical_siege_tower', name: 'Siege Tower', icon: '⚛️', category: 'historical_engineering', importPath: './machines/historical_siege_tower.js', importName: 'createSiegeTower' },

  { id: 'historical_trebuchet', name: 'Trebuchet', icon: '⚛️', category: 'historical_engineering', importPath: './machines/historical_trebuchet.js', importName: 'createTrebuchet' },
  ...
  { id: 'io_dma_controller', name: 'Dma Controller', icon: '⚛️', category: 'computing', importPath: './machines/io_dma_controller.js', importName: 'createIoDmaController' },

  { id: 'ipc_message_queue', name: 'Message Queue', icon: '⚛️', category: 'computing', importPath: './machines/ipc_message_queue.js', importName: 'createIpcMessageQueue' },
  ...
  { id: 'lagrange_points', name: 'Points', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/lagrange_points.js', importName: 'createLagrangePointsSystem' },
  ...
  { id: 'marine_biology_jellyfish', name: 'Biology Jellyfish', icon: '⚛️', category: 'marine_engineering', importPath: './machines/marine_biology_jellyfish.js', importName: 'createJellyfish' },

  { id: 'marine_biology_plankton', name: 'Biology Plankton', icon: '⚛️', category: 'marine_engineering', importPath: './machines/marine_biology_plankton.js', importName: 'createPlankton' },

  { id: 'marine_biology_shark', name: 'Biology Shark', icon: '⚛️', category: 'marine_engineering', importPath: './machines/marine_biology_shark.js', importName: 'createShark' },

  { id: 'marine_biology_submersible', name: 'Biology Submersible', icon: '⚛️', category: 'marine_engineering', importPath: './machines/marine_biology_submersible.js', importName: 'createSubmersible' },

  { id: 'marine_container_ship', name: 'Container Ship', icon: '⚛️', category: 'marine_engineering', importPath: './machines/marine_container_ship.js', importName: 'createContainerShip' },

  { id: 'marine_food_web', name: 'Food Web', icon: '⚛️', category: 'marine_engineering', importPath: './machines/marine_food_web.js', importName: 'createMarineFoodWeb' },

  { id: 'marine_hovercraft', name: 'Hovercraft', icon: '⚛️', category: 'marine_engineering', importPath: './machines/marine_hovercraft.js', importName: 'createHovercraft' },

  { id: 'marine_hydrofoil', name: 'Hydrofoil', icon: '⚛️', category: 'marine_engineering', importPath: './machines/marine_hydrofoil.js', importName: 'createHydrofoil' },

  { id: 'marine_submarine', name: 'Submarine', icon: '⚛️', category: 'marine_engineering', importPath: './machines/marine_submarine.js', importName: 'createSubmarine' },

  { id: 'mars_rover_descent_stage_crane', name: 'Rover Descent Stage Crane', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/mars_rover_descent_stage_crane.js', importName: 'createDescentStageCrane' },

  { id: 'mars_rover_multi_mission_rtg', name: 'Rover Multi Mission Rtg', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/mars_rover_multi_mission_rtg.js', importName: 'createMultiMissionRTG' },

  { id: 'mars_rover_panoramic_camera_mast', name: 'Rover Panoramic Camera Mast', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/mars_rover_panoramic_camera_mast.js', importName: 'createPanoramicCameraMast' },

  { id: 'mars_rover_rocker_bogie', name: 'Rover Rocker Bogie', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/mars_rover_rocker_bogie.js', importName: 'createRockerBogie' },

  { id: 'mars_rover_sample_return_drill', name: 'Rover Sample Return Drill', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/mars_rover_sample_return_drill.js', importName: 'createSampleReturnDrill' },
  ...
  { id: 'mech_camshaft_follower', name: 'Camshaft Follower', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mech_camshaft_follower.js', importName: 'createCamshaftFollower' },

  { id: 'mech_centrifugal_pump', name: 'Centrifugal Pump', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mech_centrifugal_pump.js', importName: 'createCentrifugalPump' },

  { id: 'mech_differential_gear', name: 'Differential Gear', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mech_differential_gear.js', importName: 'createDifferentialGear' },

  { id: 'mech_four_stroke_engine_cylinder', name: 'Four Stroke Engine Cylinder', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mech_four_stroke_engine_cylinder.js', importName: 'createFourStrokeEngineCylinder' },

  { id: 'mech_geneva_drive', name: 'Geneva Drive', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mech_geneva_drive.js', importName: 'createGenevaDrive' },

  { id: 'mech_harmonic_drive', name: 'Harmonic Drive', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mech_harmonic_drive.js', importName: 'createHarmonicDrive' },

  { id: 'mech_hydraulic_excavator_arm', name: 'Hydraulic Excavator Arm', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mech_hydraulic_excavator_arm.js', importName: 'createHydraulicExcavatorArm' },

  { id: 'mech_planetary_gearbox', name: 'Planetary Gearbox', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mech_planetary_gearbox.js', importName: 'createPlanetaryGearbox' },

  { id: 'mech_rack_and_pinion', name: 'Rack And Pinion', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mech_rack_and_pinion.js', importName: 'createRackAndPinion' },

  { id: 'mech_roots_blower', name: 'Roots Blower', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mech_roots_blower.js', importName: 'createRootsBlower' },

  { id: 'mech_scotch_yoke', name: 'Scotch Yoke', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mech_scotch_yoke.js', importName: 'createScotchYoke' },

  { id: 'mech_scroll_compressor', name: 'Scroll Compressor', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mech_scroll_compressor.js', importName: 'createScrollCompressor' },

  { id: 'mech_universal_joint', name: 'Universal Joint', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mech_universal_joint.js', importName: 'createUniversalJoint' },

  { id: 'mech_wankel_engine', name: 'Wankel Engine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mech_wankel_engine.js', importName: 'createWankelEngine' },
  ...
  { id: 'molecules', name: 'Molecules', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/molecules.js', importName: 'createMolecules' },
  ...
  { id: 'networking_datacenter_rack', name: 'Datacenter Rack', icon: '⚛️', category: 'network_engineering', importPath: './machines/networking_datacenter_rack.js', importName: 'createDataCenterRack' },

  { id: 'networking_router', name: 'Router', icon: '⚛️', category: 'network_engineering', importPath: './machines/networking_router.js', importName: 'createRouterModel' },

  { id: 'networking_switch', name: 'Switch', icon: '⚛️', category: 'network_engineering', importPath: './machines/networking_switch.js', importName: 'createSwitchModel' },

  { id: 'network_5g_cell_tower', name: '5G Cell Tower', icon: '⚛️', category: 'network_engineering', importPath: './machines/network_5g_cell_tower.js', importName: 'createCellTower' },

  { id: 'network_datacenter_server_rack', name: 'Datacenter Server Rack', icon: '⚛️', category: 'network_engineering', importPath: './machines/network_datacenter_server_rack.js', importName: 'createDatacenterServerRack' },

  { id: 'network_high_speed_switch', name: 'High Speed Switch', icon: '⚛️', category: 'network_engineering', importPath: './machines/network_high_speed_switch.js', importName: 'createHighSpeedNetworkSwitch' },

  { id: 'network_satellite_dish_array', name: 'Satellite Dish Array', icon: '⚛️', category: 'network_engineering', importPath: './machines/network_satellite_dish_array.js', importName: 'createSatelliteDishArray' },

  { id: 'network_subsea_fiber_cable', name: 'Subsea Fiber Cable', icon: '⚛️', category: 'network_engineering', importPath: './machines/network_subsea_fiber_cable.js', importName: 'createSubseaFiberCable' },
  ...
  { id: 'neuron', name: 'Neuron', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/neuron.js', importName: 'createNeuron' },
  ...
  { id: 'ocean_bottom_seismometer', name: 'Bottom Seismometer', icon: '⚛️', category: 'marine_engineering', importPath: './machines/ocean_bottom_seismometer.js', importName: 'createOceanBottomSeismometer' },

  { id: 'ocean_ecosystem', name: 'Ecosystem', icon: '⚛️', category: 'marine_engineering', importPath: './machines/ocean_ecosystem.js', importName: 'createOceanEcosystem' },
  ...
  { id: 'ocean_geo_otec_plant', name: 'Otec Plant', icon: '⚛️', category: 'marine_engineering', importPath: './machines/ocean_geo_otec_plant.js', importName: 'createOtecPlant' },

  { id: 'ocean_geo_salinity_gradient_generator', name: 'Salinity Gradient Generator', icon: '⚛️', category: 'marine_engineering', importPath: './machines/ocean_geo_salinity_gradient_generator.js', importName: 'createSalinityGradientGenerator' },

  { id: 'ocean_geo_tidal_turbine', name: 'Tidal Turbine', icon: '⚛️', category: 'marine_engineering', importPath: './machines/ocean_geo_tidal_turbine.js', importName: 'createTidalTurbine' },

  { id: 'ocean_geo_wave_energy_converter', name: 'Wave Energy Converter', icon: '⚛️', category: 'marine_engineering', importPath: './machines/ocean_geo_wave_energy_converter.js', importName: 'createWaveEnergyConverter' },

  { id: 'ocean_thermohaline_circulation', name: 'Thermohaline Circulation', icon: '⚛️', category: 'marine_engineering', importPath: './machines/ocean_thermohaline_circulation.js', importName: 'createOceanThermohalineCirculation' },
  ...
  { id: 'orbital_mechanics_hohmann_transfer', name: 'Mechanics Hohmann Transfer', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/orbital_mechanics_hohmann_transfer.js', importName: 'createHohmannTransfer' },

  { id: 'orbital_mechanics_kepler_laws', name: 'Mechanics Kepler Laws', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/orbital_mechanics_kepler_laws.js', importName: 'createKeplersLaws' },

  { id: 'orbital_mechanics_satellite_constellation', name: 'Mechanics Satellite Constellation', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/orbital_mechanics_satellite_constellation.js', importName: 'createSatelliteConstellation' },

  { id: 'orbital_mechanics_three_body', name: 'Mechanics Three Body', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/orbital_mechanics_three_body.js', importName: 'createThreeBodyProblem' },

  { id: 'orbital_mechanics_two_body', name: 'Mechanics Two Body', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/orbital_mechanics_two_body.js', importName: 'createTwoBodyOrbit' },

  { id: 'orbital_resonance', name: 'Resonance', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/orbital_resonance.js', importName: 'createOrbitalResonanceSystem' },

  { id: 'otec_plant', name: 'Plant', icon: '⚛️', category: 'otec', importPath: './machines/otec_plant.js', importName: 'createOtecPlant' },

  { id: 'outbreak-command-center', name: 'Outbreak-Command-Center', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/outbreak-command-center.js', importName: 'createOutbreakResponseCommandCenter' },
  ...
  { id: 'pathogen-mutation-sequencer', name: 'Pathogen-Mutation-Sequencer', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/pathogen-mutation-sequencer.js', importName: 'createPathogenMutationSequencer' },
  ...
  { id: 'power_generation_coal_plant', name: 'Generation Coal Plant', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/power_generation_coal_plant.js', importName: 'createCoalPlant' },
  ...
  { id: 'power_generation_hydroelectric_dam', name: 'Generation Hydroelectric Dam', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/power_generation_hydroelectric_dam.js', importName: 'createHydroelectricDam' },

  { id: 'power_generation_nuclear_plant', name: 'Generation Nuclear Plant', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/power_generation_nuclear_plant.js', importName: 'createNuclearPlant' },

  { id: 'power_generation_wind_turbine', name: 'Generation Wind Turbine', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/power_generation_wind_turbine.js', importName: 'createWindTurbine' },
  ...
  { id: 'ribosome', name: 'Ribosome', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/ribosome.js', importName: 'createRibosome' },

  { id: 'robotics_animatronic_facial_rig', name: 'Animatronic Facial Rig', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/robotics_animatronic_facial_rig.js', importName: 'createAnimatronicFacialRig' },

  { id: 'robotics_bipedal_mechanism', name: 'Bipedal Mechanism', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/robotics_bipedal_mechanism.js', importName: 'createBipedalMechanism' },

  { id: 'robotics_industrial_welding_arm', name: 'Industrial Welding Arm', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/robotics_industrial_welding_arm.js', importName: 'createIndustrialWeldingArm' },

  { id: 'robotics_omni_directional_wheel_drive', name: 'Omni Directional Wheel Drive', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/robotics_omni_directional_wheel_drive.js', importName: 'createOmniDirectionalWheelDrive' },

  { id: 'robotics_quadruped_robot_leg', name: 'Quadruped Robot Leg', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/robotics_quadruped_robot_leg.js', importName: 'createQuadrupedRobotLeg' },

  { id: 'robot_arm', name: 'Arm', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/robot_arm.js', importName: 'createRobotArm' },
  ...
  { id: 'scramjet_engine', name: 'Engine', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/scramjet_engine.js', importName: 'createScramjetEngine' },
  ...
  { id: 'siege_battering_ram', name: 'Battering Ram', icon: '⚛️', category: 'historical_engineering', importPath: './machines/siege_battering_ram.js', importName: 'createBatteringRam' },

  { id: 'siege_greek_fire', name: 'Greek Fire', icon: '⚛️', category: 'historical_engineering', importPath: './machines/siege_greek_fire.js', importName: 'createGreekFireSiphon' },

  { id: 'siege_trebuchet', name: 'Trebuchet', icon: '⚛️', category: 'historical_engineering', importPath: './machines/siege_trebuchet.js', importName: 'createTrebuchet' },

  { id: 'single_photon_detector', name: 'Photon Detector', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/single_photon_detector.js', importName: 'createPhotonDetector' },
  ...
  { id: 'space_station_airlock', name: 'Station Airlock', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/space_station_airlock.js', importName: 'createAirlockChamber' },

  { id: 'space_station_centrifuge', name: 'Station Centrifuge', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/space_station_centrifuge.js', importName: 'createCentrifugeHabitat' },

  { id: 'space_station_cupola', name: 'Station Cupola', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/space_station_cupola.js', importName: 'createCupolaModule' },

  { id: 'space_station_docking_port', name: 'Station Docking Port', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/space_station_docking_port.js', importName: 'createDockingPortAdapter' },

  { id: 'space_station_solar_array', name: 'Station Solar Array', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/space_station_solar_array.js', importName: 'createSolarArrayTruss' },
  ...
  { id: 'subglacial_buoyancy_control_bladder', name: 'Subglacial Buoyancy Control Bladder', icon: '⚛️', category: 'marine_engineering', importPath: './machines/subglacial_buoyancy_control_bladder.js', importName: 'createBuoyancyControlBladder' },

  { id: 'subglacial_ice_penetrating_radar_antenna', name: 'Subglacial Ice Penetrating Radar Antenna', icon: '⚛️', category: 'marine_engineering', importPath: './machines/subglacial_ice_penetrating_radar_antenna.js', importName: 'createIcePenetratingRadarAntenna' },
  ...
  { id: 'subglacial_subglacial_geyser_sampler', name: 'Subglacial Subglacial Geyser Sampler', icon: '⚛️', category: 'marine_engineering', importPath: './machines/subglacial_subglacial_geyser_sampler.js', importName: 'createSubglacialGeyserSampler' },

  { id: 'subglacial_sub_ice_auv_hydrobot', name: 'Subglacial Sub Ice Auv Hydrobot', icon: '⚛️', category: 'marine_engineering', importPath: './machines/subglacial_sub_ice_auv_hydrobot.js', importName: 'createSubIceAUVHydrobot' },

  { id: 'submarine', name: 'Submarine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/submarine.js', importName: 'createSubmarine' },

  { id: 'supersonic_nozzle', name: 'Nozzle', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/supersonic_nozzle.js', importName: 'createSupersonicNozzle' },
  ...
  { id: 'theme_park_bumper_car', name: 'Park Bumper Car', icon: '⚛️', category: 'amusement_rides', importPath: './machines/theme_park_bumper_car.js', importName: 'createBumperCar' },

  { id: 'theme_park_drop_tower', name: 'Park Drop Tower', icon: '⚛️', category: 'amusement_rides', importPath: './machines/theme_park_drop_tower.js', importName: 'createDropTower' },

  { id: 'theme_park_giant_pendulum', name: 'Park Giant Pendulum', icon: '⚛️', category: 'amusement_rides', importPath: './machines/theme_park_giant_pendulum.js', importName: 'createGiantPendulumRide' },

  { id: 'theme_park_scrambler', name: 'Park Scrambler', icon: '⚛️', category: 'amusement_rides', importPath: './machines/theme_park_scrambler.js', importName: 'createScramblerRide' },

  { id: 'theme_park_top_spin', name: 'Park Top Spin', icon: '⚛️', category: 'amusement_rides', importPath: './machines/theme_park_top_spin.js', importName: 'createTopSpinRide' },
  ...
  { id: 'tower_crane', name: 'Crane', icon: '⚛️', category: 'civil_engineering', importPath: './machines/tower_crane.js', importName: 'createTowerCrane' },
  ...
  { id: 't_cell_activation', name: 'Cell Activation', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/t_cell_activation.js', importName: 'createTCellActivation' },

  { id: 't_rex_skeleton_assembly', name: 'Rex Skeleton Assembly', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/t_rex_skeleton_assembly.js', importName: 'createTRexSkeletonAssembly' },

  { id: 'vaccine-cold-chain', name: 'Vaccine-Cold-Chain', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/vaccine-cold-chain.js', importName: 'createVaccineColdChainDeliverySystem' },
  ...
  { id: 'vintage_antikythera_mechanism', name: 'Antikythera Mechanism', icon: '⚛️', category: 'vintage_tech', importPath: './machines/vintage_antikythera_mechanism.js', importName: 'createAntikytheraMechanism' },

  { id: 'vintage_camera_flashbulb', name: 'Camera Flashbulb', icon: '⚛️', category: 'vintage_tech', importPath: './machines/vintage_camera_flashbulb.js', importName: 'createFlashbulbSynchronizer' },

  { id: 'vintage_camera_instant', name: 'Camera Instant', icon: '⚛️', category: 'vintage_tech', importPath: './machines/vintage_camera_instant.js', importName: 'createInstantFilmMechanism' },

  { id: 'vintage_camera_rangefinder', name: 'Camera Rangefinder', icon: '⚛️', category: 'vintage_tech', importPath: './machines/vintage_camera_rangefinder.js', importName: 'createRangefinderMechanism' },

  { id: 'vintage_camera_tlr', name: 'Camera Tlr', icon: '⚛️', category: 'vintage_tech', importPath: './machines/vintage_camera_tlr.js', importName: 'createTwinLensReflex' },

  { id: 'vintage_camera_view', name: 'Camera View', icon: '⚛️', category: 'vintage_tech', importPath: './machines/vintage_camera_view.js', importName: 'createLargeFormatViewCamera' },

  { id: 'vintage_core_memory_matrix', name: 'Core Memory Matrix', icon: '⚛️', category: 'vintage_tech', importPath: './machines/vintage_core_memory_matrix.js', importName: 'createCoreMemoryMatrix' },

  { id: 'vintage_punch_card_reader', name: 'Punch Card Reader', icon: '⚛️', category: 'vintage_tech', importPath: './machines/vintage_punch_card_reader.js', importName: 'createPunchCardReader' },

  { id: 'vintage_turing_bombe', name: 'Turing Bombe', icon: '⚛️', category: 'vintage_tech', importPath: './machines/vintage_turing_bombe.js', importName: 'createTuringBombe' },

  { id: 'vintage_vacuum_tube_logic', name: 'Vacuum Tube Logic', icon: '⚛️', category: 'vintage_tech', importPath: './machines/vintage_vacuum_tube_logic.js', importName: 'createVacuumTubeLogicGate' },

  { id: 'viral-transmission-simulator', name: 'Viral-Transmission-Simulator', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/viral-transmission-simulator.js', importName: 'createViralTransmissionSimulator' },
  ...
  { id: 'wankel_engine', name: 'Engine', icon: '⚛️', category: 'automotive_engineering', importPath: './machines/wankel_engine.js', importName: 'createWankelEngine' },
  ...
  { id: 'aerodynamics_rotor_blade', name: 'Rotor Blade', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerodynamics_rotor_blade.js', importName: 'createRotorBlade' },

  { id: 'aerodynamics_supersonic_cone', name: 'Supersonic Cone', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerodynamics_supersonic_cone.js', importName: 'createSupersonicCone' },

  { id: 'aerodynamics_vortex_generator', name: 'Vortex Generator', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerodynamics_vortex_generator.js', importName: 'createVortexGenerator' },

  { id: 'aerospace_deployable_solar_array_v1', name: 'Deployable Solar Array V1', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerospace_deployable_solar_array_v1.js', importName: 'createDeployableSolarArray' },

  { id: 'aerospace_ion_thruster_v2', name: 'Ion Thruster V2', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerospace_ion_thruster_v2.js', importName: 'createIonThruster' },

  { id: 'aerospace_lunar_lander_module_v1', name: 'Lunar Lander Module V1', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerospace_lunar_lander_module_v1.js', importName: 'createLunarLanderModule' },

  { id: 'aerospace_reaction_wheel_assembly_v1', name: 'Reaction Wheel Assembly V1', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerospace_reaction_wheel_assembly_v1.js', importName: 'createReactionWheelAssembly' },

  { id: 'aerospace_scramjet_engine_v1', name: 'Scramjet Engine V1', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerospace_scramjet_engine_v1.js', importName: 'createScramjetEngine' },
  ...
  { id: 'civil_cantilever_bridge_segment', name: 'Cantilever Bridge Segment', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_cantilever_bridge_segment.js', importName: 'createCantileverBridgeSegment' },

  { id: 'civil_gabion_wall_module', name: 'Gabion Wall Module', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_gabion_wall_module.js', importName: 'createGabionWallModule' },

  { id: 'civil_post_tensioning_jack', name: 'Post Tensioning Jack', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_post_tensioning_jack.js', importName: 'createPostTensioningJack' },

  { id: 'civil_tremie_pipe_system', name: 'Tremie Pipe System', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_tremie_pipe_system.js', importName: 'createTremiePipeSystem' },

  { id: 'civil_vibratory_pile_driver', name: 'Vibratory Pile Driver', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_vibratory_pile_driver.js', importName: 'createVibratoryPileDriver' },
  ...
  { id: 'aerospace_helicopter_rotor', name: 'Helicopter Rotor', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerospace_helicopter_rotor.js', importName: 'createHelicopterRotorHead' },

  { id: 'aerospace_landing_gear', name: 'Landing Gear', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerospace_landing_gear.js', importName: 'createLandingGearAssembly' },

  { id: 'aerospace_rocket_gimbal', name: 'Rocket Gimbal', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerospace_rocket_gimbal.js', importName: 'createRocketEngineGimbal' },

  { id: 'aerospace_scramjet_engine', name: 'Scramjet Engine', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerospace_scramjet_engine.js', importName: 'createScramjetEngine' },

  { id: 'aerospace_turbofan_engine', name: 'Turbofan Engine', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerospace_turbofan_engine.js', importName: 'createTurbofanJetEngine' },
  ...
  { id: 'civil_tbm_erector', name: 'Tbm Erector', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_tbm_erector.js', importName: 'createTBMErector' },

  { id: 'electrical_capacitor_bank', name: 'Capacitor Bank', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/electrical_capacitor_bank.js', importName: 'createCapacitorBank' },

  { id: 'electrical_solenoid_actuator', name: 'Solenoid Actuator', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/electrical_solenoid_actuator.js', importName: 'createSolenoidActuator' },

  { id: 'electrical_substation_switch', name: 'Substation Switch', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/electrical_substation_switch.js', importName: 'createSubstationSwitch' },

  { id: 'electrical_tesla_coil', name: 'Tesla Coil', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/electrical_tesla_coil.js', importName: 'createTeslaCoil' },
  ...
  { id: 'mechanical_centrifugal_pump', name: 'Centrifugal Pump', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mechanical_centrifugal_pump.js', importName: 'createCentrifugalPump' },

  { id: 'mechanical_differential_gear', name: 'Differential Gear', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mechanical_differential_gear.js', importName: 'createDifferentialGear' },

  { id: 'mechanical_hydraulic_press', name: 'Hydraulic Press', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mechanical_hydraulic_press.js', importName: 'createHydraulicPress' },

  { id: 'mechanical_planetary_gearset', name: 'Planetary Gearset', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mechanical_planetary_gearset.js', importName: 'createPlanetaryGearset' },

  { id: 'mechanical_steam_turbine', name: 'Steam Turbine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mechanical_steam_turbine.js', importName: 'createSteamTurbineRotor' },
  ...
  { id: 'robotics_delta_robot', name: 'Delta Robot', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/robotics_delta_robot.js', importName: 'createDeltaRobot' },

  { id: 'robotics_drone_swarm', name: 'Drone Swarm', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/robotics_drone_swarm.js', importName: 'createDroneSwarm' },

  { id: 'robotics_gripper_array', name: 'Gripper Array', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/robotics_gripper_array.js', importName: 'createGripperArray' },

  { id: 'robotics_omni_rover', name: 'Omni Rover', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/robotics_omni_rover.js', importName: 'createOmniRover' },

  { id: 'robotics_quadruped', name: 'Quadruped', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/robotics_quadruped.js', importName: 'createQuadruped' },
  ...
  { id: 'acoustics_anc_head', name: 'Anc Head', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/acoustics_anc_head.js', importName: 'createANCHead' },

  { id: 'acoustics_anechoic_chamber', name: 'Anechoic Chamber', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/acoustics_anechoic_chamber.js', importName: 'createAnechoicChamber' },

  { id: 'acoustics_metamaterial_panel', name: 'Metamaterial Panel', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/acoustics_metamaterial_panel.js', importName: 'createMetamaterialPanel' },

  { id: 'acoustics_parametric_speaker', name: 'Parametric Speaker', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/acoustics_parametric_speaker.js', importName: 'createParametricSpeaker' },

  { id: 'acoustics_sonic_levitator', name: 'Sonic Levitator', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/acoustics_sonic_levitator.js', importName: 'createSonicLevitator' },
  ...
  { id: 'space_centrifuge_accommodation_module', name: 'Centrifuge Accommodation Module', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/space_centrifuge_accommodation_module.js', importName: 'createCentrifugeAccommodationModule' },

  { id: 'space_inflatable_orbital_module', name: 'Inflatable Orbital Module', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/space_inflatable_orbital_module.js', importName: 'createInflatableOrbitalModule' },

  { id: 'space_lunar_regolith_base', name: 'Lunar Regolith Base', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/space_lunar_regolith_base.js', importName: 'createLunarRegolithBase' },

  { id: 'space_martian_hydroponic_dome', name: 'Martian Hydroponic Dome', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/space_martian_hydroponic_dome.js', importName: 'createMartianHydroponicDome' },

  { id: 'space_oneill_cylinder', name: 'Oneill Cylinder', icon: '⚛️', category: 'spacecraft_engineering', importPath: './machines/space_oneill_cylinder.js', importName: 'createONeillCylinder' },

  { id: 'stairwell_pressurization_fan', name: 'Pressurization Fan', icon: '⚛️', category: 'civil_engineering', importPath: './machines/stairwell_pressurization_fan.js', importName: 'createStairwellPressurizationFan' },

  { id: 'aerospace_hypersonic_waverider_airframe', name: 'Hypersonic Waverider Airframe', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerospace_hypersonic_waverider_airframe.js', importName: 'createHypersonicWaveriderAirframe' },

  { id: 'aerospace_ramjet_engine_core', name: 'Ramjet Engine Core', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerospace_ramjet_engine_core.js', importName: 'createRamjetEngineCore' },

  { id: 'aerospace_spacecraft_docking_ring', name: 'Spacecraft Docking Ring', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerospace_spacecraft_docking_ring.js', importName: 'createSpacecraftDockingRing' },

  { id: 'aerospace_supersonic_wind_tunnel', name: 'Supersonic Wind Tunnel', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerospace_supersonic_wind_tunnel.js', importName: 'createSupersonicWindTunnel' },

  { id: 'aerospace_thrust_reverser', name: 'Thrust Reverser', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerospace_thrust_reverser.js', importName: 'createThrustReverserMechanism' },

  { id: 'auto_disk_brake_caliper', name: 'Disk Brake Caliper', icon: '⚛️', category: 'automotive_engineering', importPath: './machines/auto_disk_brake_caliper.js', importName: 'createDiskBrakeCaliper' },

  { id: 'auto_double_wishbone', name: 'Double Wishbone', icon: '⚛️', category: 'automotive_engineering', importPath: './machines/auto_double_wishbone.js', importName: 'createDoubleWishbone' },

  { id: 'auto_exhaust_manifold', name: 'Exhaust Manifold', icon: '⚛️', category: 'automotive_engineering', importPath: './machines/auto_exhaust_manifold.js', importName: 'createExhaustManifold' },

  { id: 'auto_mcpherson_strut', name: 'Mcpherson Strut', icon: '⚛️', category: 'automotive_engineering', importPath: './machines/auto_mcpherson_strut.js', importName: 'createMcPhersonStrut' },

  { id: 'auto_turbocharger', name: 'Turbocharger', icon: '⚛️', category: 'automotive_engineering', importPath: './machines/auto_turbocharger.js', importName: 'createTurbocharger' },
  ...
  { id: 'civil_cantilever_bridge', name: 'Cantilever Bridge', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_cantilever_bridge.js', importName: 'createCantileverBridgeSection' },

  { id: 'civil_concrete_pump_boom', name: 'Concrete Pump Boom', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_concrete_pump_boom.js', importName: 'createConcretePumpingTruckBoom' },

  { id: 'civil_excavator_arm', name: 'Excavator Arm', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_excavator_arm.js', importName: 'createExcavatorArm' },

  { id: 'civil_road_grader', name: 'Road Grader', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_road_grader.js', importName: 'createRoadGraderBladeMechanism' },

  { id: 'civil_scaffolding', name: 'Scaffolding', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_scaffolding.js', importName: 'createScaffoldingSystem' },

  { id: 'electrical_commutator_dc_motor', name: 'Commutator Dc Motor', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/electrical_commutator_dc_motor.js', importName: 'createCommutatorDCMotor' },

  { id: 'electrical_stator_winding_machine', name: 'Stator Winding Machine', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/electrical_stator_winding_machine.js', importName: 'createStatorWindingMachine' },

  { id: 'electrical_three_phase_transformer_core', name: 'Three Phase Transformer Core', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/electrical_three_phase_transformer_core.js', importName: 'createThreePhaseTransformerCore' },

  { id: 'electrical_vacuum_circuit_breaker', name: 'Vacuum Circuit Breaker', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/electrical_vacuum_circuit_breaker.js', importName: 'createVacuumCircuitBreaker' },

  { id: 'hardware_core_memory_matrix', name: 'Core Memory Matrix', icon: '⚛️', category: 'computer_engineering', importPath: './machines/hardware_core_memory_matrix.js', importName: 'createCoreMemoryMatrix' },

  { id: 'hardware_cpu_heatsink_fan', name: 'Cpu Heatsink Fan', icon: '⚛️', category: 'computer_engineering', importPath: './machines/hardware_cpu_heatsink_fan.js', importName: 'createCpuHeatsinkFan' },

  { id: 'hardware_hard_disk_drive', name: 'Hard Disk Drive', icon: '⚛️', category: 'computer_engineering', importPath: './machines/hardware_hard_disk_drive.js', importName: 'createHardDiskDrive' },

  { id: 'hardware_mechanical_keyboard_switch', name: 'Mechanical Keyboard Switch', icon: '⚛️', category: 'computer_engineering', importPath: './machines/hardware_mechanical_keyboard_switch.js', importName: 'createMechanicalKeyboardSwitch' },

  { id: 'hardware_optical_disc_drive', name: 'Optical Disc Drive', icon: '⚛️', category: 'computer_engineering', importPath: './machines/hardware_optical_disc_drive.js', importName: 'createOpticalDiscDrive' },
  ...
  { id: 'mechanical_combustion_block', name: 'Combustion Block', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mechanical_combustion_block.js', importName: 'createInternalCombustionBlock' },

  { id: 'mechanical_cvt', name: 'Cvt', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mechanical_cvt.js', importName: 'createCVT' },

  { id: 'mechanical_rack_and_pinion', name: 'Rack And Pinion', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mechanical_rack_and_pinion.js', importName: 'createRackAndPinion' },

  { id: 'mechanical_stirling_engine', name: 'Stirling Engine', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mechanical_stirling_engine.js', importName: 'createStirlingEngine' },

  { id: 'mechanical_wankel_rotary', name: 'Wankel Rotary', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mechanical_wankel_rotary.js', importName: 'createWankelRotaryEngine' },

  { id: 'robotics_agv', name: 'Agv', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/robotics_agv.js', importName: 'createAGV' },

  { id: 'robotics_bipedal', name: 'Bipedal', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/robotics_bipedal.js', importName: 'createBipedalWalkingMechanism' },

  { id: 'robotics_hexapod', name: 'Hexapod', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/robotics_hexapod.js', importName: 'createHexapod' },

  { id: 'robotics_scara_arm', name: 'Scara Arm', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/robotics_scara_arm.js', importName: 'createSCARA' },

  { id: 'robotics_welding_cell', name: 'Welding Cell', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/robotics_welding_cell.js', importName: 'createRoboticWeldingCell' },
  ...
  { id: 'automated_glassblower_carousel', name: 'Glassblower Carousel', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/automated_glassblower_carousel.js', importName: 'createAutomatedGlassblowerCarousel' },
  ...
  { id: 'audio_mixing_console', name: 'Mixing Console', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/audio_mixing_console.js', importName: 'createMixingConsole' },
  ...
  { id: 'dynamic_microphone_capsule', name: 'Microphone Capsule', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/dynamic_microphone_capsule.js', importName: 'createDynamicMicrophone' },
  ...
  { id: 'reel_to_reel_tape_transport', name: 'To Reel Tape Transport', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/reel_to_reel_tape_transport.js', importName: 'createReelToReelTapeTransport' },

  { id: 'ribbon_tweeter_motor', name: 'Tweeter Motor', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/ribbon_tweeter_motor.js', importName: 'createRibbonTweeterMotor' },
  ...
  { id: 'vinyl_cutting_lathe', name: 'Cutting Lathe', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/vinyl_cutting_lathe.js', importName: 'createVinylCuttingLathe' },

  { id: 'aerospace_ion_thruster', name: 'Ion Thruster', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerospace_ion_thruster.js', importName: 'createIonThruster' },

  { id: 'aerospace_rcs_thruster', name: 'Rcs Thruster', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerospace_rcs_thruster.js', importName: 'createRCSThruster' },

  { id: 'aerospace_solar_array', name: 'Solar Array', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerospace_solar_array.js', importName: 'createSolarArray' },

  { id: 'aerospace_turbofan_bypass', name: 'Turbofan Bypass', icon: '⚛️', category: 'aerospace_engineering', importPath: './machines/aerospace_turbofan_bypass.js', importName: 'createTurbofanBypass' },

  { id: 'auto_catalytic_converter', name: 'Catalytic Converter', icon: '⚛️', category: 'automotive_engineering', importPath: './machines/auto_catalytic_converter.js', importName: 'createCatalyticConverter' },

  { id: 'auto_dual_clutch', name: 'Dual Clutch', icon: '⚛️', category: 'automotive_engineering', importPath: './machines/auto_dual_clutch.js', importName: 'createDualClutch' },

  { id: 'auto_limited_slip_differential', name: 'Limited Slip Differential', icon: '⚛️', category: 'automotive_engineering', importPath: './machines/auto_limited_slip_differential.js', importName: 'createLimitedSlipDifferential' },

  { id: 'auto_rack_pinion', name: 'Rack Pinion', icon: '⚛️', category: 'automotive_engineering', importPath: './machines/auto_rack_pinion.js', importName: 'createRackAndPinion' },

  { id: 'auto_vvt_camshaft', name: 'Vvt Camshaft', icon: '⚛️', category: 'automotive_engineering', importPath: './machines/auto_vvt_camshaft.js', importName: 'createVVTCamshaft' },
  ...
  { id: 'civil_asphalt_paver', name: 'Asphalt Paver', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_asphalt_paver.js', importName: 'createAsphaltPaver' },

  { id: 'civil_pile_driving_rig', name: 'Pile Driving Rig', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_pile_driving_rig.js', importName: 'createPileDrivingRig' },

  { id: 'civil_suspension_anchorage', name: 'Suspension Anchorage', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_suspension_anchorage.js', importName: 'createSuspensionAnchorage' },

  { id: 'civil_tower_crane_jib', name: 'Tower Crane Jib', icon: '⚛️', category: 'civil_engineering', importPath: './machines/civil_tower_crane_jib.js', importName: 'createTowerCraneJib' },

  { id: 'electrical_arc_furnace', name: 'Arc Furnace', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/electrical_arc_furnace.js', importName: 'createArcFurnace' },

  { id: 'electrical_insulator_string', name: 'Insulator String', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/electrical_insulator_string.js', importName: 'createHighVoltageInsulator' },

  { id: 'electrical_wind_turbine', name: 'Wind Turbine', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/electrical_wind_turbine.js', importName: 'createWindTurbine' },

  { id: 'hardware_gpu_die', name: 'Gpu Die', icon: '⚛️', category: 'computer_engineering', importPath: './machines/hardware_gpu_die.js', importName: 'createGPUDie' },

  { id: 'hardware_liquid_cooling', name: 'Liquid Cooling', icon: '⚛️', category: 'computer_engineering', importPath: './machines/hardware_liquid_cooling.js', importName: 'createLiquidCoolingRadiator' },

  { id: 'hardware_psu_transformer', name: 'Psu Transformer', icon: '⚛️', category: 'computer_engineering', importPath: './machines/hardware_psu_transformer.js', importName: 'createPSUTransformer' },

  { id: 'hardware_ssd_controller', name: 'Ssd Controller', icon: '⚛️', category: 'computer_engineering', importPath: './machines/hardware_ssd_controller.js', importName: 'createSSDController' },

  { id: 'hardware_vrm_phase', name: 'Vrm Phase', icon: '⚛️', category: 'computer_engineering', importPath: './machines/hardware_vrm_phase.js', importName: 'createVRMPhase' },
  ...
  { id: 'mechanical_planetary_gearbox', name: 'Planetary Gearbox', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mechanical_planetary_gearbox.js', importName: 'createPlanetaryGearbox' },

  { id: 'mechanical_scissor_lift', name: 'Scissor Lift', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mechanical_scissor_lift.js', importName: 'createScissorLift' },

  { id: 'robotics_auv', name: 'Auv', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/robotics_auv.js', importName: 'createAUV' },

  { id: 'robotics_exoskeleton_joint', name: 'Exoskeleton Joint', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/robotics_exoskeleton_joint.js', importName: 'createExoskeletonJoint' },

  { id: 'robotics_gripper_claw', name: 'Gripper Claw', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/robotics_gripper_claw.js', importName: 'createGripperClaw' },

  { id: 'robotics_omni_wheel', name: 'Omni Wheel', icon: '⚛️', category: 'robotics_engineering', importPath: './machines/robotics_omni_wheel.js', importName: 'createOmniWheelBase' },
  ...
  { id: 'audio_speaker_coil', name: 'Speaker Coil', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/audio_speaker_coil.js', importName: 'createSpeakerCoil' },

  { id: 'audio_synth_oscillator', name: 'Synth Oscillator', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/audio_synth_oscillator.js', importName: 'createSynthOscillator' },

  { id: 'audio_turntable_tonearm', name: 'Turntable Tonearm', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/audio_turntable_tonearm.js', importName: 'createTurntableTonearm' },

  { id: 'audio_vacuum_tube', name: 'Vacuum Tube', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/audio_vacuum_tube.js', importName: 'createVacuumTube' },
  ...
  { id: 'acoustical_anc_driver', name: 'Anc Driver', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/acoustical_anc_driver.js', importName: 'createANCHeadphoneDriver' },

  { id: 'acoustical_anechoic_wedge', name: 'Anechoic Wedge', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/acoustical_anechoic_wedge.js', importName: 'createAnechoicWedge' },

  { id: 'acoustical_helmholtz_resonator', name: 'Helmholtz Resonator', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/acoustical_helmholtz_resonator.js', importName: 'createHelmholtzResonator' },

  { id: 'acoustical_parametric_speaker', name: 'Parametric Speaker', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/acoustical_parametric_speaker.js', importName: 'createParametricArraySpeaker' },

  { id: 'acoustical_spl_microphone', name: 'Spl Microphone', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/acoustical_spl_microphone.js', importName: 'createSoundLevelMeterMicrophone' },
  ...
  { id: 'structural_post_tensioned_anchorage', name: 'Post Tensioned Anchorage', icon: '⚛️', category: 'civil_engineering', importPath: './machines/structural_post_tensioned_anchorage.js', importName: 'createPostTensionedAnchorage' },

  { id: 'structural_seismic_base_isolator', name: 'Seismic Base Isolator', icon: '⚛️', category: 'civil_engineering', importPath: './machines/structural_seismic_base_isolator.js', importName: 'createSeismicBaseIsolator' },

  { id: 'structural_space_frame_node', name: 'Space Frame Node', icon: '⚛️', category: 'civil_engineering', importPath: './machines/structural_space_frame_node.js', importName: 'createSpaceFrameNode' },

  { id: 'structural_suspension_cable_clamp', name: 'Suspension Cable Clamp', icon: '⚛️', category: 'civil_engineering', importPath: './machines/structural_suspension_cable_clamp.js', importName: 'createSuspensionCableClamp' },

  { id: 'structural_tuned_mass_damper', name: 'Tuned Mass Damper', icon: '⚛️', category: 'civil_engineering', importPath: './machines/structural_tuned_mass_damper.js', importName: 'createTunedMassDamper' },
  ...
  { id: 'power_high_voltage_circuit_breaker', name: 'High Voltage Circuit Breaker', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/power_high_voltage_circuit_breaker.js', importName: 'createHighVoltageCircuitBreaker' },

  { id: 'power_hydroelectric_pelton_wheel', name: 'Hydroelectric Pelton Wheel', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/power_hydroelectric_pelton_wheel.js', importName: 'createHydroelectricPeltonWheel' },

  { id: 'power_steam_turbine_generator', name: 'Steam Turbine Generator', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/power_steam_turbine_generator.js', importName: 'createSteamTurbineGenerator' },

  { id: 'power_step_up_transformer', name: 'Step Up Transformer', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/power_step_up_transformer.js', importName: 'createStepUpTransformer' },

  { id: 'power_wind_turbine_nacelle', name: 'Wind Turbine Nacelle', icon: '⚛️', category: 'electrical_engineering', importPath: './machines/power_wind_turbine_nacelle.js', importName: 'createWindTurbineNacelle' },
  ...
  { id: 'sound_analog_mixing_console', name: 'Analog Mixing Console', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/sound_analog_mixing_console.js', importName: 'createAnalogMixingConsole' },

  { id: 'sound_audio_limiter_compressor_tube', name: 'Audio Limiter Compressor Tube', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/sound_audio_limiter_compressor_tube.js', importName: 'createAudioLimiterCompressorTube' },

  { id: 'sound_ribbon_microphone_capsule', name: 'Ribbon Microphone Capsule', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/sound_ribbon_microphone_capsule.js', importName: 'createRibbonMicrophoneCapsule' },

  { id: 'sound_spring_reverb_tank', name: 'Spring Reverb Tank', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/sound_spring_reverb_tank.js', importName: 'createSpringReverbTank' },

  { id: 'sound_studio_monitor_crossover', name: 'Studio Monitor Crossover', icon: '⚛️', category: 'acoustics_and_audio', importPath: './machines/sound_studio_monitor_crossover.js', importName: 'createStudioMonitorCrossover' },
  ...
  { id: 'telecom_cell_tower_antenna', name: 'Cell Tower Antenna', icon: '⚛️', category: 'telecommunications', importPath: './machines/telecom_cell_tower_antenna.js', importName: 'createCellTowerAntenna' },

  { id: 'telecom_fiber_transceiver', name: 'Fiber Transceiver', icon: '⚛️', category: 'telecommunications', importPath: './machines/telecom_fiber_transceiver.js', importName: 'createFiberOpticTransceiverModule' },

  { id: 'telecom_parabolic_dish', name: 'Parabolic Dish', icon: '⚛️', category: 'telecommunications', importPath: './machines/telecom_parabolic_dish.js', importName: 'createParabolicMicrowaveDish' },

  { id: 'telecom_satellite_dish', name: 'Satellite Dish', icon: '⚛️', category: 'telecommunications', importPath: './machines/telecom_satellite_dish.js', importName: 'createSatelliteCommunicationDish' },

  { id: 'telecom_undersea_repeater', name: 'Undersea Repeater', icon: '⚛️', category: 'telecommunications', importPath: './machines/telecom_undersea_repeater.js', importName: 'createUnderseaCableRepeater' },



  { id: 'ammonite_shell', name: 'Ammonite Shell', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/ammonite_shell.js', importName: 'createAmmoniteShell' },
  ...
  { id: 'carbon_cycle', name: 'Carbon Cycle', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/carbon_cycle.js', importName: 'createCarbonCycle' },

  { id: 'e_coli_bacterium', name: 'E Coli Bacterium', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/e_coli_bacterium.js', importName: 'createEColiBacterium' },

  { id: 'forest_canopy', name: 'Forest Canopy', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/forest_canopy.js', importName: 'createForestCanopy' },

  { id: 'gas_chromatograph', name: 'Gas Chromatograph', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/gas_chromatograph.js', importName: 'createGasChromatograph' },
  ...
  { id: 'microarray_scanner', name: 'Microarray Scanner', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/microarray_scanner.js', importName: 'createMicroarrayScanner' },
  ...
  { id: 'mitochondria_powerhouse', name: 'Mitochondria Powerhouse', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mitochondria_powerhouse.js', importName: 'createMitochondriaPowerhouse' },
  ...
  { id: 'nitrogen_cycle', name: 'Nitrogen Cycle', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/nitrogen_cycle.js', importName: 'createNitrogenCycle' },
  ...
  { id: 'pcr_thermal_cycler', name: 'Pcr Thermal Cycler', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/pcr_thermal_cycler.js', importName: 'createPCRThermalCycler' },

  { id: 'pterosaur_wing', name: 'Pterosaur Wing', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/pterosaur_wing.js', importName: 'createPterosaurWing' },

  { id: 'ribosome_translation', name: 'Ribosome Translation', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/ribosome_translation.js', importName: 'createRibosomeTranslation' },

  { id: 'synthbio_artificial_cell', name: 'Synthbio Artificial Cell', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/synthbio_artificial_cell.js', importName: 'createArtificialCell' },

  { id: 'synthbio_biosensor_circuit', name: 'Synthbio Biosensor Circuit', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/synthbio_biosensor_circuit.js', importName: 'createBiosensorCircuit' },

  { id: 'synthbio_dna_synthesizer', name: 'Synthbio Dna Synthesizer', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/synthbio_dna_synthesizer.js', importName: 'createDNASynthesizer' },

  { id: 'synthbio_engineered_phage', name: 'Synthbio Engineered Phage', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/synthbio_engineered_phage.js', importName: 'createEngineeredPhage' },

  { id: 'synthbio_synthetic_ribosome', name: 'Synthbio Synthetic Ribosome', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/synthbio_synthetic_ribosome.js', importName: 'createSyntheticRibosome' },

  { id: 'trex_skeleton', name: 'Trex Skeleton', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/trex_skeleton.js', importName: 'createTrexSkeleton' },

  { id: 'triceratops_skull', name: 'Triceratops Skull', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/triceratops_skull.js', importName: 'createTriceratopsSkull' },



  { id: 'environmental_dissolved_air_flotation_unit', name: 'Environmental Dissolved Air Flotation Unit', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/environmental_dissolved_air_flotation_unit.js', importName: 'createDissolvedAirFlotationUnit' },

  { id: 'environmental_electrostatic_precipitator', name: 'Environmental Electrostatic Precipitator', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/environmental_electrostatic_precipitator.js', importName: 'createElectrostaticPrecipitator' },

  { id: 'environmental_membrane_bioreactor_tank', name: 'Environmental Membrane Bioreactor Tank', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/environmental_membrane_bioreactor_tank.js', importName: 'createMembraneBioreactorTank' },

  { id: 'environmental_reverse_osmosis_desalination_skid', name: 'Environmental Reverse Osmosis Desalination Skid', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/environmental_reverse_osmosis_desalination_skid.js', importName: 'createReverseOsmosisDesalinationSkid' },

  { id: 'environmental_sludge_dewatering_centrifuge', name: 'Environmental Sludge Dewatering Centrifuge', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/environmental_sludge_dewatering_centrifuge.js', importName: 'createSludgeDewateringCentrifuge' },

  { id: 'fire_protection_fire_hydrant', name: 'Fire Protection Fire Hydrant', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/fire_protection_fire_hydrant.js', importName: 'createFireHydrant' },

  { id: 'fire_protection_fire_pump_centrifugal', name: 'Fire Protection Fire Pump Centrifugal', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/fire_protection_fire_pump_centrifugal.js', importName: 'createFirePumpCentrifugal' },

  { id: 'fire_protection_foam_proportioner', name: 'Fire Protection Foam Proportioner', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/fire_protection_foam_proportioner.js', importName: 'createFoamProportioner' },

  { id: 'fire_protection_water_motor_gong', name: 'Fire Protection Water Motor Gong', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/fire_protection_water_motor_gong.js', importName: 'createWaterMotorGong' },

  { id: 'hardware_fpga_board', name: 'Hardware Fpga Board', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/hardware_fpga_board.js', importName: 'createFPGABoard' },

  { id: 'hardware_gpu_heatsink', name: 'Hardware Gpu Heatsink', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/hardware_gpu_heatsink.js', importName: 'createGPUHeatsink' },

  { id: 'hardware_nvme_ssd', name: 'Hardware Nvme Ssd', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/hardware_nvme_ssd.js', importName: 'createNVMeSSD' },

  { id: 'hardware_pcie_slot', name: 'Hardware Pcie Slot', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/hardware_pcie_slot.js', importName: 'createPCIeSlot' },

  { id: 'hardware_ram_dimm', name: 'Hardware Ram Dimm', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/hardware_ram_dimm.js', importName: 'createRAMDimm' },

  { id: 'hvac_evaporative_cooling_tower', name: 'Hvac Evaporative Cooling Tower', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/hvac_evaporative_cooling_tower.js', importName: 'createEvaporativeCoolingTower' },

  { id: 'hvac_rooftop_packaged_unit', name: 'Hvac Rooftop Packaged Unit', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/hvac_rooftop_packaged_unit.js', importName: 'createRooftopPackagedUnit' },

  { id: 'hvac_rotary_enthalpy_wheel', name: 'Hvac Rotary Enthalpy Wheel', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/hvac_rotary_enthalpy_wheel.js', importName: 'createRotaryEnthalpyWheel' },

  { id: 'hvac_vrf_outdoor_unit', name: 'Hvac Vrf Outdoor Unit', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/hvac_vrf_outdoor_unit.js', importName: 'createVRFOutdoorUnit' },

  { id: 'hvac_water_cooled_chiller', name: 'Hvac Water Cooled Chiller', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/hvac_water_cooled_chiller.js', importName: 'createWaterCooledChiller' },

  { id: 'manufacturing_aoi_system', name: 'Manufacturing Aoi System', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/manufacturing_aoi_system.js', importName: 'createAOISystem' },

  { id: 'manufacturing_extrusion_die_head', name: 'Manufacturing Extrusion Die Head', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/manufacturing_extrusion_die_head.js', importName: 'createExtrusionDieHead' },

  { id: 'manufacturing_injection_molding_platen', name: 'Manufacturing Injection Molding Platen', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/manufacturing_injection_molding_platen.js', importName: 'createInjectionMoldingPlaten' },

  { id: 'manufacturing_six_axis_welding_robot', name: 'Manufacturing Six Axis Welding Robot', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/manufacturing_six_axis_welding_robot.js', importName: 'createSixAxisWeldingRobot' },

  { id: 'manufacturing_vibratory_bowl_feeder', name: 'Manufacturing Vibratory Bowl Feeder', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/manufacturing_vibratory_bowl_feeder.js', importName: 'createVibratoryBowlFeeder' },
  ...
  { id: 'mechatronics_agv', name: 'Mechatronics Agv', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mechatronics_agv.js', importName: 'createAGV' },

  { id: 'mechatronics_cnc_spindle', name: 'Mechatronics Cnc Spindle', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mechatronics_cnc_spindle.js', importName: 'createCNCMillingSpindle' },

  { id: 'mechatronics_delta_robot', name: 'Mechatronics Delta Robot', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mechatronics_delta_robot.js', importName: 'createDeltaRobot' },

  { id: 'mechatronics_linear_actuator', name: 'Mechatronics Linear Actuator', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mechatronics_linear_actuator.js', importName: 'createLinearActuatorStage' },

  { id: 'mechatronics_scara_robot', name: 'Mechatronics Scara Robot', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mechatronics_scara_robot.js', importName: 'createSCARARobot' },

  { id: 'mining_dragline_bucket', name: 'Mining Dragline Bucket', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mining_dragline_bucket.js', importName: 'createDraglineBucket' },

  { id: 'mining_longwall_shearer', name: 'Mining Longwall Shearer', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/mining_longwall_shearer.js', importName: 'createLongwallShearer' },

  { id: 'nuclear_control_rod_drive_mechanism', name: 'Nuclear Control Rod Drive Mechanism', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/nuclear_control_rod_drive_mechanism.js', importName: 'createControlRodDriveMechanism' },

  { id: 'nuclear_pressurized_water_reactor_core', name: 'Nuclear Pressurized Water Reactor Core', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/nuclear_pressurized_water_reactor_core.js', importName: 'createPressurizedWaterReactorCore' },

  { id: 'nuclear_spent_fuel_cask', name: 'Nuclear Spent Fuel Cask', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/nuclear_spent_fuel_cask.js', importName: 'createSpentFuelCask' },

  { id: 'optical_adaptive_optics_deformable_mirror', name: 'Optical Adaptive Optics Deformable Mirror', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/optical_adaptive_optics_deformable_mirror.js', importName: 'createAdaptiveOpticsDeformableMirror' },

  { id: 'optical_confocal_microscope', name: 'Optical Confocal Microscope', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/optical_confocal_microscope.js', importName: 'createConfocalMicroscope' },

  { id: 'optical_free_space_communicator', name: 'Optical Free Space Communicator', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/optical_free_space_communicator.js', importName: 'createFreeSpaceOpticalCommunicator' },

  { id: 'optical_spectrometer_grating', name: 'Optical Spectrometer Grating', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/optical_spectrometer_grating.js', importName: 'createSpectrometerGrating' },

  { id: 'petroleum_blowout_preventer', name: 'Petroleum Blowout Preventer', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/petroleum_blowout_preventer.js', importName: 'createBlowoutPreventer' },

  { id: 'petroleum_mud_motor', name: 'Petroleum Mud Motor', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/petroleum_mud_motor.js', importName: 'createMudMotor' },

  { id: 'petroleum_progressive_cavity_pump', name: 'Petroleum Progressive Cavity Pump', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/petroleum_progressive_cavity_pump.js', importName: 'createProgressiveCavityPump' },

  { id: 'petroleum_rotary_steerable_system', name: 'Petroleum Rotary Steerable System', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/petroleum_rotary_steerable_system.js', importName: 'createRotarySteerableSystem' },

  { id: 'telecom_baseband_processing_unit', name: 'Telecom Baseband Processing Unit', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/telecom_baseband_processing_unit.js', importName: 'createBasebandProcessingUnit' },

  { id: 'telecom_cell_tower_antenna_array', name: 'Telecom Cell Tower Antenna Array', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/telecom_cell_tower_antenna_array.js', importName: 'createCellTowerAntennaArray' },

  { id: 'telecom_fiber_optic_splicer', name: 'Telecom Fiber Optic Splicer', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/telecom_fiber_optic_splicer.js', importName: 'createFiberOpticSplicer' },

  { id: 'telecom_microwave_parabolic_dish', name: 'Telecom Microwave Parabolic Dish', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/telecom_microwave_parabolic_dish.js', importName: 'createMicrowaveParabolicDish' },

  { id: 'telecom_submarine_cable_repeater', name: 'Telecom Submarine Cable Repeater', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/telecom_submarine_cable_repeater.js', importName: 'createSubmarineCableRepeater' },



  { id: 'acoustic_anechoic_chamber_wedge_array', name: 'Acoustic Anechoic Chamber Wedge Array', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/acoustic_anechoic_chamber_wedge_array.js', importName: 'createAnechoicChamberWedgeArray' },

  { id: 'acoustic_dynamic_microphone_diaphragm', name: 'Acoustic Dynamic Microphone Diaphragm', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/acoustic_dynamic_microphone_diaphragm.js', importName: 'createDynamicMicrophoneDiaphragm' },

  { id: 'acoustic_helmholtz_resonator', name: 'Acoustic Helmholtz Resonator', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/acoustic_helmholtz_resonator.js', importName: 'createHelmholtzResonator' },

  { id: 'acoustic_levitation_array', name: 'Acoustic Levitation Array', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/acoustic_levitation_array.js', importName: 'createAcousticLevitationArray' },

  { id: 'acoustic_parametric_speaker_array', name: 'Acoustic Parametric Speaker Array', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/acoustic_parametric_speaker_array.js', importName: 'createParametricSpeakerArray' },

  { id: 'aerospace_attitude_control_thruster', name: 'Aerospace Attitude Control Thruster', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/aerospace_attitude_control_thruster.js', importName: 'createAttitudeControlThruster' },

  { id: 'aerospace_gyroscope_gimbal_assembly', name: 'Aerospace Gyroscope Gimbal Assembly', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/aerospace_gyroscope_gimbal_assembly.js', importName: 'createGyroscopeGimbalAssembly' },

  { id: 'aerospace_landing_gear_oleo_strut', name: 'Aerospace Landing Gear Oleo Strut', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/aerospace_landing_gear_oleo_strut.js', importName: 'createLandingGearOleoStrut' },

  { id: 'aerospace_turbofan_engine_spool', name: 'Aerospace Turbofan Engine Spool', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/aerospace_turbofan_engine_spool.js', importName: 'createTurbofanEngineSpool' },

  { id: 'aerospace_wind_tunnel_test_section', name: 'Aerospace Wind Tunnel Test Section', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/aerospace_wind_tunnel_test_section.js', importName: 'createWindTunnelTestSection' },

  { id: 'automotive_disc_brake_caliper_assembly', name: 'Automotive Disc Brake Caliper Assembly', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/automotive_disc_brake_caliper_assembly.js', importName: 'createDiscBrakeCaliperAssembly' },

  { id: 'automotive_dual_clutch_transmission', name: 'Automotive Dual Clutch Transmission', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/automotive_dual_clutch_transmission.js', importName: 'createDualClutchTransmission' },

  { id: 'automotive_macpherson_strut_suspension', name: 'Automotive Macpherson Strut Suspension', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/automotive_macpherson_strut_suspension.js', importName: 'createMacPhersonStrutSuspension' },

  { id: 'automotive_rack_and_pinion_steering', name: 'Automotive Rack And Pinion Steering', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/automotive_rack_and_pinion_steering.js', importName: 'createRackAndPinionSteering' },

  { id: 'automotive_turbocharger_impeller', name: 'Automotive Turbocharger Impeller', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/automotive_turbocharger_impeller.js', importName: 'createTurbochargerImpeller' },
  ...
  { id: 'civil_batching_plant', name: 'Civil Batching Plant', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/civil_batching_plant.js', importName: 'createBatchingPlant' },

  { id: 'civil_bridge_pylon', name: 'Civil Bridge Pylon', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/civil_bridge_pylon.js', importName: 'createBridgePylon' },

  { id: 'civil_crawler_crane_boom', name: 'Civil Crawler Crane Boom', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/civil_crawler_crane_boom.js', importName: 'createCrawlerCraneBoom' },

  { id: 'computer_cpu_die_architecture', name: 'Computer Cpu Die Architecture', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/computer_cpu_die_architecture.js', importName: 'createCPUDieArchitecture' },

  { id: 'computer_liquid_cooling_block', name: 'Computer Liquid Cooling Block', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/computer_liquid_cooling_block.js', importName: 'createLiquidCoolingBlock' },

{ id: 'computer_logic_gate_array', name: 'Computer Logic Gate Array', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/computer_logic_gate_array.js', importName: 'createLogicGateArray' },

  { id: 'computer_memory_controller_hub', name: 'Computer Memory Controller Hub', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/computer_memory_controller_hub.js', importName: 'createMemoryControllerHub' },

  { id: 'computer_pcb_routing_traces', name: 'Computer Pcb Routing Traces', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/computer_pcb_routing_traces.js', importName: 'createPCBRoutingTraces' },

  { id: 'electrical_high_voltage_isolator_switch', name: 'Electrical High Voltage Isolator Switch', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/electrical_high_voltage_isolator_switch.js', importName: 'createHighVoltageIsolatorSwitch' },

  { id: 'electrical_squirrel_cage_rotor', name: 'Electrical Squirrel Cage Rotor', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/electrical_squirrel_cage_rotor.js', importName: 'createSquirrelCageRotor' },

  { id: 'electrical_substation_transformer', name: 'Electrical Substation Transformer', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/electrical_substation_transformer.js', importName: 'createSubstationTransformer' },

  { id: 'electrical_three_phase_induction_motor', name: 'Electrical Three Phase Induction Motor', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/electrical_three_phase_induction_motor.js', importName: 'createThreePhaseInductionMotor' },

  { id: 'materials_drop_weight_impact_tester', name: 'Materials Drop Weight Impact Tester', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/materials_drop_weight_impact_tester.js', importName: 'createDropWeightImpactTester' },

  { id: 'materials_extrusion_sintering_furnace', name: 'Materials Extrusion Sintering Furnace', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/materials_extrusion_sintering_furnace.js', importName: 'createExtrusionSinteringFurnace' },

  { id: 'materials_scanning_electron_microscope', name: 'Materials Scanning Electron Microscope', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/materials_scanning_electron_microscope.js', importName: 'createScanningElectronMicroscope' },

  { id: 'robotics_bipedal_walking_mechanism', name: 'Robotics Bipedal Walking Mechanism', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/robotics_bipedal_walking_mechanism.js', importName: 'createBipedalWalkingMechanism' },

  { id: 'robotics_end_effector_gripper', name: 'Robotics End Effector Gripper', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/robotics_end_effector_gripper.js', importName: 'createEndEffectorGripper' },

  { id: 'robotics_harmonic_drive_gear', name: 'Robotics Harmonic Drive Gear', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/robotics_harmonic_drive_gear.js', importName: 'createHarmonicDriveGear' },

  { id: 'robotics_lidar_rotating_scanner', name: 'Robotics Lidar Rotating Scanner', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/robotics_lidar_rotating_scanner.js', importName: 'createLIDARRotatingScanner' },

  { id: 'robotics_tactile_sensor_array', name: 'Robotics Tactile Sensor Array', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/robotics_tactile_sensor_array.js', importName: 'createTactileSensorArray' },

  { id: 'structural_ibeam_bending_rig', name: 'Structural Ibeam Bending Rig', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/structural_ibeam_bending_rig.js', importName: 'createIBeamBendingRig' },

  { id: 'structural_post_tensioning_anchor', name: 'Structural Post Tensioning Anchor', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/structural_post_tensioning_anchor.js', importName: 'createPostTensioningAnchor' },

  { id: 'structural_wind_mass_damper', name: 'Structural Wind Mass Damper', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/structural_wind_mass_damper.js', importName: 'createWindMassDamper' },

  { id: 'transport_articulated_bus_joint', name: 'Transport Articulated Bus Joint', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/transport_articulated_bus_joint.js', importName: 'createArticulatedBusJoint' },

  { id: 'transport_jet_bridge', name: 'Transport Jet Bridge', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/transport_jet_bridge.js', importName: 'createJetBridge' },

  { id: 'transport_maglev_track', name: 'Transport Maglev Track', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/transport_maglev_track.js', importName: 'createMaglevTrainTrackSegment' },

  { id: 'transport_rail_pantograph', name: 'Transport Rail Pantograph', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/transport_rail_pantograph.js', importName: 'createHighSpeedRailPantograph' },

  { id: 'transport_signal_gantry', name: 'Transport Signal Gantry', icon: '⚛️', category: 'mechanical_engineering', importPath: './machines/transport_signal_gantry.js', importName: 'createTrafficSignalGantry' },

  // --- Chemistry Batch 1: Hydrogen (Part 1) ---

  { id: 'hydrogen_atomic_structure', name: 'Atomic Structure', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_atomic_structure.js', importName: 'createHydrogenAtomicStructure' },

  { id: 'hydrogen_bohr_model', name: 'Bohr Model', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_bohr_model.js', importName: 'createHydrogenBohrModel' },

  { id: 'hydrogen_quantum_model', name: 'Quantum Model', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_quantum_model.js', importName: 'createHydrogenQuantumModel' },

  { id: 'hydrogen_electron_cloud', name: 'Electron Cloud', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_electron_cloud.js', importName: 'createHydrogenElectronCloud' },

  { id: 'hydrogen_s_orbital', name: '1s Orbital', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_s_orbital.js', importName: 'createHydrogenSOrbital' },

  { id: 'hydrogen_energy_levels', name: 'Energy Levels', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_energy_levels.js', importName: 'createHydrogenEnergyLevels' },

  { id: 'hydrogen_electron_spin', name: 'Electron Spin', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_electron_spin.js', importName: 'createHydrogenElectronSpin' },

  { id: 'hydrogen_isotopes', name: 'Isotopes', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_isotopes.js', importName: 'createHydrogenIsotopes' },

  { id: 'hydrogen_covalent_bonding', name: 'Covalent Bonding (H2)', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_covalent_bonding.js', importName: 'createHydrogenCovalentBonding' },

  { id: 'hydrogen_van_der_waals', name: 'Van der Waals', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_van_der_waals.js', importName: 'createHydrogenVanDerWaals' },

  { id: 'hydrogen_emission_spectrum', name: 'Emission Spectrum', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_emission_spectrum.js', importName: 'createHydrogenEmissionSpectrum' },

  { id: 'hydrogen_ion_formation', name: 'Ion Formation (H+)', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_ion_formation.js', importName: 'createHydrogenIonFormation' },

,

  // --- Chemistry Batch 2: Hydrogen (Part 2) ---

  { id: 'hydrogen_hydride_ion', name: 'Hydride Ion (H-)', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_hydride_ion.js', importName: 'createHydrogenHydrideIon' },

  { id: 'hydrogen_effective_nuclear_charge', name: 'Effective Nuclear Charge', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_effective_nuclear_charge.js', importName: 'createHydrogenEffectiveNuclearCharge' },

  { id: 'hydrogen_sigma_bond', name: 'Sigma Bond', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_sigma_bond.js', importName: 'createHydrogenSigmaBond' },

  { id: 'hydrogen_hydrogen_bond', name: 'Hydrogen Bonding', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_hydrogen_bond.js', importName: 'createHydrogenHydrogenBond' },

  { id: 'hydrogen_metallic_phase', name: 'Metallic Phase', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_metallic_phase.js', importName: 'createHydrogenMetallicPhase' },

  { id: 'hydrogen_photon_absorption', name: 'Photon Absorption', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_photon_absorption.js', importName: 'createHydrogenPhotonAbsorption' },

  { id: 'hydrogen_ground_state', name: 'Ground State (1s)', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_ground_state.js', importName: 'createHydrogenGroundState' },

  { id: 'hydrogen_excited_state_2p', name: '2p Orbital', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_excited_state_2p.js', importName: 'createHydrogenExcitedState2p' },

  { id: 'hydrogen_excited_state_2s', name: '2s Orbital', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_excited_state_2s.js', importName: 'createHydrogenExcitedState2s' },

  { id: 'hydrogen_excited_state_3d', name: '3d Orbital', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_excited_state_3d.js', importName: 'createHydrogenExcitedState3d' },

  { id: 'hydrogen_fuel_cell_reaction', name: 'Fuel Cell Reaction', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_fuel_cell_reaction.js', importName: 'createHydrogenFuelCellReaction' },

  { id: 'hydrogen_stellar_fusion', name: 'Stellar Fusion', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_stellar_fusion.js', importName: 'createHydrogenStellarFusion' },

  { id: 'hydrogen_liquid_phase', name: 'Liquid Phase', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_liquid_phase.js', importName: 'createHydrogenLiquidPhase' },

,

  // --- Chemistry Batch 3: Helium (Part 1) ---

  { id: 'helium_atomic_structure', name: 'Atomic Structure', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_atomic_structure.js', importName: 'createHeliumAtomicStructure' },

  { id: 'helium_bohr_model', name: 'Bohr Model', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_bohr_model.js', importName: 'createHeliumBohrModel' },

  { id: 'helium_quantum_model', name: 'Quantum Model', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_quantum_model.js', importName: 'createHeliumQuantumModel' },

  { id: 'helium_electron_cloud', name: 'Electron Cloud', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_electron_cloud.js', importName: 'createHeliumElectronCloud' },

  { id: 'helium_1s_orbital', name: '1s Orbital', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_1s_orbital.js', importName: 'createHelium1sOrbital' },

  { id: 'helium_energy_levels', name: 'Energy Levels', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_energy_levels.js', importName: 'createHeliumEnergyLevels' },

  { id: 'helium_electron_spin', name: 'Electron Spin', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_electron_spin.js', importName: 'createHeliumElectronSpin' },

  { id: 'helium_isotopes', name: 'Isotopes', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_isotopes.js', importName: 'createHeliumIsotopes' },

  { id: 'helium_alpha_particle', name: 'Alpha Particle', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_alpha_particle.js', importName: 'createHeliumAlphaParticle' },

  { id: 'helium_ionization', name: 'First Ionization', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_ionization.js', importName: 'createHeliumIonization' },

  { id: 'helium_emission_spectrum', name: 'Emission Spectrum', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_emission_spectrum.js', importName: 'createHeliumEmissionSpectrum' },

  { id: 'helium_superfluid_phase', name: 'Superfluid Phase', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_superfluid_phase.js', importName: 'createHeliumSuperfluidPhase' },

,

  // --- Chemistry Batch 4: Helium (Part 2) ---

  { id: 'helium_second_ionization', name: 'Second Ionization', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_second_ionization.js', importName: 'createHeliumSecondIonization' },

  { id: 'helium_liquid_phase', name: 'Liquid Phase', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_liquid_phase.js', importName: 'createHeliumLiquidPhase' },

  { id: 'helium_mri_cooling', name: 'MRI Cooling', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_mri_cooling.js', importName: 'createHeliumMriCooling' },

  { id: 'helium_solid_phase', name: 'Solid Phase', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_solid_phase.js', importName: 'createHeliumSolidPhase' },

  { id: 'helium_neon_laser', name: 'He-Ne Laser', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_neon_laser.js', importName: 'createHeliumNeonLaser' },

  { id: 'helium_balloon_buoyancy', name: 'Balloon Buoyancy', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_balloon_buoyancy.js', importName: 'createHeliumBalloonBuoyancy' },

  { id: 'helium_heliox_breathing', name: 'Heliox Breathing', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_heliox_breathing.js', importName: 'createHeliumHelioxBreathing' },

  { id: 'helium_fusion_triple_alpha', name: 'Stellar Fusion (Triple-Alpha)', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_fusion_triple_alpha.js', importName: 'createHeliumFusionTripleAlpha' },

  { id: 'helium_dimer', name: 'Helium Dimer (He2)', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_dimer.js', importName: 'createHeliumDimer' },

  { id: 'helium_nmr_he3', name: 'He-3 NMR', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_nmr_he3.js', importName: 'createHeliumNmrHe3' },

  { id: 'helium_carrier_gas', name: 'Carrier Gas (GC)', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_carrier_gas.js', importName: 'createHeliumCarrierGas' },

  { id: 'helium_stellar_nucleosynthesis', name: 'Cosmic Abundance', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_stellar_nucleosynthesis.js', importName: 'createHeliumStellarNucleosynthesis' },

  { id: 'helium_arc_welding', name: 'Arc Welding Shield', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_arc_welding.js', importName: 'createHeliumArcWelding' },

,

  // --- Chemistry Batch 5: Lithium (Part 1) ---

  { id: 'lithium_atomic_structure', name: 'Atomic Structure', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_atomic_structure.js', importName: 'createLithiumAtomicStructure' },

  { id: 'lithium_bohr_model', name: 'Bohr Model', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_bohr_model.js', importName: 'createLithiumBohrModel' },

  { id: 'lithium_quantum_model', name: 'Quantum Model', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_quantum_model.js', importName: 'createLithiumQuantumModel' },

  { id: 'lithium_electron_cloud', name: 'Electron Cloud', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_electron_cloud.js', importName: 'createLithiumElectronCloud' },

  { id: 'lithium_1s_orbital', name: '1s Orbital', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_1s_orbital.js', importName: 'createLithium1sOrbital' },

  { id: 'lithium_2s_orbital', name: '2s Orbital', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_2s_orbital.js', importName: 'createLithium2sOrbital' },

  { id: 'lithium_energy_levels', name: 'Energy Levels', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_energy_levels.js', importName: 'createLithiumEnergyLevels' },

  { id: 'lithium_electron_spin', name: 'Electron Spin', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_electron_spin.js', importName: 'createLithiumElectronSpin' },

  { id: 'lithium_isotopes', name: 'Isotopes (Li-6, Li-7)', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_isotopes.js', importName: 'createLithiumIsotopes' },

  { id: 'lithium_first_ionization', name: 'First Ionization', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_first_ionization.js', importName: 'createLithiumFirstIonization' },

  { id: 'lithium_emission_spectrum', name: 'Emission Spectrum', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_emission_spectrum.js', importName: 'createLithiumEmissionSpectrum' },

  { id: 'lithium_cation', name: 'Lithium Cation (Li+)', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_cation.js', importName: 'createLithiumCation' },

,

  // --- Chemistry Batch 6: Lithium (Part 2) ---

  { id: 'lithium_second_ionization', name: 'Second Ionization', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_second_ionization.js', importName: 'createLithiumSecondIonization' },

  { id: 'lithium_bcc_lattice', name: 'BCC Lattice', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_bcc_lattice.js', importName: 'createLithiumBccLattice' },

  { id: 'lithium_battery_cell', name: 'Lithium-Ion Battery', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_battery_cell.js', importName: 'createLithiumBatteryCell' },

  { id: 'lithium_water_reaction', name: 'Water Reaction', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_water_reaction.js', importName: 'createLithiumWaterReaction' },

  { id: 'lithium_flame_test_macroscopic', name: 'Flame Test (Macroscopic)', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_flame_test_macroscopic.js', importName: 'createLithiumFlameTestMacroscopic' },

  { id: 'lithium_grease', name: 'Lithium Grease', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_grease.js', importName: 'createLithiumGrease' },

  { id: 'lithium_glass', name: 'Lithium Glass', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_glass.js', importName: 'createLithiumGlass' },

  { id: 'lithium_alloy', name: 'Aerospace Alloy', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_alloy.js', importName: 'createLithiumAlloy' },

  { id: 'lithium_treatment', name: 'Psychiatric Treatment', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_treatment.js', importName: 'createLithiumTreatment' },

  { id: 'lithium_tritium_breeding', name: 'Tritium Breeding', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_tritium_breeding.js', importName: 'createLithiumTritiumBreeding' },

  { id: 'lithium_air_battery', name: 'Li-Air Battery', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_air_battery.js', importName: 'createLithiumAirBattery' },

  { id: 'lithium_cobalt_oxide', name: 'LiCoO2 Cathode', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_cobalt_oxide.js', importName: 'createLithiumCobaltOxide' },

  { id: 'lithium_solid_state', name: 'Solid-State Battery', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_solid_state.js', importName: 'createLithiumSolidState' },

,

  // --- Chemistry Batch 7: Hydrogen (Part 3) ---

  { id: 'hydrogen_thomson_model', name: 'Thomson Plum Pudding Model', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_thomson_model.js', importName: 'createHydrogenThomsonModel' },

  { id: 'hydrogen_rutherford_model', name: 'Rutherford Model', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_rutherford_model.js', importName: 'createHydrogenRutherfordModel' },

  { id: 'hydrogen_schrodinger_model', name: 'Schrödinger Wave Model', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_schrodinger_model.js', importName: 'createHydrogenSchrodingerModel' },

  { id: 'hydrogen_electron_density', name: 'Electron Density', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_electron_density.js', importName: 'createHydrogenElectronDensity' },

  { id: 'hydrogen_probability_distribution', name: 'Probability Distribution', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_probability_distribution.js', importName: 'createHydrogenProbabilityDistribution' },

  { id: 'hydrogen_electron_proton_interaction', name: 'Electron-Proton Interaction', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_electron_proton_interaction.js', importName: 'createHydrogenElectronProtonInteraction' },

  { id: 'hydrogen_electron_shells', name: 'Electron Shells (n)', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_electron_shells.js', importName: 'createHydrogenElectronShells' },

  { id: 'hydrogen_subshells', name: 'Subshells (l)', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_subshells.js', importName: 'createHydrogenSubshells' },

  { id: 'hydrogen_nodal_surfaces', name: 'Nodal Surfaces', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_nodal_surfaces.js', importName: 'createHydrogenNodalSurfaces' },

  { id: 'hydrogen_electron_configuration', name: 'Electron Configuration', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_electron_configuration.js', importName: 'createHydrogenElectronConfiguration' },

  { id: 'hydrogen_orbital_filling_sequence', name: 'Orbital Filling', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_orbital_filling_sequence.js', importName: 'createHydrogenOrbitalFillingSequence' },

  { id: 'hydrogen_aufbau_principle', name: 'Aufbau Principle', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_aufbau_principle.js', importName: 'createHydrogenAufbauPrinciple' },

,

  // --- Chemistry Batch 8: Hydrogen (Part 4) ---

  { id: 'hydrogen_effective_nuclear_charge', name: 'Effective Nuclear Charge', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_effective_nuclear_charge.js', importName: 'createHydrogenEffectiveNuclearCharge' },

  { id: 'hydrogen_shielding_effect', name: 'Shielding Effect', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_shielding_effect.js', importName: 'createHydrogenShieldingEffect' },

  { id: 'hydrogen_electron_electron_repulsion', name: 'Electron Repulsion', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_electron_electron_repulsion.js', importName: 'createHydrogenElectronElectronRepulsion' },

  { id: 'hydrogen_pauli_exclusion', name: 'Pauli Exclusion', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_pauli_exclusion.js', importName: 'createHydrogenPauliExclusion' },

  { id: 'hydrogen_hunds_rule', name: 'Hund\'s Rule', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_hunds_rule.js', importName: 'createHydrogenHundsRule' },

  { id: 'hydrogen_ground_state', name: 'Ground State', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_ground_state.js', importName: 'createHydrogenGroundState' },

  { id: 'hydrogen_excited_states', name: 'Excited States', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_excited_states.js', importName: 'createHydrogenExcitedStates' },

  { id: 'hydrogen_photon_absorption', name: 'Photon Absorption', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_photon_absorption.js', importName: 'createHydrogenPhotonAbsorption' },

  { id: 'hydrogen_atomic_radius', name: 'Atomic Radius', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_atomic_radius.js', importName: 'createHydrogenAtomicRadius' },

  { id: 'hydrogen_ionic_radius', name: 'Ionic Radius', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_ionic_radius.js', importName: 'createHydrogenIonicRadius' },

  { id: 'hydrogen_covalent_radius', name: 'Covalent Radius', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_covalent_radius.js', importName: 'createHydrogenCovalentRadius' },

  { id: 'hydrogen_oxidation_reduction', name: 'Oxidation & Reduction', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_oxidation_reduction.js', importName: 'createHydrogenOxidationReduction' },

,

  // --- Chemistry Batch 9: Hydrogen (Part 5) ---

  { id: 'hydrogen_ionic_bonding', name: 'Ionic Bonding', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_ionic_bonding.js', importName: 'createHydrogenIonicBonding' },

  { id: 'hydrogen_coordinate_bonding', name: 'Coordinate Bonding', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_coordinate_bonding.js', importName: 'createHydrogenCoordinateBonding' },

  { id: 'hydrogen_dipole_interactions', name: 'Dipole Interactions', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_dipole_interactions.js', importName: 'createHydrogenDipoleInteractions' },

  { id: 'hydrogen_nuclear_structure', name: 'Nuclear Structure', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_nuclear_structure.js', importName: 'createHydrogenNuclearStructure' },

  { id: 'hydrogen_radioactive_decay', name: 'Radioactive Decay', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_radioactive_decay.js', importName: 'createHydrogenRadioactiveDecay' },

  { id: 'hydrogen_crystal_structure', name: 'Crystal Structure', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_crystal_structure.js', importName: 'createHydrogenCrystalStructure' },

  { id: 'hydrogen_coordination_complexes', name: 'Coordination Complexes', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_coordination_complexes.js', importName: 'createHydrogenCoordinationComplexes' },

  { id: 'hydrogen_catalytic_behavior', name: 'Catalytic Behavior', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_catalytic_behavior.js', importName: 'createHydrogenCatalyticBehavior' },

  { id: 'hydrogen_reaction_mechanisms', name: 'Reaction Mechanisms', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_reaction_mechanisms.js', importName: 'createHydrogenReactionMechanisms' },

  { id: 'hydrogen_biological_importance', name: 'Biological Importance', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_biological_importance.js', importName: 'createHydrogenBiologicalImportance' },

  { id: 'hydrogen_environmental_impact', name: 'Environmental Impact', icon: '⚛️', category: 'hydrogen', importPath: './machines/chemistry/hydrogen_environmental_impact.js', importName: 'createHydrogenEnvironmentalImpact' },

,

  // --- Chemistry Batch 10: Helium (Part 3) ---

  { id: 'helium_thomson_model', name: 'Thomson Model', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_thomson_model.js', importName: 'createHeliumThomsonModel' },

  { id: 'helium_rutherford_model', name: 'Rutherford Model', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_rutherford_model.js', importName: 'createHeliumRutherfordModel' },

  { id: 'helium_schrodinger_model', name: 'Schrödinger Model', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_schrodinger_model.js', importName: 'createHeliumSchrodingerModel' },

  { id: 'helium_electron_density', name: 'Electron Density', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_electron_density.js', importName: 'createHeliumElectronDensity' },

  { id: 'helium_probability_distribution', name: 'Probability Distribution', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_probability_distribution.js', importName: 'createHeliumProbabilityDistribution' },

  { id: 'helium_electron_proton_interaction', name: 'Electron-Proton Force', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_electron_proton_interaction.js', importName: 'createHeliumElectronProtonInteraction' },

  { id: 'helium_electron_shells', name: 'Electron Shells', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_electron_shells.js', importName: 'createHeliumElectronShells' },

  { id: 'helium_subshells', name: 'Subshells', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_subshells.js', importName: 'createHeliumSubshells' },

  { id: 'helium_nodal_surfaces', name: 'Nodal Surfaces', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_nodal_surfaces.js', importName: 'createHeliumNodalSurfaces' },

  { id: 'helium_electron_configuration', name: 'Electron Config', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_electron_configuration.js', importName: 'createHeliumElectronConfiguration' },

  { id: 'helium_orbital_filling_sequence', name: 'Orbital Filling', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_orbital_filling_sequence.js', importName: 'createHeliumOrbitalFillingSequence' },

  { id: 'helium_aufbau_principle', name: 'Aufbau Principle', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_aufbau_principle.js', importName: 'createHeliumAufbauPrinciple' },

,

  // --- Chemistry Batch 11: Helium (Part 4) ---

  { id: 'helium_valence_electrons', name: 'Valence Electrons', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_valence_electrons.js', importName: 'createHeliumValenceElectrons' },

  { id: 'helium_core_electrons', name: 'Core Electrons', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_core_electrons.js', importName: 'createHeliumCoreElectrons' },

  { id: 'helium_effective_nuclear_charge', name: 'Effective Nuclear Charge', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_effective_nuclear_charge.js', importName: 'createHeliumEffectiveNuclearCharge' },

  { id: 'helium_shielding_effect', name: 'Shielding Effect', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_shielding_effect.js', importName: 'createHeliumShieldingEffect' },

  { id: 'helium_atomic_radius', name: 'Atomic Radius', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_atomic_radius.js', importName: 'createHeliumAtomicRadius' },

  { id: 'helium_ionic_radius', name: 'Ionic Radius', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_ionic_radius.js', importName: 'createHeliumIonicRadius' },

  { id: 'helium_covalent_radius', name: 'Covalent Radius', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_covalent_radius.js', importName: 'createHeliumCovalentRadius' },

  { id: 'helium_metallic_bonding', name: 'Metallic Bonding', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_metallic_bonding.js', importName: 'createHeliumMetallicBonding' },

  { id: 'helium_ionic_bonding', name: 'Ionic Bonding', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_ionic_bonding.js', importName: 'createHeliumIonicBonding' },

  { id: 'helium_van_der_waals_interactions', name: 'London Dispersion', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_van_der_waals_interactions.js', importName: 'createHeliumVanDerWaalsInteractions' },

  { id: 'helium_ground_state', name: 'Ground State', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_ground_state.js', importName: 'createHeliumGroundState' },

  { id: 'helium_excited_states', name: 'Excited States', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_excited_states.js', importName: 'createHeliumExcitedStates' },

,

  // --- Chemistry Batch 12: Helium (Part 5 - Final) ---

  { id: 'helium_photon_absorption', name: 'Photon Absorption', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_photon_absorption.js', importName: 'createHeliumPhotonAbsorption' },

  { id: 'helium_photon_emission', name: 'Photon Emission', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_photon_emission.js', importName: 'createHeliumPhotonEmission' },

  { id: 'helium_nuclear_structure', name: 'Alpha Particle', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_nuclear_structure.js', importName: 'createHeliumNuclearStructure' },

  { id: 'helium_radioactive_decay', name: 'Radioactive Decay', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_radioactive_decay.js', importName: 'createHeliumRadioactiveDecay' },

  { id: 'helium_crystal_structure', name: 'Solid Helium', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_crystal_structure.js', importName: 'createHeliumCrystalStructure' },

  { id: 'helium_coordinate_bonding_rejection', name: 'Bonding Rejection', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_coordinate_bonding_rejection.js', importName: 'createHeliumCoordinateBondingRejection' },

  { id: 'helium_dipole_interactions', name: 'Helium Dimer', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_dipole_interactions.js', importName: 'createHeliumDipoleInteractions' },

  { id: 'helium_oxidation_reduction_inertness', name: 'Total Inertness', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_oxidation_reduction_inertness.js', importName: 'createHeliumOxidationReductionInertness' },

  { id: 'helium_catalytic_carrier', name: 'Carrier Gas', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_catalytic_carrier.js', importName: 'createHeliumCatalyticCarrier' },

  { id: 'helium_reaction_mechanisms_collision', name: 'Elastic Collision', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_reaction_mechanisms_collision.js', importName: 'createHeliumReactionMechanismsCollision' },

  { id: 'helium_environmental_escape', name: 'Atmospheric Escape', icon: '⚛️', category: 'helium', importPath: './machines/chemistry/helium_environmental_escape.js', importName: 'createHeliumEnvironmentalEscape' },

,

  // --- Chemistry Batch 13: Lithium (Part 1) ---

  { id: 'lithium_atomic_structure', name: 'Atomic Structure', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_atomic_structure.js', importName: 'createLithiumAtomicStructure' },

  { id: 'lithium_bohr_model', name: 'Bohr Model', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_bohr_model.js', importName: 'createLithiumBohrModel' },

  { id: 'lithium_rutherford_model', name: 'Rutherford Model', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_rutherford_model.js', importName: 'createLithiumRutherfordModel' },

  { id: 'lithium_thomson_model', name: 'Thomson Model', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_thomson_model.js', importName: 'createLithiumThomsonModel' },

  { id: 'lithium_quantum_mechanical_model', name: 'Quantum Model', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_quantum_mechanical_model.js', importName: 'createLithiumQuantumMechanicalModel' },

  { id: 'lithium_schrodinger_model', name: 'Schrödinger Model', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_schrodinger_model.js', importName: 'createLithiumSchrodingerModel' },

  { id: 'lithium_electron_cloud', name: 'Electron Cloud', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_electron_cloud.js', importName: 'createLithiumElectronCloud' },

  { id: 'lithium_electron_density', name: 'Electron Density', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_electron_density.js', importName: 'createLithiumElectronDensity' },

  { id: 'lithium_probability_density', name: 'Probability Density', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_probability_density.js', importName: 'createLithiumProbabilityDensity' },

  { id: 'lithium_electron_proton_interaction', name: 'Proton Attraction', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_electron_proton_interaction.js', importName: 'createLithiumElectronProtonInteraction' },

  { id: 'lithium_electron_electron_repulsion', name: 'Electron Repulsion', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_electron_electron_repulsion.js', importName: 'createLithiumElectronElectronRepulsion' },

  { id: 'lithium_shielding_effect', name: 'Shielding Effect', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_shielding_effect.js', importName: 'createLithiumShieldingEffect' },

  { id: 'lithium_effective_nuclear_charge', name: 'Effective Nuclear Charge', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_effective_nuclear_charge.js', importName: 'createLithiumEffectiveNuclearCharge' },

,

  // --- Chemistry Batch 14: Lithium (Part 2) ---

  { id: 'lithium_electron_shells', name: 'Electron Shells', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_electron_shells.js', importName: 'createLithiumElectronShells' },

  { id: 'lithium_energy_levels', name: 'Energy Levels', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_energy_levels.js', importName: 'createLithiumEnergyLevels' },

  { id: 'lithium_subshells', name: 'Subshells', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_subshells.js', importName: 'createLithiumSubshells' },

  { id: 'lithium_s_orbitals', name: 's Orbitals', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_s_orbitals.js', importName: 'createLithiumSOrbitals' },

  { id: 'lithium_p_orbitals', name: 'p Orbitals', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_p_orbitals.js', importName: 'createLithiumPOrbitals' },

  { id: 'lithium_orbital_overlap', name: 'Orbital Overlap', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_orbital_overlap.js', importName: 'createLithiumOrbitalOverlap' },

  { id: 'lithium_orbital_hybridization', name: 'Hybridization', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_orbital_hybridization.js', importName: 'createLithiumOrbitalHybridization' },

  { id: 'lithium_electron_spin', name: 'Electron Spin', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_electron_spin.js', importName: 'createLithiumElectronSpin' },

  { id: 'lithium_pauli_exclusion_principle', name: 'Pauli Exclusion', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_pauli_exclusion_principle.js', importName: 'createLithiumPauliExclusionPrinciple' },

  { id: 'lithium_hunds_rule', name: 'Hund\'s Rule', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_hunds_rule.js', importName: 'createLithiumHundsRule' },

  { id: 'lithium_aufbau_principle', name: 'Aufbau Principle', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_aufbau_principle.js', importName: 'createLithiumAufbauPrinciple' },

  { id: 'lithium_orbital_filling_sequence', name: 'Orbital Filling', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_orbital_filling_sequence.js', importName: 'createLithiumOrbitalFillingSequence' },

,

  // --- Chemistry Batch 15: Lithium (Part 3) ---

  { id: 'lithium_valence_electrons', name: 'Valence Electrons', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_valence_electrons.js', importName: 'createLithiumValenceElectrons' },

  { id: 'lithium_core_electrons', name: 'Core Electrons', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_core_electrons.js', importName: 'createLithiumCoreElectrons' },

  { id: 'lithium_atomic_radius', name: 'Atomic Radius', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_atomic_radius.js', importName: 'createLithiumAtomicRadius' },

  { id: 'lithium_ionic_radius', name: 'Ionic Radius', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_ionic_radius.js', importName: 'createLithiumIonicRadius' },

  { id: 'lithium_covalent_radius', name: 'Covalent Radius', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_covalent_radius.js', importName: 'createLithiumCovalentRadius' },

  { id: 'lithium_metallic_bonding', name: 'Metallic Bonding', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_metallic_bonding.js', importName: 'createLithiumMetallicBonding' },

  { id: 'lithium_ionic_bonding', name: 'Ionic Bonding', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_ionic_bonding.js', importName: 'createLithiumIonicBonding' },

  { id: 'lithium_covalent_bonding', name: 'Covalent Bonding', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_covalent_bonding.js', importName: 'createLithiumCovalentBonding' },

  { id: 'lithium_coordinate_bonding', name: 'Coordinate Bonding', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_coordinate_bonding.js', importName: 'createLithiumCoordinateBonding' },

  { id: 'lithium_hydrogen_bonding', name: 'Hydrogen Bonding', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_hydrogen_bonding.js', importName: 'createLithiumHydrogenBonding' },

  { id: 'lithium_van_der_waals_interactions', name: 'Van der Waals', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_van_der_waals_interactions.js', importName: 'createLithiumVanDerWaals' },

  { id: 'lithium_dipole_interactions', name: 'Dipole Interactions', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_dipole_interactions.js', importName: 'createLithiumDipoleInteractions' },

  { id: 'lithium_ion_formation', name: 'Ion Formation', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_ion_formation.js', importName: 'createLithiumIonFormation' },

,

  // --- Chemistry Batch 16: Lithium (Part 4) ---

  { id: 'lithium_electron_transitions', name: 'Electron Transitions', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_electron_transitions.js', importName: 'createLithiumElectronTransitions' },

  { id: 'lithium_excited_states', name: 'Excited States', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_excited_states.js', importName: 'createLithiumExcitedStates' },

  { id: 'lithium_ground_state', name: 'Ground State', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_ground_state.js', importName: 'createLithiumGroundState' },

  { id: 'lithium_photon_absorption', name: 'Photon Absorption', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_photon_absorption.js', importName: 'createLithiumPhotonAbsorption' },

  { id: 'lithium_photon_emission', name: 'Photon Emission', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_photon_emission.js', importName: 'createLithiumPhotonEmission' },

  { id: 'lithium_flame_test', name: 'Flame Test', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_flame_test.js', importName: 'createLithiumFlameTest' },

  { id: 'lithium_isotopes', name: 'Isotopes', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_isotopes.js', importName: 'createLithiumIsotopes' },

  { id: 'lithium_nuclear_structure', name: 'Nuclear Structure', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_nuclear_structure.js', importName: 'createLithiumNuclearStructure' },

  { id: 'lithium_alpha_particle_bombardment', name: 'Alpha Bombardment', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_alpha_particle_bombardment.js', importName: 'createLithiumAlphaBombardment' },

  { id: 'lithium_half_life', name: 'Half Life', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_half_life.js', importName: 'createLithiumHalfLife' },

,

  // --- Chemistry Batch 17: Lithium (Part 5) ---

  { id: 'lithium_oxidation_state', name: 'Oxidation State', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_oxidation_state.js', importName: 'createLithiumOxidationState' },

  { id: 'lithium_electronegativity', name: 'Electronegativity', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_electronegativity.js', importName: 'createLithiumElectronegativity' },

  { id: 'lithium_ionization_energy', name: 'Ionization Energy', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_ionization_energy.js', importName: 'createLithiumIonizationEnergy' },

  { id: 'lithium_electron_affinity', name: 'Electron Affinity', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_electron_affinity.js', importName: 'createLithiumElectronAffinity' },

  { id: 'lithium_alkali_metal_group', name: 'Alkali Group', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_alkali_metal_group.js', importName: 'createLithiumAlkaliMetalGroup' },

  { id: 'lithium_reactivity_with_water', name: 'Water Reactivity', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_reactivity_with_water.js', importName: 'createLithiumWaterReactivity' },

  { id: 'lithium_battery_anode', name: 'Battery Anode', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_battery_anode.js', importName: 'createLithiumBatteryAnode' },

  { id: 'lithium_ion_battery_intercalation', name: 'Intercalation', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_ion_battery_intercalation.js', importName: 'createLithiumIntercalation' },

  { id: 'lithium_crystal_structure', name: 'Crystal Structure', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_crystal_structure.js', importName: 'createLithiumCrystalStructure' },

  { id: 'lithium_density', name: 'Density', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_density.js', importName: 'createLithiumDensity' },

  { id: 'lithium_flammability', name: 'Flammability', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_flammability.js', importName: 'createLithiumFlammability' },

  { id: 'lithium_medical_use', name: 'Medical Use', icon: '⚛️', category: 'lithium', importPath: './machines/chemistry/lithium_medical_use.js', importName: 'createLithiumMedicalUse' },

,

  // --- Chemistry Batch 18: Beryllium (Part 1) ---

  { id: 'beryllium_atomic_structure', name: 'Atomic Structure', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_atomic_structure.js', importName: 'createBerylliumAtomicStructure' },

  { id: 'beryllium_bohr_model', name: 'Bohr Model', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_bohr_model.js', importName: 'createBerylliumBohrModel' },

  { id: 'beryllium_rutherford_model', name: 'Rutherford Model', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_rutherford_model.js', importName: 'createBerylliumRutherfordModel' },

  { id: 'beryllium_thomson_model', name: 'Thomson Model', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_thomson_model.js', importName: 'createBerylliumThomsonModel' },

  { id: 'beryllium_quantum_mechanical_model', name: 'Quantum Model', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_quantum_mechanical_model.js', importName: 'createBerylliumQuantumMechanicalModel' },

  { id: 'beryllium_schrodinger_model', name: 'Schrödinger Model', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_schrodinger_model.js', importName: 'createBerylliumSchrodingerModel' },

  { id: 'beryllium_electron_cloud', name: 'Electron Cloud', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_electron_cloud.js', importName: 'createBerylliumElectronCloud' },

  { id: 'beryllium_electron_density', name: 'Electron Density', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_electron_density.js', importName: 'createBerylliumElectronDensity' },

  { id: 'beryllium_probability_density', name: 'Probability Density', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_probability_density.js', importName: 'createBerylliumProbabilityDensity' },

  { id: 'beryllium_electron_proton_interaction', name: 'Proton Interaction', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_electron_proton_interaction.js', importName: 'createBerylliumElectronProtonInteraction' },

  { id: 'beryllium_electron_electron_repulsion', name: 'Electron Repulsion', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_electron_electron_repulsion.js', importName: 'createBerylliumElectronElectronRepulsion' },

  { id: 'beryllium_shielding_effect', name: 'Shielding Effect', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_shielding_effect.js', importName: 'createBerylliumShieldingEffect' },

,

  // --- Chemistry Batch 19: Beryllium (Part 2) ---

  { id: 'beryllium_effective_nuclear_charge', name: 'Zeff (Effective Pull)', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_effective_nuclear_charge.js', importName: 'createBerylliumEffectiveNuclearCharge' },

  { id: 'beryllium_nuclear_attraction', name: 'Nuclear Attraction', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_nuclear_attraction.js', importName: 'createBerylliumNuclearAttraction' },

  { id: 'beryllium_electron_shells', name: 'Electron Shells', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_electron_shells.js', importName: 'createBerylliumElectronShells' },

  { id: 'beryllium_energy_levels', name: 'Energy Levels', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_energy_levels.js', importName: 'createBerylliumEnergyLevels' },

  { id: 'beryllium_subshells', name: 'Subshells', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_subshells.js', importName: 'createBerylliumSubshells' },

  { id: 'beryllium_s_orbitals', name: 'S Orbitals', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_s_orbitals.js', importName: 'createBerylliumSOrbitals' },

  { id: 'beryllium_p_orbitals', name: 'P Orbitals', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_p_orbitals.js', importName: 'createBerylliumPOrbitals' },

  { id: 'beryllium_d_orbitals', name: 'D Orbitals', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_d_orbitals.js', importName: 'createBerylliumDOrbitals' },

  { id: 'beryllium_f_orbitals', name: 'F Orbitals', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_f_orbitals.js', importName: 'createBerylliumFOrbitals' },

  { id: 'beryllium_orbital_overlap', name: 'Orbital Overlap', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_orbital_overlap.js', importName: 'createBerylliumOrbitalOverlap' },

  { id: 'beryllium_orbital_hybridization', name: 'Hybridization (sp)', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_orbital_hybridization.js', importName: 'createBerylliumHybridization' },

  { id: 'beryllium_electron_spin', name: 'Electron Spin', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_electron_spin.js', importName: 'createBerylliumElectronSpin' },

  { id: 'beryllium_pauli_exclusion_principle', name: 'Pauli Exclusion', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_pauli_exclusion_principle.js', importName: 'createBerylliumPauliExclusion' },

,

  // --- Chemistry Batch 20: Beryllium (Part 3) ---

  { id: 'beryllium_hunds_rule', name: 'Hund\'s Rule', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_hunds_rule.js', importName: 'createBerylliumHundsRule' },

  { id: 'beryllium_aufbau_principle', name: 'Aufbau Principle', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_aufbau_principle.js', importName: 'createBerylliumAufbauPrinciple' },

  { id: 'beryllium_orbital_filling_sequence', name: 'Orbital Filling (Madelung)', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_orbital_filling_sequence.js', importName: 'createBerylliumOrbitalFillingSequence' },

  { id: 'beryllium_valence_electrons', name: 'Valence Electrons', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_valence_electrons.js', importName: 'createBerylliumValenceElectrons' },

  { id: 'beryllium_core_electrons', name: 'Core Electrons', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_core_electrons.js', importName: 'createBerylliumCoreElectrons' },

  { id: 'beryllium_atomic_radius', name: 'Atomic Radius', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_atomic_radius.js', importName: 'createBerylliumAtomicRadius' },

  { id: 'beryllium_ionic_radius', name: 'Ionic Radius (Be2+)', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_ionic_radius.js', importName: 'createBerylliumIonicRadius' },

  { id: 'beryllium_covalent_radius', name: 'Covalent Radius', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_covalent_radius.js', importName: 'createBerylliumCovalentRadius' },

  { id: 'beryllium_metallic_bonding', name: 'Metallic Bonding', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_metallic_bonding.js', importName: 'createBerylliumMetallicBonding' },

  { id: 'beryllium_ionic_bonding', name: 'Ionic Bonding', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_ionic_bonding.js', importName: 'createBerylliumIonicBonding' },

  { id: 'beryllium_covalent_bonding', name: 'Covalent Bonding', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_covalent_bonding.js', importName: 'createBerylliumCovalentBonding' },

  { id: 'beryllium_coordinate_bonding', name: 'Coordinate Bonding', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_coordinate_bonding.js', importName: 'createBerylliumCoordinateBonding' },

  { id: 'beryllium_hydrogen_bonding', name: 'Hydrogen Bonding', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_hydrogen_bonding.js', importName: 'createBerylliumHydrogenBonding' },

,

  // --- Chemistry Batch 21: Beryllium (Part 4) ---

  { id: 'beryllium_solid_state', name: 'Solid State (HCP)', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_solid_state.js', importName: 'createBerylliumSolidState' },

  { id: 'beryllium_liquid_state', name: 'Liquid State', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_liquid_state.js', importName: 'createBerylliumLiquidState' },

  { id: 'beryllium_gaseous_state', name: 'Gaseous State', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_gaseous_state.js', importName: 'createBerylliumGaseousState' },

  { id: 'beryllium_plasma_state', name: 'Plasma State', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_plasma_state.js', importName: 'createBerylliumPlasmaState' },

  { id: 'beryllium_isotope_be7', name: 'Isotope Be-7', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_isotope_be7.js', importName: 'createBeryllium7' },

  { id: 'beryllium_isotope_be9', name: 'Isotope Be-9 (Stable)', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_isotope_be9.js', importName: 'createBeryllium9' },

  { id: 'beryllium_isotope_be10', name: 'Isotope Be-10', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_isotope_be10.js', importName: 'createBeryllium10' },

  { id: 'beryllium_radioactive_decay', name: 'Radioactive Decay', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_radioactive_decay.js', importName: 'createBerylliumDecay' },

  { id: 'beryllium_nuclear_fusion', name: 'Nuclear Fusion', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_nuclear_fusion.js', importName: 'createBerylliumFusion' },

  { id: 'beryllium_emission_spectrum', name: 'Emission Spectrum', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_emission_spectrum.js', importName: 'createBerylliumEmissionSpectrum' },

  { id: 'beryllium_absorption_spectrum', name: 'Absorption Spectrum', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_absorption_spectrum.js', importName: 'createBerylliumAbsorptionSpectrum' },

  { id: 'beryllium_photoelectric_effect', name: 'Photoelectric Effect', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_photoelectric_effect.js', importName: 'createBerylliumPhotoelectricEffect' },

,

  // --- Chemistry Batch 22: Beryllium (Part 5 - Final) ---

  { id: 'beryllium_absolute_zero', name: 'Absolute Zero (0K)', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_absolute_zero.js', importName: 'createBerylliumAbsoluteZero' },

  { id: 'beryllium_black_hole_spaghettification', name: 'Black Hole Tidal Force', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_black_hole_spaghettification.js', importName: 'createBerylliumSpaghettification' },

  { id: 'beryllium_quantum_entanglement', name: 'Quantum Entanglement', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_quantum_entanglement.js', importName: 'createBerylliumEntanglement' },

  { id: 'beryllium_quarks_protons', name: 'Proton Quarks', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_quarks_protons.js', importName: 'createBerylliumQuarksProton' },

  { id: 'beryllium_quarks_neutrons', name: 'Neutron Quarks', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_quarks_neutrons.js', importName: 'createBerylliumQuarksNeutron' },

  { id: 'beryllium_gluons', name: 'Gluons (Strong Force)', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_gluons.js', importName: 'createBerylliumGluons' },

  { id: 'beryllium_antimatter', name: 'Anti-Beryllium', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_antimatter.js', importName: 'createBerylliumAntimatter' },

  { id: 'beryllium_higgs_field', name: 'The Higgs Field', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_higgs_field.js', importName: 'createBerylliumHiggsField' },

  { id: 'beryllium_neutron_star_crust', name: 'Neutron Star Crust', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_neutron_star_crust.js', importName: 'createBerylliumNeutronStar' },

  { id: 'beryllium_james_webb_mirror', name: 'James Webb Mirror', icon: '⚛️', category: 'beryllium', importPath: './machines/chemistry/beryllium_james_webb_mirror.js', importName: 'createBerylliumJamesWebb' },

  // --- Chemistry Batch 23: Boron (Part 1 - Atomic Structure) ---

  { id: 'boron_atom_basic', name: 'Boron Atom (Base)', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_atom_basic.js', importName: 'createBoronAtomBasic' },

  { id: 'boron_protons', name: 'The 5 Protons', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_protons.js', importName: 'createBoronProtons' },

  { id: 'boron_neutrons', name: 'The 6 Neutrons', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_neutrons.js', importName: 'createBoronNeutrons' },

  { id: 'boron_electrons', name: 'The 5 Electrons', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_electrons.js', importName: 'createBoronElectrons' },

  { id: 'boron_nucleus', name: 'The Nucleus', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_nucleus.js', importName: 'createBoronNucleus' },

  { id: 'boron_electron_cloud', name: 'Quantum Cloud', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_electron_cloud.js', importName: 'createBoronElectronCloud' },

  { id: 'boron_bohr_model', name: 'Bohr Model (1913)', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_bohr_model.js', importName: 'createBoronBohr' },

  { id: 'boron_rutherford_model', name: 'Rutherford (1911)', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_rutherford_model.js', importName: 'createBoronRutherford' },

  { id: 'boron_thomson_model', name: 'Plum Pudding (1904)', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_thomson_model.js', importName: 'createBoronThomson' },

  { id: 'boron_schrodinger_model', name: 'Schrödinger (1926)', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_schrodinger_model.js', importName: 'createBoronSchrodinger' },

  { id: 'boron_probability_density', name: 'Probability Density', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_probability_density.js', importName: 'createBoronProbabilityDensity' },

  { id: 'boron_electron_repulsion', name: 'Electron Repulsion', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_electron_repulsion.js', importName: 'createBoronElectronRepulsion' },

  // --- Chemistry Batch 24: Boron (Part 2 - Periodic Trends & Rules) ---

  { id: 'boron_effective_nuclear_charge', name: 'Effective Nuclear Charge', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_effective_nuclear_charge.js', importName: 'createBoronEffectiveNuclearCharge' },

  { id: 'boron_electron_shielding', name: 'Electron Shielding', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_electron_shielding.js', importName: 'createBoronShielding' },

  { id: 'boron_ionization_energy', name: 'Ionization Energy', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_ionization_energy.js', importName: 'createBoronIonizationEnergy' },

  { id: 'boron_atomic_radius', name: 'Atomic Radius', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_atomic_radius.js', importName: 'createBoronAtomicRadius' },

  { id: 'boron_ionic_radius', name: 'Ionic Radius (B3+)', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_ionic_radius.js', importName: 'createBoronIonicRadius' },

  { id: 'boron_covalent_radius', name: 'Covalent Radius', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_covalent_radius.js', importName: 'createBoronCovalentRadius' },

  { id: 'boron_electron_affinity', name: 'Electron Affinity', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_electron_affinity.js', importName: 'createBoronElectronAffinity' },

  { id: 'boron_electronegativity', name: 'Electronegativity', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_electronegativity.js', importName: 'createBoronElectronegativity' },

  { id: 'boron_metalloid_properties', name: 'Metalloid (Semiconductor)', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_metalloid_properties.js', importName: 'createBoronMetalloid' },

  { id: 'boron_electron_configuration', name: 'Configuration (1s2 2s2 2p1)', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_electron_configuration.js', importName: 'createBoronConfiguration' },

  { id: 'boron_aufbau_principle', name: 'Aufbau Principle', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_aufbau_principle.js', importName: 'createBoronAufbau' },

  { id: 'boron_hunds_rule', name: 'Hund\'s Rule', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_hunds_rule.js', importName: 'createBoronHundsRule' },

  { id: 'boron_pauli_exclusion', name: 'Pauli Exclusion Principle', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_pauli_exclusion.js', importName: 'createBoronPauliExclusion' },

  // --- Chemistry Batch 25: Boron (Part 3 - Advanced Bonding & Allotropes) ---

  { id: 'boron_icosahedron', name: 'The B12 Icosahedron', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_icosahedron.js', importName: 'createBoronIcosahedron' },

  { id: 'boron_covalent_network', name: 'Macroscopic Network Solid', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_covalent_network.js', importName: 'createBoronCovalentNetwork' },

  { id: 'boron_three_center_two_electron_bond', name: 'Banana Bond (B2H6)', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_three_center_two_electron_bond.js', importName: 'createBoronBananaBond' },

  { id: 'boron_trifluoride_molecule', name: 'Trigonal Planar (BF3)', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_trifluoride_molecule.js', importName: 'createBoronTrifluoride' },

  { id: 'boron_nitride_nanotube', name: 'Boron Nitride Nanotube', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_nitride_nanotube.js', importName: 'createBoronNitrideNanotube' },

  // --- Chemistry Batch 26: Boron (Part 4 - Ceramics & Spectrums) ---

  { id: 'boron_carbide', name: 'Boron Carbide (B4C)', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_carbide.js', importName: 'createBoronCarbide' },

  { id: 'boron_borax', name: 'Borax Anion', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_borax.js', importName: 'createBoronBorax' },

  { id: 'boron_flame_test', name: 'Flame Test (518nm)', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_flame_test.js', importName: 'createBoronFlameTest' },

  // --- Chemistry Batch 27: Boron (Part 5 - Isotopes & Acids) ---

  { id: 'boron_boric_acid', name: 'Boric Acid (H3BO3)', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_boric_acid.js', importName: 'createBoronBoricAcid' },

  { id: 'boron_isotope_10', name: 'Isotope: Boron-10', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_isotope_10.js', importName: 'createBoron10' },

  { id: 'boron_isotope_11', name: 'Isotope: Boron-11', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_isotope_11.js', importName: 'createBoron11' },

  { id: 'boron_neodymium_magnet', name: 'Neodymium Magnet', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_neodymium_magnet.js', importName: 'createBoronNeodymiumMagnet' },

  { id: 'boron_boron_nitride_nanotube', name: 'BN Nanotube', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_boron_nitride_nanotube.js', importName: 'createBNNanotube' },

  // --- Chemistry Batch 29: Boron (Part 7 - Glasses & Ceramics) ---

  { id: 'boron_sodium_borohydride', name: 'Sodium Borohydride', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_sodium_borohydride.js', importName: 'createBoronNaBH4' },

  { id: 'boron_boron_phosphide', name: 'Boron Phosphide (BP)', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_boron_phosphide.js', importName: 'createBoronPhosphide' },

  { id: 'boron_borosilicate_glass', name: 'Borosilicate Glass (Pyrex)', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_borosilicate_glass.js', importName: 'createBorosilicateGlass' },

  // --- Chemistry Batch 30: Boron (Part 8 - Organic Reactions & Industrial Materials) ---

  { id: 'boron_dative_bond', name: 'The Dative Bond (BF3+NH3)', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_dative_bond.js', importName: 'createBoronDativeBond' },

  { id: 'boron_suzuki_coupling', name: 'Suzuki Cross-Coupling', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_suzuki_coupling.js', importName: 'createBoronSuzukiCoupling' },

  { id: 'boron_magnesium_diboride', name: 'MgB2 Superconductor', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_magnesium_diboride.js', importName: 'createMgB2' },

  { id: 'boron_bpsg_glass', name: 'BPSG Microchip Glass', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_bpsg_glass.js', importName: 'createBPSG' },

  { id: 'boron_neutron_shielding', name: 'Nuclear Shielding', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_neutron_shielding.js', importName: 'createBoronShielding' },

  // --- Chemistry Batch 31: Boron (Part 9 - Extreme Compounds) ---

  { id: 'boron_sodium_perborate', name: 'Sodium Perborate Bleach', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_sodium_perborate.js', importName: 'createSodiumPerborate' },

  { id: 'boron_boron_suboxide', name: 'Boron Suboxide (B6O)', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_boron_suboxide.js', importName: 'createBoronSuboxide' },

  { id: 'boron_boroxine', name: 'Boroxine (B3O3H3)', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_boroxine.js', importName: 'createBoroxine' },

  { id: 'boron_carborane', name: 'Carborane Superacid', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_carborane.js', importName: 'createCarboraneSuperacid' },

  { id: 'boron_hydroboration_oxidation', name: 'Hydroboration Rxn', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_hydroboration_oxidation.js', importName: 'createHydroboration' },

  // --- Chemistry Batch 32: Boron (Part 10 - Tech & Medicine) ---

  { id: 'boron_neodymium_magnet_domains', name: 'Magnet Domains', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_neodymium_magnet_domains.js', importName: 'createMagneticDomains' },

  { id: 'boron_bpsg_glass_etching', name: 'BPSG Wet Etching', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_bpsg_glass_etching.js', importName: 'createBPSGEtching' },

  { id: 'boron_neutron_capture_therapy', name: 'Cancer Therapy (BNCT)', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_neutron_capture_therapy.js', importName: 'createBNCT' },

  { id: 'boron_boron_nitride_lubricant', name: 'h-BN Dry Lubricant', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_boron_nitride_lubricant.js', importName: 'createBNLubricant' },

  { id: 'boron_doping_silicon', name: 'P-Type Semiconductors', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_doping_silicon.js', importName: 'createPTypeDoping' },

  // --- Chemistry Batch 33: Boron Finale & Lithium Remasters ---

  { id: 'boron_flame_test', name: 'Boron Flame Test', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_flame_test.js', importName: 'createBoronFlameTest' },

  { id: 'boron_ferroboron', name: 'Ferroboron Alloy', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_ferroboron.js', importName: 'createFerroboron' },

  { id: 'boron_borophene', name: 'Borophene (2D Sheet)', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_borophene.js', importName: 'createBorophene' },
  { id: 'boron_absorption_spectrum', name: 'Absorption Spectrum', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_absorption_spectrum.js', importName: 'createBoronAbsorptionSpectrum' },
  { id: 'boron_allotropes', name: 'Allotropes', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_allotropes.js', importName: 'createBoronAllotropes' },
  { id: 'boron_biological_role', name: 'Biological Role', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_biological_role.js', importName: 'createBoronBiologicalRole' },
  { id: 'boron_boiling_point', name: 'Boiling Point', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_boiling_point.js', importName: 'createBoronBoilingPoint' },
  { id: 'boron_bulk_modulus', name: 'Bulk Modulus', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_bulk_modulus.js', importName: 'createBoronBulkModulus' },
  { id: 'boron_color', name: 'Color', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_color.js', importName: 'createBoronColor' },
  { id: 'boron_cosmic_abundance', name: 'Cosmic Abundance', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_cosmic_abundance.js', importName: 'createBoronCosmicAbundance' },
  { id: 'boron_crystal_structure', name: 'Crystal Structure', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_crystal_structure.js', importName: 'createBoronCrystalStructure' },
  { id: 'boron_dalton_model', name: 'Dalton Model', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_dalton_model.js', importName: 'createBoronDalton' },
  { id: 'boron_decay_mode', name: 'Decay Mode', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_decay_mode.js', importName: 'createBoronDecayMode' },
  { id: 'boron_density', name: 'Density', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_density.js', importName: 'createBoronDensity' },
  { id: 'boron_discoverer', name: 'Discoverer', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_discoverer.js', importName: 'createBoronDiscoverer' },
  { id: 'boron_earth_crust_abundance', name: 'Earth Crust Abundance', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_earth_crust_abundance.js', importName: 'createBoronEarthCrustAbundance' },
  { id: 'boron_electrical_conductivity', name: 'Electrical Conductivity', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_electrical_conductivity.js', importName: 'createBoronElectricalConductivity' },
  { id: 'boron_emission_spectrum', name: 'Emission Spectrum', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_emission_spectrum.js', importName: 'createBoronEmissionSpectrum' },
  { id: 'boron_enthalpy_of_fusion', name: 'Enthalpy Of Fusion', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_enthalpy_of_fusion.js', importName: 'createBoronEnthalpyOfFusion' },
  { id: 'boron_enthalpy_of_vaporization', name: 'Enthalpy Of Vaporization', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_enthalpy_of_vaporization.js', importName: 'createBoronEnthalpyOfVaporization' },
  { id: 'boron_half_life', name: 'Half Life', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_half_life.js', importName: 'createBoronHalfLife' },
  { id: 'boron_hardness', name: 'Hardness', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_hardness.js', importName: 'createBoronHardness' },
  { id: 'boron_ionization_energy_1', name: 'Ionization Energy 1', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_ionization_energy_1.js', importName: 'createBoronIonizationEnergy1' },
  { id: 'boron_ionization_energy_2', name: 'Ionization Energy 2', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_ionization_energy_2.js', importName: 'createBoronIonizationEnergy2' },
  { id: 'boron_ionization_energy_3', name: 'Ionization Energy 3', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_ionization_energy_3.js', importName: 'createBoronIonizationEnergy3' },
  { id: 'boron_isotopes', name: 'Isotopes', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_isotopes.js', importName: 'createBoronIsotopes' },
  { id: 'boron_magnetic_properties', name: 'Magnetic Properties', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_magnetic_properties.js', importName: 'createBoronMagneticProperties' },
  { id: 'boron_mass_number', name: 'Mass Number', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_mass_number.js', importName: 'createBoronMassNumber' },
  { id: 'boron_melting_point', name: 'Melting Point', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_melting_point.js', importName: 'createBoronMeltingPoint' },
  { id: 'boron_molar_volume', name: 'Molar Volume', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_molar_volume.js', importName: 'createBoronMolarVolume' },
  { id: 'boron_natural_isotopes_abundance', name: 'Natural Isotopes Abundance', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_natural_isotopes_abundance.js', importName: 'createBoronNaturalIsotopesAbundance' },
  { id: 'boron_oxidation_states', name: 'Oxidation States', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_oxidation_states.js', importName: 'createBoronOxidationStates' },
  { id: 'boron_poisson_ratio', name: 'Poisson Ratio', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_poisson_ratio.js', importName: 'createBoronPoissonRatio' },
  { id: 'boron_production_methods', name: 'Production Methods', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_production_methods.js', importName: 'createBoronProductionMethods' },
  { id: 'boron_quantum_model', name: 'Quantum Model', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_quantum_model.js', importName: 'createBoronQuantum' },
  { id: 'boron_reactivity_with_acids', name: 'Reactivity With Acids', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_reactivity_with_acids.js', importName: 'createBoronReactivityWithAcids' },
  { id: 'boron_reactivity_with_bases', name: 'Reactivity With Bases', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_reactivity_with_bases.js', importName: 'createBoronReactivityWithBases' },
  { id: 'boron_reactivity_with_halogens', name: 'Reactivity With Halogens', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_reactivity_with_halogens.js', importName: 'createBoronReactivityWithHalogens' },
  { id: 'boron_reactivity_with_oxygen', name: 'Reactivity With Oxygen', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_reactivity_with_oxygen.js', importName: 'createBoronReactivityWithOxygen' },
  { id: 'boron_reactivity_with_water', name: 'Reactivity With Water', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_reactivity_with_water.js', importName: 'createBoronReactivityWithWater' },
  { id: 'boron_shear_modulus', name: 'Shear Modulus', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_shear_modulus.js', importName: 'createBoronShearModulus' },
  { id: 'boron_specific_heat_capacity', name: 'Specific Heat Capacity', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_specific_heat_capacity.js', importName: 'createBoronSpecificHeatCapacity' },
  { id: 'boron_spectral_lines', name: 'Spectral Lines', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_spectral_lines.js', importName: 'createBoronSpectralLines' },
  { id: 'boron_speed_of_sound', name: 'Speed Of Sound', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_speed_of_sound.js', importName: 'createBoronSpeedOfSound' },
  { id: 'boron_standard_state', name: 'Standard State', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_standard_state.js', importName: 'createBoronStandardState' },
  { id: 'boron_thermal_conductivity', name: 'Thermal Conductivity', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_thermal_conductivity.js', importName: 'createBoronThermalConductivity' },
  { id: 'boron_thermal_expansion', name: 'Thermal Expansion', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_thermal_expansion.js', importName: 'createBoronThermalExpansion' },
  { id: 'boron_toxicity', name: 'Toxicity', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_toxicity.js', importName: 'createBoronToxicity' },
  { id: 'boron_uses', name: 'Uses', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_uses.js', importName: 'createBoronUses' },
  { id: 'boron_year_of_discovery', name: 'Year Of Discovery', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_year_of_discovery.js', importName: 'createBoronYearOfDiscovery' },
  { id: 'boron_youngs_modulus', name: 'Youngs Modulus', icon: '⚛️', category: 'boron', importPath: './machines/chemistry/boron_youngs_modulus.js', importName: 'createBoronYoungsModulus' },
  { id: 'carbon_lonsdaleite', name: 'Carbon Lonsdaleite', icon: '⚛️', category: 'chemistry', importPath: './machines/chemistry/carbon_lonsdaleite.js', importName: 'chem_c_lonsdaleite' },

  { id: 'carbon_carbyne', name: 'Carbon Carbyne', icon: '⚛️', category: 'chemistry', importPath: './machines/chemistry/carbon_carbyne.js', importName: 'chem_c_carbyne' },

  { id: 'carbon_graphyne', name: 'Carbon Graphyne', icon: '⚛️', category: 'chemistry', importPath: './machines/chemistry/carbon_graphyne.js', importName: 'chem_c_graphyne' },

  { id: 'carbon_amorphous', name: 'Amorphous Carbon', icon: '⚛️', category: 'chemistry', importPath: './machines/chemistry/carbon_amorphous.js', importName: 'chem_c_amorphous' },

  { id: 'carbon_nanoscroll', name: 'Carbon Nanoscroll', icon: '⚛️', category: 'chemistry', importPath: './machines/chemistry/carbon_nanoscroll.js', importName: 'chem_c_nanoscroll' },

  { id: 'chem_c_mwcnt', name: 'Carbon MWCNT', icon: '⚛️', category: 'chemistry', importPath: './machines/chemistry/carbon_nanotube_mwcnt.js', importName: 'chem_c_mwcnt' },

  { id: 'chem_c_lonsdaleite_3', name: 'Carbon Lonsdaleite', icon: '⚛️', category: 'chemistry', importPath: './machines/chemistry/carbon_lonsdaleite.js', importName: 'chem_c_lonsdaleite' },

  { id: 'chem_c_fullerene_c70', name: 'Carbon C70 Fullerene', icon: '⚛️', category: 'chemistry', importPath: './machines/chemistry/carbon_fullerene_c70.js', importName: 'chem_c_fullerene_c70' },

  { id: 'chem_c_carbyne_3', name: 'Carbon Carbyne', icon: '⚛️', category: 'chemistry', importPath: './machines/chemistry/carbon_carbyne.js', importName: 'chem_c_carbyne' },

  { id: 'chem_c_graphene_oxide', name: 'Graphene Oxide', icon: '⚛️', category: 'chemistry', importPath: './machines/chemistry/carbon_graphene_oxide.js', importName: 'chem_c_graphene_oxide' }

]; // End of MACHINES array
