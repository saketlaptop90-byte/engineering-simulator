...
export function createParabolicMicrowaveDish(THREE) {
    ...
    rotor.name = "Rotor_createParabolicMicrowaveDish";
    group.add(rotor);
    ...
    const track = new THREE.QuaternionKeyframeTrack(
        "Rotor_createParabolicMicrowaveDish.quaternion",
        times,
        [q1.x, q1.y, q1.z, q1.w, q2.x, q2.y, q2.z, q2.w, q3.x, q3.y, q3.z, q3.w]
    );

    const clip = new THREE.AnimationClip('Operate_createParabolicMicrowaveDish', 2, [track]);
