export const chem_c_foam = {
    id: 'chem_c_foam',
    name: 'Carbon - Foam',
    type: 'chemistry',
    category: 'Chemistry',
    price: 45000,
    description: 'Carbon Foam. A lightweight cellular carbon material featuring open pores, excellent thermal stability, and low density.',
    particles: '250 carbon atoms in an open, porous, sponge-like 3D lattice',
    connections: 'Amorphous sp2 graphitic bonds forming interconnected webs',
    isPremium: true,
