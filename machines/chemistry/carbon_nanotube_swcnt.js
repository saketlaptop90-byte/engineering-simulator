...
export function createCarbonNanotubeSwcnt() {
    const group = new THREE.Group();
    group.userData = {
        name: 'Carbon Nanotube (SWCNT)',
        description: 'Single-Walled Carbon Nanotube exhibiting extraordinary tensile strength and electrical conductivity.',
        type: 'Chemistry'
    };
