export const chem_c_kagome = {
    id: 'chem_c_kagome',
    name: 'Carbon - Kagome Graphene',
    type: 'chemistry',
    category: 'Chemistry',
    price: 75000,
    description: 'Kagome Graphene. A theoretical 2D carbon sheet where atoms are arranged in a Kagome lattice (interwoven triangles and hexagons), creating exotic electronic flat bands.',
    particles: '200 carbon atoms structured in a trihexagonal tiling',
    connections: 'Symmetric planar sp2 bonds forming triangles and large hexagons',
    isPremium: true,
