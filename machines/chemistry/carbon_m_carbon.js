export const chem_c_m_carbon = {
    id: 'chem_c_m_carbon',
    name: 'Carbon - M-Carbon',
    type: 'chemistry',
    category: 'Chemistry',
    price: 95000,
    description: 'M-Carbon. A superhard carbon allotrope produced through cold compression of graphite, serving as an intermediate state to diamond.',
    particles: '300 carbon atoms in a monoclinic crystal lattice',
    connections: 'Fully sp3 hybridized with distorted tetrahedral geometries',
    isPremium: true,
