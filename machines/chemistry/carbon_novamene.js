export const chem_c_novamene = {
    id: 'chem_c_novamene',
    name: 'Carbon - Novamene',
    type: 'chemistry',
    category: 'Chemistry',
    price: 115000,
    description: 'Novamene. A hybrid carbon allotrope constructed by periodically inserting graphene layers into a hexagonal diamond structure.',
    particles: '320 carbon atoms in an alternating 2D/3D hybrid lattice',
    connections: 'Interleaving sp2 and sp3 hybridized regions',
    isPremium: true,
