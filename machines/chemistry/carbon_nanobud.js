export const chem_c_nanobud = {
    id: 'chem_c_nanobud',
    name: 'Carbon - Nanobud',
    type: 'chemistry',
    category: 'Chemistry',
    price: 88000,
    description: 'Carbon Nanobud. A hybrid structure combining carbon nanotubes and fullerenes, featuring fullerene 'buds' covalently bonded to the outer sidewall of a nanotube.',
    particles: '350 carbon atoms in a hybrid tubed-sphere configuration',
    connections: 'Continuous sp2 and sp3 hybrid covalent bonds between tube and bud',
    isPremium: true,
