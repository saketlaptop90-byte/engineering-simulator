export const chem_c_graphene_oxide = {
    id: 'chem_c_graphene_oxide',
    name: 'Carbon - Graphene Oxide',
    type: 'chemistry',
    category: 'Chemistry',
    price: 55000,
    description: 'Graphene Oxide (GO). A graphene sheet heavily disrupted by oxygen functional groups, tunable between conductor and insulator.',
    particles: '200 carbon atoms and 50 oxygen atoms in a functionalized 2D sheet',
    connections: 'sp2 and sp3 carbon bonds interspersed with hydroxyl and epoxy linkages',
    isPremium: true,
