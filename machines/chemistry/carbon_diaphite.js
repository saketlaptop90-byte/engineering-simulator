export const chem_c_diaphite = {
    id: 'chem_c_diaphite',
    name: 'Carbon - Diaphite',
    type: 'chemistry',
    category: 'Chemistry',
    price: 95000,
    description: 'Diaphite. An intricate nanocomposite where regions of diamond and graphite are coherently intergrown at the atomic scale.',
    particles: '350 carbon atoms featuring a phase boundary',
    connections: 'Transitioning from sp3 tetrahedral to sp2 planar sheets',
    isPremium: true,
