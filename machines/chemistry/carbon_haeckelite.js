export const chem_c_haeckelite = {
    id: 'chem_c_haeckelite',
    name: 'Carbon - Haeckelite',
    type: 'chemistry',
    category: 'Chemistry',
    price: 68000,
    description: 'Haeckelite. A planar carbon network containing a combination of pentagonal, hexagonal, and heptagonal rings, resulting in a metallic character unlike pristine graphene.',
    particles: '250 carbon atoms in a flat 5-6-7 ring 2D structure',
    connections: 'Defective planar sp2 bonds forming non-hexagonal polygons',
    isPremium: true,
