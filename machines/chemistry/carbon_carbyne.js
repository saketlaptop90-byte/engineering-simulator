export const chem_c_carbyne = {
    id: 'chem_c_carbyne',
    name: 'Carbon - Carbyne',
    type: 'chemistry',
    category: 'Chemistry',
    price: 95000,
    description: 'Linear Acetylenic Carbon (Carbyne). A 1D chain of carbon atoms, considered the strongest known material under tension.',
    particles: '100 carbon atoms in an ultra-stiff linear chain',
    connections: 'Alternating single and triple bonds with strong phonon wave dynamics',
    isPremium: true,
