export const chem_c_lonsdaleite = {
    id: 'chem_c_lonsdaleite',
    name: 'Carbon - Lonsdaleite',
    type: 'chemistry',
    category: 'Chemistry',
    price: 85000,
    description: 'Hexagonal Diamond (Lonsdaleite). A rare carbon allotrope with a hexagonal lattice, theoretically 58% harder than diamond.',
    particles: '250 carbon atoms in a dense hexagonal lattice',
    connections: 'Ultra-rigid sp3 hybridized covalent bonds',
    isPremium: true,
