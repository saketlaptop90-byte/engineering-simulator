export const chem_c_graphane = {
    id: 'chem_c_graphane',
    name: 'Carbon - Graphane',
    type: 'chemistry',
    category: 'Chemistry',
    price: 65000,
    description: 'Graphane. A two-dimensional polymer of carbon and hydrogen, created by fully hydrogenating a graphene sheet, turning it into an insulator.',
    particles: '200 carbon atoms and 200 hydrogen atoms',
    connections: 'sp3 hybridized carbon bonded to alternating hydrogen atoms',
    isPremium: true,
