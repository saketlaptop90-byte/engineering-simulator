export const chem_c_t_carbon = {
    id: 'chem_c_t_carbon',
    name: 'Carbon - T-Carbon',
    type: 'chemistry',
    category: 'Chemistry',
    price: 105000,
    description: 'T-Carbon. A low-density, highly porous cubic carbon allotrope where each atom in a diamond lattice is replaced by a carbon tetrahedron.',
    particles: '400 carbon atoms structured in a hierarchy of tetrahedrons',
    connections: 'Complex sp3 tetrahedral clusters bonded together',
    isPremium: true,
