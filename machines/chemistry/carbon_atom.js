...
export function createCarbonAtom() {
    const group = new THREE.Group();
    group.userData = {
        name: 'Carbon Atom (Quantum)',
        description: 'Ultra-high quality quantum representation of a Carbon atom showing its nucleus and 1s, 2s, 2p electron orbitals.',
        type: 'Chemistry'
    };
