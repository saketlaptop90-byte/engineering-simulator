...
export function createHardwareSecurityModule(THREE) {
    ...
    rotor.name = "Rotor_createHardwareSecurityModule";
    group.add(rotor);
    ...
    const track = new THREE.QuaternionKeyframeTrack(
        "Rotor_createHardwareSecurityModule.quaternion",
        times,
        [q1.x, q1.y, q1.z, q1.w, q2.x, q2.y, q2.z, q2.w, q3.x, q3.y, q3.z, q3.w]
    );

    const clip = new THREE.AnimationClip('Operate_createHardwareSecurityModule', 2, [track]);
